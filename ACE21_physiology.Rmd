...
Yield_cu_Pcomp_model.Clade<-lmer(Yield_cu~Days*Treatment*Clade+(1|Parent.ID:Frag.ID)+(1|Tank.num), PAMdata2_stats_Pcomp)
  ...
  emm<-emmeans(Yield_cu_Pcomp_model.Clade,  ~ Days*Treatment*Clade, adjust="Tukey")
    ...
    pairs(emm)
#T1 only 
    Biomass_Pcomp_model.T1<-lmer(Yield_cu~Treatment*Clade+(1|Parent.ID)+(1|Tank.num), PAMdata2_stats_Pcomp.T1)
  anova(Biomass_Pcomp_model.T1) 
  qqPlot(residuals(Biomass_Pcomp_model.T1)) 
  emm<-emmeans(Biomass_Pcomp_model.T1,  ~ Time.Point*Treatment, adjust="Tukey")
  cld(emm)
  ...
  #TF only
  Biomass_Pcomp_model.TF<-lmer(Yield_cu~Treatment*Clade+(1|Parent.ID)+(1|Tank.num), PAMdata2_stats_Pcomp.TF)
  anova(Biomass_Pcomp_model.TF) 
  qqPlot(residuals(Biomass_Pcomp_model.TF)) 
  emm<-emmeans(Biomass_Pcomp_model.TF,  ~ Time.Point*Treatment, adjust="Tukey")
  cld(emm)
...
Yield_cu_Pvar_model<-lmer(Yield_cu~Days*Treatment*Clade+(1|Parent.ID:Frag.ID)+(1|Tank.num), PAMdata2_stats_Pvar)
  ...
  #T1 only 
    Biomass_Pvar_model.T1<-lmer(Yield_cu~Treatment*Clade+(1|Parent.ID)+(1|Tank.num), PAMdata2_stats_Pvar.T1)
  anova(Biomass_Pvar_model.T1) 
  qqPlot(residuals(Biomass_Pvar_model.T1)) 
  emm<-emmeans(Biomass_Pvar_model.T1,  ~ Time.Point*Treatment, adjust="Tukey")
  cld(emm)
  ...
  #TF only
  Biomass_Pvar_model.TF<-lmer(Yield_cu~Treatment*Clade+(1|Parent.ID)+(1|Tank.num), PAMdata2_stats_Pvar.TF)
  anova(Biomass_Pvar_model.TF) 
  qqPlot(residuals(Biomass_Pvar_model.TF)) 
  emm<-emmeans(Biomass_Pvar_model.TF,  ~ Time.Point*Treatment, adjust="Tukey")
  cld(emm)
...
Yield_cu_Pacu_model<-lmer(Yield_cu~Days*Treatment*Clade+(1|Parent.ID:Frag.ID)+(1|Tank.num), PAMdata2_stats_Pacu)
  ...
  #T1 only 
    Biomass_Pacu_model.T1<-lmer(Yield_cu~Treatment*Clade+(1|Parent.ID)+(1|Tank.num), PAMdata2_stats_Pacu.T1)
  anova(Biomass_Pacu_model.T1) 
  qqPlot(residuals(Biomass_Pacu_model.T1)) 
  emm<-emmeans(Biomass_Pacu_model.T1,  ~ Time.Point*Treatment, adjust="Tukey")
  cld(emm)
  ...
  #TF only
  Biomass_Pacu_model.TF<-lmer(Yield_cu~Treatment*Clade+(1|Parent.ID)+(1|Tank.num), PAMdata2_stats_Pacu.TF)
  anova(Biomass_Pacu_model.TF) 
  qqPlot(residuals(Biomass_Pacu_model.TF)) 
  emm<-emmeans(Biomass_Pacu_model.TF,  ~ Time.Point*Treatment, adjust="Tukey")
  cld(emm)
