...
#Pacu-CCC only
  ...
  qqPlot(residuals(Biomass_Pacu_model.CCC)) 
    emm<-emmeans(Biomass_Pacu_model.CCC,  ~ Time.Point*Treatment, adjust="Tukey")
    cld(emm)
    pairs(emm)
...
hist(PR.df_B$Photo)
PR.df_B$Photo_sqrt<-sqrt(PR.df_B$Photo)
hist(PR.df_B$Photo_sqrt) #

#lmer
Photo_stats_model<-lmer(Photo_sqrt~Time.Point*Treatment*Species+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B)
anova(Photo_stats_model) 
qqPlot(residuals(Photo_stats_model)) 
Photo_stats_modelC<-lmer(Photo_sqrt~Time.Point*Treatment*Species*Clade+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B)
...
#mcap
#lmer
Photo_Mcap_model<-lmer(Photo_sqrt~Time.Point*Treatment*Clade+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Mcap)
...
#mcap-C only
  Photo_Mcap_model.C<-lmer(Photo_sqrt~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Mcap.C)
...
#mcap-CD only
  Photo_Mcap_model.CD<-lmer(Photo_sqrt~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Mcap.CD)
...
#Pcomp
#lmer
Photo_Pcomp_model<-lmer(Photo_sqrt~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pcomp)
...
Photo_Pcomp_model.Clade<-lmer(Photo_sqrt~Time.Point*Treatment*Clade+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pcomp.C15)
...
#Pcomp-C15cj only
  Photo_Pcomp_model.C15cj<-1-lmer(Photo_sqrt~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pcomp.C15cj)
...
#Pcomp-C27 only
  Photo_Pcomp_model.C15n<-lmer(Photo_sqrt~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pcomp.C15n)
...
#Pvar
#lmer
Photo_Pvar_model<-lmer(Photo_sqrt~Time.Point*Treatment*Clade+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pvar)
...
#Pvar-C only
  Photo_Pvar_model.C1<-lmer(Photo_sqrt~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pvar.C1)
...
#Pvar-CD only
  Photo_Pvar_model.C27<-lmer(Photo_sqrt~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pvar.C27)
...
#Pacu
#lmer
Photo_Pacu_model<-lmer(Photo_sqrt~Time.Point*Treatment*Clade+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pacu)
...
#Pacu-CCC only
  Photo_Pacu_model.CCC<-lmer(Photo_sqrt~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pacu.CCC)
...
#Pacu-C42 only
  Photo_Pacu_model.C42<-lmer(Photo_sqrt~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pacu.C42)
...
#lmer
PR_stats_model<-lmer(PR_log~Time.Point*Treatment*Species+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B)
anova(PR_stats_model) 
qqPlot(residuals(PR_stats_model)) 

PR_stats_modelC<-lmer(PR_log~Time.Point*Treatment*Species*Clade+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B)
...
#mcap
#lmer
PR_Mcap_model<-lmer(PR_log~Time.Point*Treatment*Clade+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Mcap)
  anova(PR_Mcap_model) 
...
#mcap-C only
  PR_Mcap_model.C<-lmer(PR_log~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Mcap.C)
...
#mcap-CD only
  PR_Mcap_model.CD<-lmer(PR_log~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Mcap.CD)
...
#Pcomp
#lmer
PR_Pcomp_model<-lmer(PR_log~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pcomp)
...
PR_Pcomp_model.Clade<-lmer(PR_log~Time.Point*Treatment*Clade+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pcomp)
...
#Pcomp-C15cj only
  PR_Pcomp_model.C15cj<-lmer(PR_log~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pcomp.C15cj)
...
#Pcomp-C27 only
  PR_Pcomp_model.C15n<-lmer(PR_log~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pcomp.C15n)
...
#Pvar
#lmer
PR_Pvar_model<-lmer(PR_log~Time.Point*Treatment*Clade+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pvar)
  anova(PR_Pvar_model) 
...
#Pvar-C1 only
  PR_Pvar_model.C1<-lmer(PR_log~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pvar.C1)
...
#Pvar-C27 only
  PR_Pvar_model.C27<-lmer(PR_log~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pvar.C27)
...
#Pacu
#lmer
PR_Pacu_model<-lmer(PR_log~Time.Point*Treatment*Clade+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pacu)
  anova(PR_Pacu_model) 
...
#Pacu-CCC only
  PR_Pacu_model.CCC<-lmer(PR_log~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pacu.CCC)
...
#Pacu-C42 only
  PR_Pacu_model.C42<-lmer(PR_log~Time.Point*Treatment+(1|Parent.ID:Frag.ID)+(1|Tank.num), PR.df_B_Pacu.C42)
