...
#Mcap ####
AFDW_Mcap_plot<- ggplot(biomass_T1_mcap, aes(x=interaction(Treatment,Clade), y=AFDWmg.cm2, fill=Treatment)) + 
      scale_fill_manual(values=c("deepskyblue1", "orangered"))+
      ggtitle("M. capitata")+
      xlab("") + #Label the X Axis
      ylab(bquote('Ash-free Dry Weight '(mg~cm^2)))+
      ...
      geom_boxplot(show.legend = F);AFDW_Mcap_plot
...
plot_row<-plot_grid(AFDW_Mcap_plot, AFDW_Pcomp_plot, AFDW_Pvar_plot, AFDW_Pacu_plot, nrow=1,label_size = 12)
  title <- ggdraw() + 
  draw_label("Ash-free Dry Weight", fontface = 'bold',x = 0, hjust = 0) +
