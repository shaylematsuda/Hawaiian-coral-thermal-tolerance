...
#2/16/24 boxplot ####
#T0 only
 Biomass_T0<- ggplot(biomass_T0, aes(x=Species, y=AFDWmg.cm2, fill=Species)) + 
      ...
      geom_boxplot(show.legend = FALSE);Biomass_T0
...
Biomass_T0_clade <- ggplot(biomass_T0, aes(x=interaction(Clade, Species), y=AFDWmg.cm2, fill=Clade)) + 
      ...
      scale_x_discrete(guide = "axis_nested");Biomass_T0_clade
...
#T0 only ####
FC_T0<-  ggplot(FC_Data_T0, aes(x=Species, y=zoox.cm2, fill=Species)) + 
      scale_fill_manual(values=c("#E69F00", "#56B4E9", "#CC79A7","#009E73"))+
      xlab("") + #Label the X Axis
      ...
      theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
      panel.background = element_blank(), axis.line = element_line(colour = "black")) + 
      geom_boxplot(show.legend = FALSE);FC_T0
ggsave("FC_T0.pdf", plot=last_plot(), path="Figures",device = "pdf", width=8, height=5, units=c("in"), dpi=300)

#T0 only - by algal profile
FC_T0_clade<-ggplot(FC_Data_T0, aes(x=interaction(factor(Species, levels=unique(Species)), Clade), y=zoox.cm2, fill=Clade)) + 
      scale_fill_manual(values=c("goldenrod1","darkorange3", "powderblue","#0072B2" ,"pink1","firebrick",   "palegreen2","darkgreen"))+
      xlab("") + #Label the X Axis
      theme(axis.text.x = element_text(face = "italic",size=14))+
      theme(axis.text.y = element_text(size=14))+
      ...
      geom_boxplot( show.legend = FALSE)+
    scale_x_discrete(guide = "axis_nested");FC_T0_clade
...
#Pcomp####
flow_T1TF_pcomp<-subset(flow_T1TF, Species=="Porites compressa")
FC_Pcomp_plot<- ggplot(flow_T1TF_pcomp, aes(x=interaction(Treatment,Clade, Time.Point), y=zoox.cm2, fill=Treatment)) + 
      scale_fill_manual(values=c("deepskyblue1", "orangered"))+
      ggtitle("P. compressa: Cell counts")+
      xlab("") + 
      ylab("") + 
      theme(axis.text.y = element_text(size=14))+
      theme(axis.text.x = element_text(size=14))+
...
ggsave("FC_Pcomp_plot.pdf", plot=last_plot(), path="Figures",device = "pdf", width=7, height=4, units=c("in"), dpi=300)
...
#T0 only ####
BW_T0<-  ggplot(BW_df4_T1_amb, aes(x=Species, y=value, fill=Species)) + 
      scale_fill_manual(values=c("#E69F00", "#56B4E9", "#CC79A7","#009E73"))+
      xlab("") + #Label the X Axis
      ...
      theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
      panel.background = element_blank(), axis.line = element_line(colour = "black")) + 
      geom_boxplot(show.legend = FALSE);BW_T0
ggsave("BW_T0.pdf", plot=last_plot(), path="Figures",device = "pdf", width=8, height=5, units=c("in"), dpi=300)

#T0 only - by algal profile
BW_T0_clade<-  ggplot(BW_df4_T1_amb, aes(x=interaction(Clade, Species), y=value, fill=Clade))+ 
     scale_fill_manual(values=c("goldenrod1","darkorange3", "powderblue","#0072B2" ,"pink1","firebrick",   "palegreen2","darkgreen"))+
      xlab("") + #Label the X Axis
      theme(axis.text.x = element_text(face = "italic",size=14))+
      theme(axis.text.y = element_text(size=14))+
      ...
      geom_boxplot( show.legend = FALSE)+
      scale_x_discrete(guide = "axis_nested"); BW_T0_clade
ggsave("FC_T0_profile.pdf", plot=last_plot(), path="Figures",device = "pdf", width=8, height=5, units=c("in"), dpi=300)
...
#T0 only ####
 Chl_T0<- ggplot(Chla_T0, aes(x=Species, y=ChlaSA, fill=Species)) + 
      scale_fill_manual(values=c("#E69F00", "#56B4E9", "#CC79A7","#009E73"))+
      xlab("") + #Label the X Axis
      ...
      theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
      panel.background = element_blank(), axis.line = element_line(colour = "black")) + 
      geom_boxplot(show.legend = FALSE);Chl_T0
ggsave("Chla_T0.pdf", plot=last_plot(), path="Figures",device = "pdf", width=8, height=5, units=c("in"), dpi=300)

#T0 only - by algal profile
Chl_T0_clade<-  ggplot(Chla_T0, aes(x=interaction(Species,Clade), y=ChlaSA, fill=Clade)) + 
      scale_fill_manual(values=c("goldenrod1","darkorange3", "powderblue","#0072B2" ,"pink1","firebrick",   "palegreen2","darkgreen"))+
      xlab("") + #Label the X Axis
      theme(axis.text.x = element_text(face = "italic",size=14))+
      theme(axis.text.y = element_text(size=14))+
      ...
      geom_boxplot( show.legend = FALSE)+
              scale_x_discrete(guide = "axis_nested");Chl_T0_clade
...
emm<-emmeans(Yield_cu_stats_model,  ~ Treatment| Days*Species, adjust="Tukey")
 cld(emm)
 pairs(emm)
...
PAM_T0<-ggplot(PAM_T0, aes(x=Species, y=Yield, fill=Species)) + 
      scale_fill_manual(values=c("#E69F00", "#56B4E9", "#CC79A7","#009E73"))+
      xlab("") + #Label the X Axis
      ylab(bquote("fv/fm"))+
      theme(axis.text.x = element_text(face = "italic",size=14))+
      ...
      theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
      panel.background = element_blank(), axis.line = element_line(colour = "black")) + 
      geom_boxplot(show.legend = FALSE);PAM_T0
ggsave("PAM_T0.pdf", plot=last_plot(), path="Figures",device = "pdf", width=8, height=5, units=c("in"), dpi=300)

#T0 only - by algal profile
 PAM_T0_clade<- ggplot(PAM_T0, aes(x=interaction(Clade, Species), y=Yield, fill=Clade)) + 
         scale_fill_manual(values=c("goldenrod1","darkorange3", "powderblue","#0072B2" ,"pink1","firebrick",   "palegreen2","darkgreen"))+
      xlab("") + #Label the X Axis
      theme(axis.text.x = element_text(face = "italic",size=14))+
      theme(axis.text.y = element_text(size=14))+
      ...
      geom_boxplot(show.legend = FALSE)+
              scale_x_discrete(guide = "axis_nested");PAM_T0_clade

ggsave("PAM_T0_profile.pdf", plot=last_plot(), path="Figures",device = "pdf", width=8, height=5, units=c("in"), dpi=300)


#Plots T1 and TF####
FvFm_T1TF_ND_D24D58<-subset(PAMdata2, Days==24|Days==58)

#T1TF - by species ####
FvFmT1TF<- ggplot(FvFm_T1TF_ND_D24D58, aes(x=interaction(Treatment,Days,Species), y=Yield, fill=Treatment)) + 
      scale_fill_manual(values=c("deepskyblue1", "orangered"))+
      ggtitle(bquote("Photosynthetic Quantum Yeild")) +
      xlab("") + #Label the X Axis
      ylab(bquote("Fv/Fm"))+
...
FvFm_T1TF_NDpacu<-subset(FvFm_T1TF_ND, Species=="Pocillopora acuta")
PAM_Pacu<-ggplot(FvFm_T1TF_NDpacu, aes(x=interaction(Days), y=Yield, fill=Treatment)) + 
      scale_fill_manual(values=c("deepskyblue1", "orangered"))+
      ggtitle("P. acuta")+
      xlab("") + #Label the X Axis
      ylab(bquote("fv/fm"))+
...
#T0 only
Prot_T0<-  ggplot(Protein_T0, aes(x=Species, y=mg.mm2, fill=Species)) + 
      scale_fill_manual(values=c("#E69F00", "#56B4E9", "#CC79A7","#009E73"))+
      xlab("") + #Label the X Axis
      ...
      theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
      panel.background = element_blank(), axis.line = element_line(colour = "black")) + 
      geom_boxplot(show.legend = FALSE);Prot_T0
ggsave("Protein_T0.pdf", plot=last_plot(), path="Figures",device = "pdf", width=15, height=4, units=c("in"), dpi=300)

#T0 only - by algal profile
Prot_T0_clade<-  ggplot(Protein_T0, aes(x=interaction(Clade, Species), y=mg.mm2, fill=Clade)) + 
      scale_fill_manual(values=c("goldenrod1","darkorange3", "powderblue","#0072B2" ,"pink1","firebrick",   "palegreen2","darkgreen"))+
      xlab("") + #Label the X Axis
      theme(axis.text.x = element_text(face = "italic",size=14))+
      theme(axis.text.y = element_text(size=14))+
      ...
      geom_boxplot( show.legend = FALSE)+
      scale_x_discrete(guide = "axis_nested");Prot_T0_clade
...
#T0 only
 Photo_T0<- ggplot(PR.df_T0, aes(x=Species, y=GrossP, fill=Species)) + 
      scale_fill_manual(values=c("#E69F00", "#56B4E9", "#CC79A7","#009E73"))+
      xlab("") + #Label the X Axis
      ...
      theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
      panel.background = element_blank(), axis.line = element_line(colour = "black")) + 
      geom_boxplot(show.legend = FALSE);Photo_T0
ggsave("GrossPhoto_T0.pdf", plot=last_plot(), path="Figures",device = "pdf", width=15, height=4, units=c("in"), dpi=300)

#T0 only - by algal profile ####
 Photo_T0_clade<- ggplot(PR.df_T0, aes(x=interaction(Clade, Species), y=GrossP, fill=Clade)) + 
      scale_fill_manual(values=c("goldenrod1","darkorange3", "powderblue","#0072B2" ,"pink1","firebrick",   "palegreen2","darkgreen"))+
      xlab("") + #Label the X Axis
      theme(axis.text.x = element_text(face = "italic",size=14))+
      theme(axis.text.y = element_text(size=14))+
      ...
      geom_boxplot( show.legend = FALSE)+
      scale_x_discrete(guide = "axis_nested");Photo_T0_clade
...
#T0 only
 Resp_T0<- ggplot(PR.df_T0, aes(x=Species, y=Resp, fill=Species)) + 
      scale_fill_manual(values=c("#E69F00", "#56B4E9", "#CC79A7","#009E73"))+
      xlab("") + #Label the X Axis
      ylab(expression(paste(plain("\u03bc"), "mol ", O[2], " cm"^"-2 ", plain(m)^"-1")))+
      theme(axis.text.x = element_text(face = "italic",size=14))+
      ...
      theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
      panel.background = element_blank(), axis.line = element_line(colour = "black")) + 
      geom_boxplot(show.legend = FALSE);Resp_T0
ggsave("Resp_T0.pdf", plot=last_plot(), path="Figures",device = "pdf", width=15, height=4, units=c("in"), dpi=300)

#T0 only - by algal profile
Resp_T0_clade<-  ggplot(PR.df_T0, aes(x=interaction(Clade, Species), y=Resp, fill=Clade)) + 
      scale_fill_manual(values=c("goldenrod1","darkorange3", "powderblue","#0072B2" ,"pink1","firebrick",   "palegreen2","darkgreen"))+
      xlab("") + #Label the X Axis
      theme(axis.text.x = element_text(face = "italic",size=14))+
      theme(axis.text.y = element_text(size=14))+
      ...
      geom_boxplot( show.legend = FALSE)+
      scale_x_discrete(guide = "axis_nested");Resp_T0_clade
...
#T0 only
PR_T0<-  ggplot(PR.df_T0, aes(x=Species, y=PR, fill=Species)) + 
      scale_fill_manual(values=c("#E69F00", "#56B4E9", "#CC79A7","#009E73"))+
      xlab("") + #Label the X Axis
      ylab(expression(paste(plain("\u03bc"), "mol ", O[2], " cm"^"-2 ", plain(m)^"-1")))+
      theme(axis.text.x = element_text(face = "italic",size=14))+
      ...
      theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
      panel.background = element_blank(), axis.line = element_line(colour = "black")) + 
      geom_boxplot(show.legend = FALSE);PR_T0
ggsave("resp_T0.pdf", plot=last_plot(), path="Figures",device = "pdf", width=15, height=4, units=c("in"), dpi=300)

#T0 only - by algal profile
 PR_T0_clade<- ggplot(PR.df_T0, aes(x=interaction(Clade, Species), y=PR, fill=Clade)) + 
      scale_fill_manual(values=c("goldenrod1","darkorange3", "powderblue","#0072B2" ,"pink1","firebrick",   "palegreen2","darkgreen"))+
      xlab("") + #Label the X Axis
      theme(axis.text.x = element_text(face = "italic",size=14))+
      theme(axis.text.y = element_text(size=14))+
      ...
      ggtitle("Respiration by Algal Profile")+
      geom_boxplot( show.legend = FALSE)+
      scale_x_discrete(guide = "axis_nested");PR_T0_clade
...
#same as above with FvFm for P.acuta 0s removed _ We are not doing this
```{r}
library(patchwork)
...
# Combine plots vertically using patchwork
combined_plot <- BiomassT0 / BWT0 / FlowT0 / ChlT0 / PAMT0 / 
                 ProtT0 / PhotoT0 / RespT0 / PRT0 +
                 plot_layout(ncol = 1)



pdf("CombinedPhysioPlots_T0.pdf", width = 10, height = 18)
print(combined_plot)
dev.off()
```
...
#T0 all physio by algal symbiont lineage
```{r}
# Adjust y-axis text size and hide x-axis labels/underlines except for the bottom plot
BiomassT0_clade <- Biomass_T0_clade +
  theme(axis.text.y = element_text(size = 10),
        axis.text.x = element_blank(),
        axis.ticks.x = element_blank(),
        axis.title.x = element_blank(),
...
PRT0_clade <- PR_T0_clade + 
  theme(axis.text.y = element_text(size = 10),axis.title.y = element_text(size = 9))  # Keep x-axis on bottom plot

# Combine plots vertically using patchwork
combined_plot <- BiomassT0_clade / BWT0_clade / FlowT0_clade / ChlT0_clade / PAMT0_clade / 
                 ProtT0_clade / PhotoT0_clade / RespT0_clade / PRT0_clade +
                 plot_layout(ncol = 1)



pdf("CombinedPhysioPlots_T0_clade.pdf", width = 10, height = 18)
print(combined_plot)
dev.off()
```
...
write.csv(PhysioData,"PhysioData.csv") #export
...
#select cols for the PCA - Since no measured data for growth at T0 and it looks the same as making T0 the same as ambient T1, just do not include
...
# you have missing values - remove rows with missing data.
...
pca_scores <- as_tibble(pca_scores)


# calc centroid
centroids <- pca_scores %>%
  dplyr::group_by(Species, Treatment, Time.Point) %>%
  summarise(PC1 = mean(PC1), PC2 = mean(PC2), .groups = "drop")

# prepare arrows
arrows <- centroids %>%
  dplyr::arrange(Species, Treatment, Time.Point) %>%
...
#editing for fig 4 main manuscript 20250407 see below for more <-i dont love this figure. can likely cut
```{r}
library(dplyr)
library(tidyr)
library(ggplot2)
...
# Figure 4 physiology significance summary

This plot summarizes treatment-effect p-values by physiology trait, host species, and experimental time point.

```{r}
phys_fig4 <- read.csv(
  "ACE21_physio_for_figure.csv",
  fileEncoding = "UTF-8-BOM",
  check.names = FALSE
)

names(phys_fig4) <- trimws(names(phys_fig4))
phys_fig4 <- phys_fig4 %>%
  mutate(
    `Physiology trait` = na_if(`Physiology trait`, ""),
    `Host species` = na_if(`Host species`, "")
  ) %>%
  tidyr::fill(`Physiology trait`, `Host species`)
...
species_order <- c("M. capitata", "P. compressa", "P. varians", "P. acuta")

phys_fig4 <- phys_fig4 %>%
  mutate(
    `Physiology trait` = factor(`Physiology trait`, levels = rev(trait_order)),
    `Host species` = factor(`Host species`, levels = species_order),
    `Time pt` = factor(`Time pt`, levels = c("T1", "TF")),
    p_numeric = as.numeric(str_remove(str_remove_all(as.character(p), "\\*"), "^<")),
    significant = str_detect(as.character(p), "\\*") | p_numeric < 0.05,
    fill_category = if_else(significant, as.character(`Host species`), "Not significant"),
    p_label = as.character(p)
  )
...
figure4_colors <- c(
  ...
  "P. varians" = "#CC79A7",
  "P. acuta" = "#009E73",
  "Not significant" = "azure3"
)

physiology_figure4 <- ggplot(
  phys_fig4,
  aes(x = `Time pt`, y = `Physiology trait`, fill = fill_category)
) +
  geom_tile(color = "#2B2B2B", linewidth = 0.6, width = 0.95, height = 0.98) +
  geom_text(aes(label = p_label), size = 3.4, fontface = "bold") +
  facet_grid(. ~ `Host species`, switch = "x") +
  scale_fill_manual(values = figure4_colors) +
...
physiology_figure4
# ggsave("Figures/ACE21_Figure4_physiology_summary.pdf", physiology_figure4)
```
