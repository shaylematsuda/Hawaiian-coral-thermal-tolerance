...
#T0 only - by algal profile
  ggplot(FC_Data_T0, aes(x=Species, y=zoox.cm2, fill=Clade, group=interaction(Species, Clade))) + 
      scale_fill_manual(values=c("darkorange3", "pink1","powderblue","#0072B2" ,"firebrick","darkgreen",    "palegreen2","goldenrod1"))+
      xlab("") + #Label the X Axis
      theme(axis.text.x = element_text(face = "italic",size=14))+
      theme(axis.text.y = element_text(size=14))+
...
#T1 - by species  ####
ggplot(FC_T1, aes(x=Species, y=zoox.cm2, fill=Treatment)) + 
      scale_fill_manual(values=c("deepskyblue1", "orangered"))+
...
#TF ####
      ggplot(FC_TF, aes(x=Species, y=zoox.cm2, fill=Treatment)) + 
      scale_fill_manual(values=c("deepskyblue1", "orangered"))+
...
G_Mcap$Species<-"Montipora capitata"
G_Pcomp$Species<-"Porites compressa"
G_Pvar$Species<-"Pavona varians"
G_Pacu$Species<-"Pocillopora acuta"
...
#Chl-a\
dfs: Slurry=airbrush, SA=wax dip, SHOULD YOU STANDARDIZE TO CELLS INSTEAD?
...
# divide by Clade
Mcap_PAM_mean<-subset(PAMdata2_mean, Species =="Montipora capitata")
Pcomp_PAM_mean<-subset(PAMdata2_mean, Species =="Porites compressa")
Pvar_PAM_mean<-subset(PAMdata2_mean, Species =="Pavona varians")
Pacu_PAM_mean<-subset(PAMdata2_mean, Species =="Pocillopora acuta")
...
#### by species ####
Mcap_Protein_mean<-subset(Protein_mean, Species=="Montipora capitata")
Pcomp_Protein_mean<-subset(Protein_mean, Species=="Porites compressa")
Pvar_Protein_mean<-subset(Protein_mean, Species=="Pavona varians")
Pacu_Protein_mean<-subset(Protein_mean, Species=="Pocillopora acuta")
...
#Mcap by clade
Protein_meanCLADE.Mcap<-subset(Protein_meanCLADE, Species=="Montipora capitata")
...
#Pcomp by clade
Protein_meanCLADE.Pcomp<-subset(Protein_meanCLADE, Species=="Porites compressa")
...
#Pvar by clade
Protein_meanCLADE.Pvar<-subset(Protein_meanCLADE, Species=="Pavona varians")
...
#Pacu by clade
Protein_meanCLADE.Pacu<-subset(Protein_meanCLADE, Species=="Pocillopora acuta")
...
# divide by species ####
Mcap_GrossP_mean<-subset(GrossP_mean, Species =="Montipora capitata")
Pcomp_GrossP_mean<-subset(GrossP_mean, Species =="Porites compressa")
Pvar_GrossP_mean<-subset(GrossP_mean, Species =="Pavona varians")
Pacu_GrossP_mean<-subset(GrossP_mean, Species =="Pocillopora acuta")
...
GrossP_meanCLADE.pcomp<-subset(Photo_meanCLADE, Species=="Porites compressa")
...
# divide by species
Mcap_GrossP_mean.Clade<-subset(GrossP_mean.Clade, Species =="Montipora capitata")
  Mcap_GrossP_mean.Clade$Code<-paste(Mcap_GrossP_mean.Clade$Clade, Mcap_GrossP_mean.Clade$Treatment)
Pcomp_GrossP_mean.Clade<-subset(GrossP_mean.Clade, Species =="Porites compressa")
  Pcomp_GrossP_mean.Clade$Code<-paste(Pcomp_GrossP_mean.Clade$Clade, Pcomp_GrossP_mean.Clade$Treatment)
Pvar_GrossP_mean.Clade<-subset(GrossP_mean.Clade, Species =="Pavona varians")
  Pvar_GrossP_mean.Clade$Code<-paste(Pvar_GrossP_mean.Clade$Clade, Pvar_GrossP_mean.Clade$Treatment)
Pacu_GrossP_mean.Clade<-subset(GrossP_mean.Clade, Species =="Pocillopora acuta")
...
# divide by species
Mcap_RespPos_mean<-subset(RespPos_mean, Species =="Montipora capitata")
Pcomp_RespPos_mean<-subset(RespPos_mean, Species =="Porites compressa")
Pvar_RespPos_mean<-subset(RespPos_mean, Species =="Pavona varians")
Pacu_RespPos_mean<-subset(RespPos_mean, Species =="Pocillopora acuta")
...
# divide by species
Mcap_RespPos_mean.Clade<-subset(RespPos_mean.Clade, Species =="Montipora capitata")
  Mcap_RespPos_mean.Clade$Code<-paste(Mcap_RespPos_mean.Clade$Clade, Mcap_RespPos_mean.Clade$Treatment)
Pcomp_RespPos_mean.Clade<-subset(RespPos_mean.Clade, Species =="Porites compressa")
  Pcomp_RespPos_mean.Clade$Code<-paste(Pcomp_RespPos_mean.Clade$Clade, Pcomp_RespPos_mean.Clade$Treatment)
Pvar_RespPos_mean.Clade<-subset(RespPos_mean.Clade, Species =="Pavona varians")
  Pvar_RespPos_mean.Clade$Code<-paste(Pvar_RespPos_mean.Clade$Clade, Pvar_RespPos_mean.Clade$Treatment)
Pacu_RespPos_mean.Clade<-subset(RespPos_mean.Clade, Species =="Pocillopora acuta")
...
# divide by species
Mcap_PR_mean<-subset(PR_mean, Species =="Montipora capitata")
Pcomp_PR_mean<-subset(PR_mean, Species =="Porites compressa")
Pvar_PR_mean<-subset(PR_mean, Species =="Pavona varians")
Pacu_PR_mean<-subset(PR_mean, Species =="Pocillopora acuta")
