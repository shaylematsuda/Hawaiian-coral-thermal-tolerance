...
#Resp:photosynthesis
####### Check the original data from Ford. compare to original plots and confirm!
```{r}
...
#T1 - by species
ggplot(PR.df_T1, aes(x=Species, y=Photo, fill=Treatment)) + 
      scale_fill_manual(values=c("deepskyblue1", "orangered"))+
...
#TF ####
      ggplot(PR.df_TF, aes(x=Species, y=GrossP, fill=Treatment)) + 
      scale_fill_manual(values=c("deepskyblue1", "orangered"))+
...
#T1 - by species
ggplot(PR.df_T1, aes(x=Species, y=Resp, fill=Treatment)) + 
      scale_fill_manual(values=c("deepskyblue1", "orangered"))+
...
#TF ####
      ggplot(PR.df_TF, aes(x=Species, y=Resp, fill=Treatment)) + 
      scale_fill_manual(values=c("deepskyblue1", "orangered"))+
...
#T0 only - by algal profile
  ggplot(PR.df_T0, aes(x=interaction(Clade, Species), y=PR, fill=Clade)) + 
      ...
      theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
      panel.background = element_blank(), axis.line = element_line(colour = "black")) +
      ggtitle(" PRiration by Algal Profile")+
      geom_boxplot( show.legend = FALSE)+
      scale_x_discrete(guide = "axis_nested")
...
#T1 - by species
ggplot(PR.df_T1, aes(x=Species, y=PR, fill=Treatment)) + 
      scale_fill_manual(values=c("deepskyblue1", "orangered"))+
...
#TF ####
      ggplot(PR.df_TF, aes(x=Species, y=PR, fill=Treatment)) + 
      scale_fill_manual(values=c("deepskyblue1", "orangered"))+
