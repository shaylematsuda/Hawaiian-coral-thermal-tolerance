...
DIV_RelA  = transform_sample_counts(coralDIV2_rare, function(x) x / sum(x) )  #save as RELA DIVs
...
#                                             diff        lwr        upr     p adj
# Pavona_varians-Montipora_capitata    -1.16163190 -1.3624327 -0.9608311 0.0000000
# Pocillopora_acuta-Montipora_capitata -1.24194758 -1.4483099 -1.0355853 0.0000000
# Porites_compressa-Montipora_capitata -0.05568403 -0.2548492  0.1434812 0.8875317
# Pocillopora_acuta-Pavona_varians     -0.08031568 -0.2840678  0.1234365 0.7376709
# Porites_compressa-Pavona_varians      1.10594786  0.9094884  1.3024073 0.0000000
# Porites_compressa-Pocillopora_acuta   1.18626355  0.9841231  1.3884040 0.0000000

#Plot
boxplot(Shannon ~ Species, data=erich, ylab="Shannon's diversity") 

#show that only Species is significant
aov.shannon.species2 = aov(Shannon ~ Species*Treatment*Time.Point, data=erich)
  summary(aov.shannon.species2) # sig diff between species
