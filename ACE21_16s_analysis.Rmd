...
#make unifrac matrix
Bac.fam.T1F <- phyloseq::distance(Bac.seqFam_stats.T1F, method = "wunifrac")
Fam.samp.df <- as(sample_data(Bac.seqFam_stats.T1F), "data.frame") #sample df
  #adonis test
set.seed(30)
...
adonis(Fam.16s.all ~ Species*Treatment*Time.Point*Clade, data = Fam.samp.df)
  # Homogeneity of dispersion test  
set.seed(30)    
  beta <- betadisper(Bac.fam.T1F, Fam.samp.df$Clade)  #clade
    permutest(beta, pairwise = T) 
set.seed(30)    
  beta <- betadisper(Bac.fam.T1F, Fam.samp.df$Treatment) #treatment
    permutest(beta, pairwise = T) 
############# mcap
...
#make bray curtis data matrix -T1 and TF
 ...
 #heatmap
    #plot_heatmap(mcap.u.f.bac.T1F, "NMDS", "bray", "Parent.ID", "Phylum")
      # Homogeneity of dispersion test  
set.seed(30)    
  beta <- betadisper(bc.mcap.u.f.T1F, mcap.u.f.samp.df.T1F$Clade)  #clade
    permutest(beta, pairwise = T) 
set.seed(30)    
  beta <- betadisper(bc.mcap.u.f.T1F, mcap.u.f.samp.df.T1F$Treatment) #treatment
    permutest(beta, pairwise = T) 
    
#T1
    set.seed(30)
  bc.mcapT1 <- phyloseq::distance(mcap.u.f.bac.T1, method = "wunifrac") 
      mcap.u.f.samp.df.T1 <- as(sample_data(mcap.u.f.bac.T1), "data.frame") 
          set.seed(30)
    adonis(bc.mcapT1 ~ Treatment, data = mcap.u.f.samp.df.T1)  
     set.seed(30)
    adonis(bc.mcapT1 ~ Clade*Treatment, data = mcap.u.f.samp.df.T1)  
# Homogeneity of dispersion test  
  beta.mcap.u.f.T1 <- betadisper(bc.mcapT1, mcap.u.f.samp.df.T1$Clade)  #clade
    permutest(beta.mcap.u.f.T1, pairwise = T) 
  beta.mcap.u.f.T1 <- betadisper(bc.mcapT1, mcap.u.f.samp.df.T1$Treatment) #treatment
    permutest(beta.mcap.u.f.T1, pairwise = T) 

#TF
  bc.mcap.u.f.TF <- phyloseq::distance(mcap.u.f.bac.TF, method = "wunifrac")
     mcap.u.f.samp.df.TF <- as(sample_data(mcap.u.f.bac.TF), "data.frame")
    set.seed(30)
    adonis(bc.mcap.u.f.TF ~ Treatment, data = mcap.u.f.samp.df.TF)
    set.seed(30)
    adonis(bc.mcap.u.f.TF ~ Clade*Treatment, data = mcap.u.f.samp.df.TF)
  # Homogeneity of dispersion test  
  beta.mcap.u.f.TF <- betadisper(bc.mcap.u.f.TF, mcap.u.f.samp.df.TF$Clade) 
    permutest(beta.mcap.u.f.TF, pairwise = T) 
  beta.mcap.u.f.TF <- betadisper(bc.mcap.u.f.TF, mcap.u.f.samp.df.TF$Treatment) 
    permutest(beta.mcap.u.f.TF, pairwise = T) 
...
#make wunifrac curtis data matrix -T1 and TF
  bc.pcomp.f.T1F <- phyloseq::distance(pcomp.f.bac.T1F, method = "wunifrac")
     pcomp.f.samp.df.T1F <- as(sample_data(pcomp.f.bac.T1F), "data.frame") #sample df
      set.seed(30)
    adonis(bc.pcomp.f.T1F ~ Treatment*Time.Point, data = pcomp.f.samp.df.T1F) #adonis test no clade
   set.seed(30)
    adonis(bc.pcomp.f.T1F ~ Clade*Treatment*Time.Point, data = pcomp.f.samp.df.T1F)#adonis test with clade
 #heatmap
    #plot_heatmap(pcomp.f.bac.T1F, "NMDS", "wunifrac", "Parent.ID", "Phylum")
    
#T1
  bc.PcompT1 <- phyloseq::distance(pcomp.f.bac.T1, method = "wunifrac") 
      pcomp.f.samp.df.T1 <- as(sample_data(pcomp.f.bac.T1), "data.frame") 
   set.seed(30)
   adonis(bc.PcompT1 ~ Treatment, data = pcomp.f.samp.df.T1)  
    set.seed(30)
   adonis(bc.PcompT1 ~ Clade*Treatment, data = pcomp.f.samp.df.T1)  
# Homogeneity of dispersion test  
  beta.pcomp.f.T1 <- betadisper(bc.PcompT1, pcomp.f.samp.df.T1$Clade)  #clade
...
#TF
bc.pcomp.f.TF <- phyloseq::distance(pcomp.f.bac.TF, method = "wunifrac")
     pcomp.f.samp.df.TF <- as(sample_data(pcomp.f.bac.TF), "data.frame") 
      set.seed(30)
    adonis(bc.pcomp.f.TF ~ Treatment, data = pcomp.f.samp.df.TF)
     set.seed(30)
    adonis(bc.pcomp.f.TF ~ Clade*Treatment, data = pcomp.f.samp.df.TF)
  # Homogeneity of dispersion test  
  beta.pcomp.f.TF <- betadisper(bc.pcomp.f.TF, pcomp.f.samp.df.TF$Clade) 
...
#make wunifrac curtis data matrix -T1 and TF
  ...
  bc.pvar.f.f.T1F <- phyloseq::distance(pvar.f.f.bac.T1F, method = "wunifrac")
     pvar.f.f.samp.df.T1F <- as(sample_data(pvar.f.f.bac.T1F), "data.frame") #sample df
     set.seed(30)
adonis(bc.pvar.f.f.T1F ~ Treatment*Time.Point, data = pvar.f.f.samp.df.T1F) #adonis test no clade
    set.seed(30)
    adonis(bc.pvar.f.f.T1F ~ Clade*Treatment*Time.Point, data = pvar.f.f.samp.df.T1F)#adonis test with clade
 #heatmap
    #plot_heatmap(pvar.f.f.bac.T1F, "NMDS", "wunifrac", "Parent.ID", "Phylum")
    
#T1
                 

  bc.PvarT1 <- phyloseq::distance(pvar.f.f.bac.T1, method = "wunifrac") 
      pvar.f.f.samp.df.T1 <- as(sample_data(pvar.f.f.bac.T1), "data.frame") 
   set.seed(30)
   adonis(bc.PvarT1 ~ Treatment, data = pvar.f.f.samp.df.T1) 
     set.seed(30)
...
#TF
  bc.pvar.f.f.TF <- phyloseq::distance(pvar.f.f.bac.TF, method = "wunifrac")
     pvar.f.f.samp.df.TF <- as(sample_data(pvar.f.f.bac.TF), "data.frame") 
      set.seed(30)
      adonis(bc.pvar.f.f.TF ~ Treatment, data = pvar.f.f.samp.df.TF)
        set.seed(30)
...
#T1TF
#make wunifrac curtis data matrix -T1 and TF
  bc.pacu.f.T1F <- phyloseq::distance(pacu.f.bac.T1F, method = "wunifrac")
     pacu.f.samp.df.T1F <- as(sample_data(pacu.f.bac.T1F), "data.frame") #sample df
     set.seed(30)
     adonis(bc.pacu.f.T1F ~ Treatment*Time.Point, data = pacu.f.samp.df.T1F) #adonis test no clade
     set.seed(30)
     adonis(bc.pacu.f.T1F ~ Clade*Treatment*Time.Point, data = pacu.f.samp.df.T1F)#adonis test with clade
 #heatmap
    #plot_heatmap(pacu.f.bac.T1F, "NMDS", "wunifrac", "Parent.ID", "Phylum")
    
#T1
  bc.PacuT1 <- phyloseq::distance(pacu.f.bac.T1, method = "wunifrac") 
      pacu.f.samp.df.T1 <- as(sample_data(pacu.f.bac.T1), "data.frame") 
      set.seed(30)
      adonis(bc.PacuT1 ~ Treatment, data = pacu.f.samp.df.T1)  
      set.seed(30)
      adonis(bc.PacuT1 ~ Clade*Treatment, data = pacu.f.samp.df.T1)  
# Homogeneity of dispersion test  
  beta.pacu.f.T1 <- betadisper(bc.PacuT1, pacu.f.samp.df.T1$Clade)  #clade
...
#TF
  ...
  bc.pacu.f.TF <- phyloseq::distance(pacu.f.bac.TF, method = "wunifrac")
     pacu.f.samp.df.TF <- as(sample_data(pacu.f.bac.TF), "data.frame") 
      set.seed(30)
      adonis(bc.pacu.f.TF ~Treatment, data = pacu.f.samp.df.TF)
      set.seed(30)
      adonis(bc.pacu.f.TF ~ Clade*Treatment, data = pacu.f.samp.df.TF)
  # Homogeneity of dispersion test  
  beta.pacu.f.TF <- betadisper(bc.pacu.f.TF, pacu.f.samp.df.TF$Clade) 
  ...
  beta.pacu.f.TF <- betadisper(bc.pacu.f.TF, pacu.f.samp.df.TF$Treatment) 
    permutest(beta.pacu.f.TF, pairwise = T) 
```
Permanova UNIFRAC by ASV (no filter)
```{r}
#Bac.s.rel
...
s.u.samp.df <- as(sample_data(Bac.s.rel.u.T1F), "data.frame") #sample df
  #adonis test
set.seed(30)
adonis(Bac.s.u.T1F ~ Species*Treatment*Time.Point, data = s.u.samp.df)
set.seed(30)    
adonis(Bac.s.u.T1F ~ Species*Treatment*Time.Point*Clade, data = s.u.samp.df)

    beta.mcap.u.T1F <- betadisper(Bac.s.u.T1F, s.u.samp.df$Clade)  #clade
    permutest(beta.mcap.u.T1F, pairwise = T) 
      
     beta.mcap.u.f.T1 <- betadisper(Bac.s.u.T1F, s.u.samp.df$Species) #treatment
    permutest(beta.mcap.u.T1F, pairwise = T) 
############# mcap

#Mcap
mcap.u.f.bac.T1F <- subset_samples(Bac.s.rel.u.T1F, Species == "Montipora_capitata")
#mcap.u.f.bac.T1F = prune_taxa(taxa_sums(mcap.u.f.bac.T1F) > 0, mcap.u.f.bac.T1F) #this removes any OTU with 0s
...
#T1
  mcap.u.f.bac.mcapT1 <- phyloseq::distance(mcap.u.f.bac.T1, method = "wunifrac") 
      mcap.u.f.samp.df.T1 <- as(sample_data(mcap.u.f.bac.T1), "data.frame") 
          set.seed(30)
    adonis(mcap.u.f.bac.mcapT1 ~ Treatment, data = mcap.u.f.samp.df.T1)  
     set.seed(30)
    adonis(mcap.u.f.bac.mcapT1 ~ Clade*Treatment, data = mcap.u.f.samp.df.T1)  
# Homogeneity of dispersion test  
            set.seed(30)
  beta <- betadisper(mcap.u.f.bac.mcapT1, mcap.u.f.samp.df.T1$Clade)  #clade
    permutest(beta, pairwise = T) 
            set.seed(30)
  beta <- betadisper(mcap.u.f.bac.mcapT1, mcap.u.f.samp.df.T1$Treatment) #treatment
    permutest(beta, pairwise = T) 

#TF
  mcap.u.f.TF <- phyloseq::distance(mcap.u.f.bac.TF, method = "wunifrac")
     mcap.u.f.samp.df.TF <- as(sample_data(mcap.u.f.bac.TF), "data.frame")
    set.seed(30)
    adonis(mcap.u.f.TF ~ Treatment, data = mcap.u.f.samp.df.TF)
    set.seed(30)
    adonis(mcap.u.f.TF ~ Clade*Treatment, data = mcap.u.f.samp.df.TF)
  # Homogeneity of dispersion test  
  beta <- betadisper(mcap.u.f.TF, mcap.u.f.samp.df.TF$Clade) 
    permutest(beta, pairwise = T) 
  beta <- betadisper(mcap.u.f.TF, mcap.u.f.samp.df.TF$Treatment) 
    permutest(beta, pairwise = T) 
...
#make wunifrac curtis data matrix -T1 and TF
 ...
 #heatmap
    #plot_heatmap(pcomp.u.bac.T1F, "NMDS", "wunifrac", "Parent.ID", "Phylum")
       set.seed(30)
     beta <- betadisper(pcomp.u.T1F, pcomp.u.samp.df.T1F$Clade)  #clade
    permutest(beta, pairwise = T) 
          set.seed(30)
     beta <- betadisper(pcomp.u.T1F, pcomp.u.samp.df.T1F$Treatment) #treatment
    permutest(beta, pairwise = T) 
...
# Homogeneity of dispersion test  
       set.seed(30)
  beta <- betadisper(pcomp.u.T1, pcomp.u.samp.df.T1$Clade)  #clade
    permutest(beta, pairwise = T) 
        set.seed(30)
  beta <- betadisper(pcomp.u.T1, pcomp.u.samp.df.T1$Treatment) #treatment
    permutest(beta, pairwise = T) 
...
pcomp.u.TF <- phyloseq::distance(pcomp.u.bac.TF, method = "wunifrac")
  ...
  # Homogeneity of dispersion test  
      set.seed(30)
  beta <- betadisper(pcomp.u.TF, pcomp.u.samp.df.TF$Clade) 
    permutest(beta, pairwise = T) 
      set.seed(30)
  beta <- betadisper(pcomp.u.TF, pcomp.u.samp.df.TF$Treatment) 
    permutest(beta, pairwise = T) 
...
adonis(pvar.u.u.T1F ~ Treatment*Time.Point, data = pvar.u.u.samp.df.T1F) #adonis test no clade
 ...
 #heatmap
    #plot_heatmap(pvar.u.u.bac.T1F, "NMDS", "wunifrac", "Parent.ID", "Phylum")
    # Homogeneity of dispersion test  
        set.seed(30)
  beta <- betadisper(pvar.u.u.T1F, pvar.u.u.samp.df.T1F$Clade)  #clade
    permutest(beta, pairwise = T) 
        set.seed(30)
  beta <- betadisper(pvar.u.u.T1F, pvar.u.u.samp.df.T1F$Treatment) #treatment
    permutest(beta, pairwise = T) 
...
# Homogeneity of dispersion test  
          set.seed(30)
  beta.pvar.u.u.T1 <- betadisper(pvar.u.u.T1, pvar.u.u.samp.df.T1$Clade)  #clade
    permutest(beta.pvar.u.u.T1, pairwise = T) 
         set.seed(30)
  beta.pvar.u.u.T1 <- betadisper(pvar.u.u.T1, pvar.u.u.samp.df.T1$Treatment) #treatment
    permutest(beta.pvar.u.u.T1, pairwise = T) 
...
#TF
  ...
  # Homogeneity of dispersion test  
              set.seed(30)
  beta <- betadisper(pvar.u.u.TF, pvar.u.u.samp.df.TF$Clade) 
    permutest(beta, pairwise = T) 
          set.seed(30)
  beta <- betadisper(pvar.u.u.TF, pvar.u.u.samp.df.TF$Treatment) 
    permutest(beta, pairwise = T) 
...
#make wunifrac curtis data matrix -T1 and TF
 ...
 #heatmap
    #plot_heatmap(pacu.u.bac.T1F, "NMDS", "wunifrac", "Parent.ID", "Phylum")
    # Homogeneity of dispersion test  
        set.seed(30)
  beta <- betadisper(pacu.u.T1F, pacu.u.samp.df.T1F$Clade)  #clade
    permutest(beta, pairwise = T) 
       set.seed(30)
  beta <- betadisper(pacu.u.T1F, pacu.u.samp.df.T1F$Treatment) #treatment
    permutest(beta, pairwise = T) 
...
# Homogeneity of dispersion test 
            set.seed(30)
  beta <- betadisper(Pacu.u.T1, pacu.u.samp.df.T1$Clade)  #clade
    permutest(beta, pairwise = T) 
          set.seed(30)
  beta <- betadisper(Pacu.u.T1, pacu.u.samp.df.T1$Treatment) #treatment
    permutest(beta, pairwise = T) 
...
pacu.u.TF <- phyloseq::distance(pacu.u.bac.TF, method = "wunifrac")
  ...
  # Homogeneity of dispersion test  
       set.seed(30)
  beta <- betadisper(pacu.u.TF, pacu.u.samp.df.TF$Clade) 
    permutest(beta, pairwise = T) 
     set.seed(30)
  beta <- betadisper(pacu.u.TF, pacu.u.samp.df.TF$Treatment) 
    permutest(beta, pairwise = T) 
```
...
# Homogeneity of dispersion test  
  beta.mcap.g.T1 <- betadisper(bc.mcapT1, mcap.g.samp.df.T1$Clade)  #clade
    permutest(beta.mcap.g.T1, pairwise = T) 
  beta.mcap.g.T1 <- betadisper(bc.mcapT1, mcap.g.samp.df.T1$Treatment) #treatment
    permutest(beta.mcap.g.T1, pairwise = T) 
...
#TF
  ...
  # Homogeneity of dispersion test  
  beta.mcap.g.TF <- betadisper(bc.mcap.g.TF, mcap.g.samp.df.TF$Clade) 
    permutest(beta.mcap.g.TF, pairwise = T) 
  beta.mcap.g.TF <- betadisper(bc.mcap.g.TF, mcap.g.samp.df.TF$Treatment) 
    permutest(beta.mcap.g.TF, pairwise = T) 
...
# Homogeneity of dispersion test  
  beta.pcomp.g.T1 <- betadisper(bc.PcompT1, pcomp.g.samp.df.T1$Clade)  #clade
    permutest(beta.pcomp.g.T1, pairwise = T) 
  beta.pcomp.g.T1 <- betadisper(bc.PcompT1, pcomp.g.samp.df.T1$Treatment) #treatment
    permutest(beta.pcomp.g.T1, pairwise = T) 
...
#TF
  ...
  # Homogeneity of dispersion test  
  beta.pcomp.g.TF <- betadisper(bc.pcomp.g.TF, pcomp.g.samp.df.TF$Clade) 
    permutest(beta.pcomp.g.TF, pairwise = T) 
  beta.pcomp.g.TF <- betadisper(bc.pcomp.g.TF, pcomp.g.samp.df.TF$Treatment) 
    permutest(beta.pcomp.g.TF, pairwise = T) 
...
#T1.C15cj
  ...
  beta.pcomp.g.T1.C15cj <- betadisper(bc.PcompT1.C15cj, pcomp.g.samp.df.T1.C15cj$Treatment)
    permutest(beta.pcomp.g.T1.C15cj, pairwise = T) 
...
#TF.C15cj
  ...
  beta.pcomp.g.TF.C15cj <- betadisper(bc.pcomp.g.TF.C15cj, pcomp.g.samp.df.TF.C15cj$Treatment)
    permutest(beta.pcomp.g.TF.C15cj, pairwise = T) 
...
#make bray curtis data matrix -T1 and TF
 ...
 #heatmap
    #plot_heatmap(Pvar.g.bac.T1F, "NMDS", "bray", "Parent.ID", "Phylum")
...
# Homogeneity of dispersion test  
  beta.Pvar.g.T1 <- betadisper(bc.PvarT1, Pvar.g.samp.df.T1$Clade)  #clade
    permutest(beta.Pvar.g.T1, pairwise = T) 
  beta.Pvar.g.T1 <- betadisper(bc.PvarT1, Pvar.g.samp.df.T1$Treatment) #treatment
    permutest(beta.Pvar.g.T1, pairwise = T) 
...
#TF
  ...
  # Homogeneity of dispersion test  
  beta.Pvar.g.TF <- betadisper(bc.Pvar.g.TF, Pvar.g.samp.df.TF$Clade) 
    permutest(beta.Pvar.g.TF, pairwise = T) 
  beta.Pvar.g.TF <- betadisper(bc.Pvar.g.TF, Pvar.g.samp.df.TF$Treatment) 
    permutest(beta.Pvar.g.TF, pairwise = T) 
...
#T1.C27
  ...
  beta.Pvar.g.T1.C27 <- betadisper(bc.PvarT1.C27, Pvar.g.samp.df.T1.C27$Treatment)
    permutest(beta.Pvar.g.T1.C27, pairwise = T) 
...
#TF.C27
  ...
  beta.Pvar.g.TF.C27 <- betadisper(bc.Pvar.g.TF.C27, Pvar.g.samp.df.TF.C27$Treatment)
    permutest(beta.Pvar.g.TF.C27, pairwise = T) 
...
#T1.C1
  ...
  adonis(bc.PvarT1.C1 ~ Treatment, data = Pvar.g.samp.df.T1.C1)
    beta.Pvar.g.T1.C1 <- betadisper(bc.PvarT1.C1, Pvar.g.samp.df.T1.C1$Treatment)
  permutest(beta.Pvar.g.T1.C1, pairwise = T) 
...
#TF.C1
  ...
  beta.Pvar.g.TF.C1 <- betadisper(bc.Pvar.g.TF.C1, Pvar.g.samp.df.TF.C1$Treatment)
    permutest(beta.Pvar.g.TF.C1, pairwise = T) 
``` 
Pvar NMDS
```{r} 
## create palette for parent.ID and treatments
...
ggplot(scores.Pvar.g.samp.df, aes(x = NMDS1, y = NMDS2, shape=Code2, fill=Treatment)) + 
 geom_point(aes(size = 5) )+
    #geom_point(aes(colour = Treatment, size = 4, shape=Code2)) +
    scale_shape_manual(values = c(21, 22,24,25)) + 
  scale_color_manual(values=Pvar.g.Parent.colors)+
...
#TF only
set.seed(30)
ord.pvarTF <- ordinate(Pvar.g.bac.T1, "NMDS", "bray", trymax = 100) 
...
# Homogeneity of dispersion test  
  beta.Pacu.g.T1 <- betadisper(bc.PacuT1, Pacu.g.samp.df.T1$Clade)  #clade
    permutest(beta.Pacu.g.T1, pairwise = T) 
  beta.Pacu.g.T1 <- betadisper(bc.PacuT1, Pacu.g.samp.df.T1$Treatment) #treatment
    permutest(beta.Pacu.g.T1, pairwise = T) 
...
#TF
  ...
  # Homogeneity of dispersion test  
  beta.Pacu.g.TF <- betadisper(bc.Pacu.g.TF, Pacu.g.samp.df.TF$Clade) 
    permutest(beta.Pacu.g.TF, pairwise = T) 
  beta.Pacu.g.TF <- betadisper(bc.Pacu.g.TF, Pacu.g.samp.df.TF$Treatment) 
    permutest(beta.Pacu.g.TF, pairwise = T) 
...
#T1.CCC
  ...
  beta.Pacu.g.T1.CCC <- betadisper(bc.PacuT1.CCC, Pacu.g.samp.df.T1.CCC$Treatment)
    permutest(beta.Pacu.g.T1.CCC, pairwise = T) 
...
#TF.CCC
  ...
  beta.Pacu.g.TF.CCC <- betadisper(bc.Pacu.g.TF.CCC, Pacu.g.samp.df.TF.CCC$Treatment)
    permutest(beta.Pacu.g.TF.CCC, pairwise = T) 
...
#T1TF.C42
  ...
  adonis(bc.Pacu.g.T1F.C42 ~ Treatment*Time.Point, data = Pacu.g.samp.df.T1F.C42)
...
#T1.C42
  ...
  adonis(bc.PacuT1.C42 ~ Treatment, data = Pacu.g.samp.df.T1.C42)
    beta.Pacu.g.T1.C42 <- betadisper(bc.PacuT1.C42, Pacu.g.samp.df.T1.C42$Treatment)
  permutest(beta.Pacu.g.T1.C42, pairwise = T) 
...
#TF.C42
  ...
  beta.Pacu.g.TF.C42 <- betadisper(bc.Pacu.g.TF.C42, Pacu.g.samp.df.TF.C42$Treatment)
    permutest(beta.Pacu.g.TF.C42, pairwise = T) 
``` 
Pacu NMDS
```{r}
## create palette for parent.ID and treatments
...
ggplot(scores.Pacu.g.samp.df, aes(x = NMDS1, y = NMDS2, shape=Code2, fill=Treatment)) + 
 geom_point(aes(size = 5) )+
    #geom_point(aes(colour = Treatment, size = 4, shape=Code2)) +
    scale_shape_manual(values = c(21, 22,24,25)) + 
  scale_color_manual(values=Pacu.g.Parent.colors)+
