...
Bac.seqAll<-subset_taxa(Bac.seqAll, Domain !="unknown")
Bac.seqAll<-subset_taxa(Bac.seqAll, Domain !="Archaea")
...
# df Bac_RelA_stats.T1F
#Pcomp
Pcomp.bac.T1F <- subset_samples(Bac_RelA_stats.T1F, Species == "Montipora_capitata")
...
######### by phylotype: C vs CD
# C ONLY
  Pcomp.bac.T1F.C <- subset_samples(Pcomp.bac.T1F, Clade == "C")
  Pcomp.bac.T1.C <- subset_samples(Pcomp.bac.T1, Clade == "C")
  Pcomp.bac.TF.C <- subset_samples(Pcomp.bac.TF, Clade == "C")
  
#T1TF.C
  bc.Pcomp.T1F.C <- phyloseq::distance(Pcomp.bac.T1F.C, method = "bray")
    Pcomp.samp.df.T1F.C <- as(sample_data(Pcomp.bac.T1F.C), "data.frame") 
  adonis(bc.Pcomp.T1F.C ~ Treatment*Time.Point, data = Pcomp.samp.df.T1F.C)

#T1.C
  bc.PcompT1.C <- phyloseq::distance(Pcomp.bac.T1.C, method = "bray")
    Pcomp.samp.df.T1.C <- as(sample_data(Pcomp.bac.T1.C), "data.frame") #sample df
...
#TF.C
  bc.Pcomp.TF.C <- phyloseq::distance(Pcomp.bac.TF.C, method = "bray")
    Pcomp.samp.df.TF.C <- as(sample_data(Pcomp.bac.TF.C), "data.frame") #sample df
...
# CD ONLY
Pcomp.bac.T1F.CD <- subset_samples(Pcomp.bac.T1F, Clade == "CD")
Pcomp.bac.T1.CD <- subset_samples(Pcomp.bac.T1, Clade == "CD")
Pcomp.bac.TF.CD <- subset_samples(Pcomp.bac.TF, Clade == "CD")
  
#T1TF.CD
  bc.Pcomp.T1F.CD <- phyloseq::distance(Pcomp.bac.T1F.CD, method = "bray")
  Pcomp.samp.df.T1F.CD <- as(sample_data(Pcomp.bac.T1F.CD), "data.frame") 
  adonis(bc.Pcomp.T1F.CD ~ Treatment*Time.Point, data = Pcomp.samp.df.T1F.CD)

#T1.CD
  bc.PcompT1.CD <- phyloseq::distance(Pcomp.bac.T1.CD, method = "bray")
    Pcomp.samp.df.T1.CD <- as(sample_data(Pcomp.bac.T1.CD), "data.frame") 
  adonis(bc.PcompT1.CD ~ Treatment, data = Pcomp.samp.df.T1.CD)
    beta.Pcomp.T1.CD <- betadisper(bc.PcompT1.CD, Pcomp.samp.df.T1.CD$Treatment)
  permutest(beta.Pcomp.T1.CD, pairwise = T) 

#TF.CD
  bc.Pcomp.TF.CD <- phyloseq::distance(Pcomp.bac.TF.CD, method = "bray")
    Pcomp.samp.df.TF.CD <- as(sample_data(Pcomp.bac.TF.CD), "data.frame") 
...
#C T1 and TF 
set.seed(30)
ord.Pcomp_C <- ordinate(Pcomp.bac.T1F.C , "NMDS", "bray", trymax = 100) 
stressplot(ord.Pcomp_C)
scores.Pcomp_C<-as.data.frame(cbind(vegan::scores(ord.Pcomp_C, display="sites"))) # these are "points" ask hannah 
...
#C T1
set.seed(30)
ord.Pcomp_C.T1 <- ordinate(Pcomp.bac.T1.C, "NMDS", "bray", trymax = 100) 
...
#C TF
set.seed(30)
ord.Pcomp_C.TF <- ordinate(Pcomp.bac.TF.C, "NMDS", "bray", trymax = 100) 
stressplot(ord.Pcomp_C.TF)
scores.Pcomp_C.TF<-as.data.frame(cbind(vegan::scores(ord.Pcomp_C.TF, display="sites"))) # these are "points" ask hannah 
...
#CD Pcomp.bacT1F.CD
set.seed(30)
ord.Pcomp_CD <- ordinate(Pcomp.bac.T1F.CD, "NMDS", "bray", trymax = 100) 
stressplot(ord.Pcomp_CD)
scores.Pcomp_CD<-as.data.frame(cbind(vegan::scores(ord.Pcomp_CD, display="sites"))) # these are "points" ask hannah 
...
geom_point(aes(stroke=3, colour = Parent.ID, shape=Time.Point,size = 4) )+
  ...
  ggtitle("M. capitata C&D T1 TF") +
  theme_classic()
#ggsave("Pcomp_ITS2_CD_its_T1TF.pdf")

#CD T1
set.seed(30)
ord.Pcomp_CD.T1 <- ordinate(Pcomp.bac.T1.CD , "NMDS", "bray", trymax = 100) 
stressplot(ord.Pcomp_CD.T1)
scores.Pcomp_CD.T1<-as.data.frame(cbind(vegan::scores(ord.Pcomp_CD.T1, display="sites"))) # these are "points" ask hannah 
...
geom_point(aes(stroke=3, colour = Parent.ID, shape=Treatment, size = 4) )+
  ...
  ggtitle("M. capitata T1 CD") +
  theme_classic()
#ggsave("Pcomp_ITS2_CD_T1.pdf")

#CD TF
set.seed(30)
ord.Pcomp_CD.TF <- ordinate(Pcomp.bac.TF.CD, "NMDS", "bray", trymax = 100) 
stressplot(ord.Pcomp_CD.TF)
scores.Pcomp_CD.TF<-as.data.frame(cbind(vegan::scores(ord.Pcomp_CD.TF, display="sites"))) # these are "points" ask hannah 
...
# df Bac_RelA_stats.T1F
#Pvar
Pvar.bac.T1F <- subset_samples(Bac_RelA_stats.T1F, Species == "Montipora_capitata")
...
######### by phylotype: C vs CD
# C ONLY
  Pvar.bac.T1F.C <- subset_samples(Pvar.bac.T1F, Clade == "C")
  Pvar.bac.T1.C <- subset_samples(Pvar.bac.T1, Clade == "C")
  Pvar.bac.TF.C <- subset_samples(Pvar.bac.TF, Clade == "C")
  
#T1TF.C
  bc.Pvar.T1F.C <- phyloseq::distance(Pvar.bac.T1F.C, method = "bray")
    Pvar.samp.df.T1F.C <- as(sample_data(Pvar.bac.T1F.C), "data.frame") 
  adonis(bc.Pvar.T1F.C ~ Treatment*Time.Point, data = Pvar.samp.df.T1F.C)

#T1.C
  bc.PvarT1.C <- phyloseq::distance(Pvar.bac.T1.C, method = "bray")
    Pvar.samp.df.T1.C <- as(sample_data(Pvar.bac.T1.C), "data.frame") #sample df
...
#TF.C
  bc.Pvar.TF.C <- phyloseq::distance(Pvar.bac.TF.C, method = "bray")
    Pvar.samp.df.TF.C <- as(sample_data(Pvar.bac.TF.C), "data.frame") #sample df
...
# CD ONLY
Pvar.bac.T1F.CD <- subset_samples(Pvar.bac.T1F, Clade == "CD")
Pvar.bac.T1.CD <- subset_samples(Pvar.bac.T1, Clade == "CD")
Pvar.bac.TF.CD <- subset_samples(Pvar.bac.TF, Clade == "CD")
  
#T1TF.CD
  bc.Pvar.T1F.CD <- phyloseq::distance(Pvar.bac.T1F.CD, method = "bray")
  Pvar.samp.df.T1F.CD <- as(sample_data(Pvar.bac.T1F.CD), "data.frame") 
  adonis(bc.Pvar.T1F.CD ~ Treatment*Time.Point, data = Pvar.samp.df.T1F.CD)

#T1.CD
  bc.PvarT1.CD <- phyloseq::distance(Pvar.bac.T1.CD, method = "bray")
    Pvar.samp.df.T1.CD <- as(sample_data(Pvar.bac.T1.CD), "data.frame") 
  adonis(bc.PvarT1.CD ~ Treatment, data = Pvar.samp.df.T1.CD)
    beta.Pvar.T1.CD <- betadisper(bc.PvarT1.CD, Pvar.samp.df.T1.CD$Treatment)
  permutest(beta.Pvar.T1.CD, pairwise = T) 

#TF.CD
  bc.Pvar.TF.CD <- phyloseq::distance(Pvar.bac.TF.CD, method = "bray")
    Pvar.samp.df.TF.CD <- as(sample_data(Pvar.bac.TF.CD), "data.frame") 
...
```{r}
## create palette for parent.ID and treatments
Pvar.Parent.colors <- c("363" = "green4",  "364" = "firebrick3", "365" ="deeppink4", "366" = "orange", "367" = "green1","368" = "gold",  "369"= "hotpink", "370" ="darkslateblue", "371" = "cyan", "372" = "darkorange","373" ="darkorchid1", "374" = "lightblue", Ambient = "Blue", High = "Red","C Ambient"="blue","C High"="red", "CD Ambient"="darkblue", "CD High"="darkred", "Ambient T1"="darkred", "Ambient TF"="darkblue", "High T1"="pink","High TF"="darkred") 
...
geom_point(aes(stroke=3, colour = Parent.ID, shape=Treatment,size = 4) )+
  ...
  ggtitle("M. capitata Cladocopium") +
  theme_classic()
#ggsave("PvarTFits_C.pdf")


#C T1
set.seed(30)
ord.Pvar_C.T1 <- ordinate(Pvar.bac.T1.C, "NMDS", "bray", trymax = 100) 
stressplot(ord.Pvar_C.T1)
scores.Pvar_C.T1<-as.data.frame(cbind(vegan::scores(ord.Pvar_C.T1, display="sites"))) # these are "points" ask hannah 
...
# df Bac_RelA_stats.T1F
#Pacu
Pacu.bac.T1F <- subset_samples(Bac_RelA_stats.T1F, Species == "Montipora_capitata")
...
######### by phylotype: C vs CD
# C ONLY
  Pacu.bac.T1F.C <- subset_samples(Pacu.bac.T1F, Clade == "C")
  Pacu.bac.T1.C <- subset_samples(Pacu.bac.T1, Clade == "C")
  Pacu.bac.TF.C <- subset_samples(Pacu.bac.TF, Clade == "C")
  
#T1TF.C
  bc.Pacu.T1F.C <- phyloseq::distance(Pacu.bac.T1F.C, method = "bray")
    Pacu.samp.df.T1F.C <- as(sample_data(Pacu.bac.T1F.C), "data.frame") 
  adonis(bc.Pacu.T1F.C ~ Treatment*Time.Point, data = Pacu.samp.df.T1F.C)

#T1.C
  bc.PacuT1.C <- phyloseq::distance(Pacu.bac.T1.C, method = "bray")
    Pacu.samp.df.T1.C <- as(sample_data(Pacu.bac.T1.C), "data.frame") #sample df
...
#TF.C
  bc.Pacu.TF.C <- phyloseq::distance(Pacu.bac.TF.C, method = "bray")
    Pacu.samp.df.TF.C <- as(sample_data(Pacu.bac.TF.C), "data.frame") #sample df
...
# CD ONLY
Pacu.bac.T1F.CD <- subset_samples(Pacu.bac.T1F, Clade == "CD")
Pacu.bac.T1.CD <- subset_samples(Pacu.bac.T1, Clade == "CD")
Pacu.bac.TF.CD <- subset_samples(Pacu.bac.TF, Clade == "CD")
  
#T1TF.CD
  bc.Pacu.T1F.CD <- phyloseq::distance(Pacu.bac.T1F.CD, method = "bray")
  Pacu.samp.df.T1F.CD <- as(sample_data(Pacu.bac.T1F.CD), "data.frame") 
  adonis(bc.Pacu.T1F.CD ~ Treatment*Time.Point, data = Pacu.samp.df.T1F.CD)

#T1.CD
  bc.PacuT1.CD <- phyloseq::distance(Pacu.bac.T1.CD, method = "bray")
    Pacu.samp.df.T1.CD <- as(sample_data(Pacu.bac.T1.CD), "data.frame") 
  adonis(bc.PacuT1.CD ~ Treatment, data = Pacu.samp.df.T1.CD)
    beta.Pacu.T1.CD <- betadisper(bc.PacuT1.CD, Pacu.samp.df.T1.CD$Treatment)
  permutest(beta.Pacu.T1.CD, pairwise = T) 

#TF.CD
  bc.Pacu.TF.CD <- phyloseq::distance(Pacu.bac.TF.CD, method = "bray")
    Pacu.samp.df.TF.CD <- as(sample_data(Pacu.bac.TF.CD), "data.frame") 
...
```{r}
## create palette for parent.ID and treatments
Pacu.Parent.colors <- c("363" = "green4",  "364" = "firebrick3", "365" ="deeppink4", "366" = "orange", "367" = "green1","368" = "gold",  "369"= "hotpink", "370" ="darkslateblue", "371" = "cyan", "372" = "darkorange","373" ="darkorchid1", "374" = "lightblue", Ambient = "Blue", High = "Red","C Ambient"="blue","C High"="red", "CD Ambient"="darkblue", "CD High"="darkred", "Ambient T1"="darkred", "Ambient TF"="darkblue", "High T1"="pink","High TF"="darkred") 
...
#C T1 and TF 
set.seed(30)
ord.Pacu_C <- ordinate(Pacu.bac.T1F.C , "NMDS", "bray", trymax = 100) 
stressplot(ord.Pacu_C)
scores.Pacu_C<-as.data.frame(cbind(vegan::scores(ord.Pacu_C, display="sites"))) # these are "points" ask hannah 
...
geom_point(aes(stroke=3, colour = Parent.ID, shape=Treatment,size = 4) )+
  ...
  ggtitle("M. capitata Cladocopium") +
  theme_classic()
#ggsave("PacuTFits_C.pdf")


#C T1
set.seed(30)
ord.Pacu_C.T1 <- ordinate(Pacu.bac.T1.C, "NMDS", "bray", trymax = 100) 
stressplot(ord.Pacu_C.T1)
scores.Pacu_C.T1<-as.data.frame(cbind(vegan::scores(ord.Pacu_C.T1, display="sites"))) # these are "points" ask hannah 
...
geom_point(aes(stroke=2, colour = Parent.ID,shape=Treatment, size = 4) )+
  ...
  ggtitle("M. capitata T1 Cladocopium") +
  theme_classic()
#ggsave("Pacu_T1_its_C.pdf")

#C TF
set.seed(30)
ord.Pacu_C.TF <- ordinate(Pacu.bac.TF.C, "NMDS", "bray", trymax = 100) 
stressplot(ord.Pacu_C.TF)
scores.Pacu_C.TF<-as.data.frame(cbind(vegan::scores(ord.Pacu_C.TF, display="sites"))) # these are "points" ask hannah 
...
geom_point(aes(stroke=3, colour = Parent.ID, shape=Treatment,size = 4) )+
  ...
  ggtitle("M. capitata C TF") +
  theme_classic()
#ggsave("Pacu_TF_its_TF_C.pdf")


#CD Pacu.bacT1F.CD
set.seed(30)
ord.Pacu_CD <- ordinate(Pacu.bac.T1F.CD, "NMDS", "bray", trymax = 100) 
stressplot(ord.Pacu_CD)
scores.Pacu_CD<-as.data.frame(cbind(vegan::scores(ord.Pacu_CD, display="sites"))) # these are "points" ask hannah 
...
geom_point(aes(stroke=3, colour = Parent.ID, shape=Time.Point,size = 4) )+
  ...
  ggtitle("M. capitata C&D T1 TF") +
  theme_classic()
#ggsave("Pacu_ITS2_CD_its_T1TF.pdf")

#CD T1
set.seed(30)
ord.Pacu_CD.T1 <- ordinate(Pacu.bac.T1.CD , "NMDS", "bray", trymax = 100) 
stressplot(ord.Pacu_CD.T1)
scores.Pacu_CD.T1<-as.data.frame(cbind(vegan::scores(ord.Pacu_CD.T1, display="sites"))) # these are "points" ask hannah 
...
geom_point(aes(stroke=3, colour = Parent.ID, shape=Treatment, size = 4) )+
  ...
  ggtitle("M. capitata T1 CD") +
  theme_classic()
#ggsave("Pacu_ITS2_CD_T1.pdf")

#CD TF
set.seed(30)
ord.Pacu_CD.TF <- ordinate(Pacu.bac.TF.CD, "NMDS", "bray", trymax = 100) 
stressplot(ord.Pacu_CD.TF)
scores.Pacu_CD.TF<-as.data.frame(cbind(vegan::scores(ord.Pacu_CD.TF, display="sites"))) # these are "points" ask hannah 
