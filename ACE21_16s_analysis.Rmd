 ...
 #try plotting only the top 10 FAMs    
    ...
    top10P.names.Pvar = sort(tapply(taxa_sums(pvar.f.f.bac.T1F), tax_table(pvar.f.f.bac.T1F)[, "Family"], sum), TRUE)[1:10]
      ...
      #rename Fam with taxa
            ...
            names(Pvar.u.f.bac.T1F.top10P.OTU.df)[names(Pvar.u.f.bac.T1F.top10P.OTU.df) == "Otu00012"] <- "Bacteria_unclassified"
  ...
  #try plotting only the top 10 FAMs    
    ...
    top10P.names.Pacu = sort(tapply(taxa_sums(pacu.f.bac.T1F), tax_table(pacu.f.bac.T1F)[, "Family"], sum), TRUE)[1:10]
      ...
      #rename Fam with taxa
            ...
            names(Pacu.u.f.bac.T1F.top10P.OTU.df)[names(Pacu.u.f.bac.T1F.top10P.OTU.df) == "Otu000226"] <- "Gammaproteobacteria_unclassified"
            names(Pacu.u.f.bac.T1F.top10P.OTU.df)[names(Pacu.u.f.bac.T1F.top10P.OTU.df) == "Otu00084"] <- "Thalassospiraceae"
