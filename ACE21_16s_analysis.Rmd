...
adonis(Bac.s.u.T1F ~ Species*Treatment*Time.Point*Clade, data = s.u.samp.df)
     ...
     # Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(Bac.s.u.T1F, s.u.samp.df$Clade, type = "centroid")) #put in distance matrix
   set.seed(30)
    permutest(betadisper(Bac.s.u.T1F, s.u.samp.df$Treatment, type = "centroid")) #put in distance matrix
############# mcap
...
#make bray curtis data matrix -T1 and TF
  u.mcap.u.T1F <- phyloseq::distance(mcap.u.bac.T1F, method = "wunifrac")
     mcap.u.samp.df.T1F <- as(sample_data(mcap.u.bac.T1F), "data.frame") #sample df
       set.seed(30)
    adonis2(u.mcap.u.T1F ~ Treatment*Time.Point, data = mcap.u.samp.df.T1F) #adonis test no clade
      set.seed(30)
    adonis2(u.mcap.u.T1F ~ Clade*Treatment*Time.Point, data = mcap.u.samp.df.T1F)#adonis test with clade
   # Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(u.mcap.u.T1F, mcap.u.samp.df.T1F$Clade, type = "centroid")) #put in distance matrix
   set.seed(30)
    permutest(betadisper(u.mcap.u.T1F, mcap.u.samp.df.T1F$Treatment, type = "centroid")) #put in distance matrix
...
#T1
  mcap.u.bac.mcapT1 <- phyloseq::distance(mcap.u.bac.T1, method = "wunifrac") 
      mcap.u.samp.df.T1 <- as(sample_data(mcap.u.bac.T1), "data.frame") 
          set.seed(30)
    adonis2(mcap.u.bac.mcapT1 ~ Treatment, data = mcap.u.samp.df.T1)  
     set.seed(30)
    adonis2(mcap.u.bac.mcapT1 ~ Clade*Treatment, data = mcap.u.samp.df.T1)  
# Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(mcap.u.bac.mcapT1, mcap.u.samp.df.T1$Clade, type = "centroid")) #put in distance matrix
   set.seed(30)
    permutest(betadisper(mcap.u.bac.mcapT1, mcap.u.samp.df.T1$Treatment, type = "centroid")) #put in distance matrix
...
#TF
  mcap.u.TF <- phyloseq::distance(mcap.u.bac.TF, method = "wunifrac")
    ...
    set.seed(30)
    adonis2(mcap.u.TF ~ Treatment, data = mcap.u.samp.df.TF)
    set.seed(30)
    adonis2(mcap.u.TF ~ Clade*Treatment, data = mcap.u.samp.df.TF)
  # Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(mcap.u.TF, mcap.u.samp.df.TF$Clade, type = "centroid")) #put in distance matrix
   set.seed(30)
    permutest(betadisper(mcap.u.TF, mcap.u.samp.df.TF$Treatment, type = "centroid")) #put in distance matrix
...
#make wunifrac curtis data matrix -T1 and TF
  pcomp.u.T1F <- phyloseq::distance(pcomp.u.bac.T1F, method = "wunifrac")
     pcomp.u.samp.df.T1F <- as(sample_data(pcomp.u.bac.T1F), "data.frame") #sample df
      set.seed(30)
    adonis2(pcomp.u.T1F ~ Treatment*Time.Point, data = pcomp.u.samp.df.T1F) #adonis test no clade
   set.seed(30)
    adonis2(pcomp.u.T1F ~ Clade*Treatment*Time.Point, data = pcomp.u.samp.df.T1F)#adonis test with clade
  # Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(pcomp.u.T1F, pcomp.u.samp.df.T1F$Clade, type = "centroid")) #put in distance matrix
   set.seed(30)
    permutest(betadisper(pcomp.u.T1F, pcomp.u.samp.df.T1F$Treatment, type = "centroid")) #put in distance matrix
    
#T1
  pcomp.u.T1 <- phyloseq::distance(pcomp.u.bac.T1, method = "wunifrac") 
      pcomp.u.samp.df.T1 <- as(sample_data(pcomp.u.bac.T1), "data.frame") 
   set.seed(30)
   adonis2(pcomp.u.T1 ~ Treatment, data = pcomp.u.samp.df.T1)  
    set.seed(30)
   adonis(pcomp.u.T1 ~ Clade*Treatment, data = pcomp.u.samp.df.T1)  
 # Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(pcomp.u.T1, pcomp.u.samp.df.T1$Clade, type = "centroid")) #put in distance matrix
   set.seed(30)
    permutest(betadisper(pcomp.u.T1, pcomp.u.samp.df.T1$Treatment, type = "centroid")) #put in distance matrix

#TF
pcomp.u.TF <- phyloseq::distance(pcomp.u.bac.TF, method = "wunifrac")
     pcomp.u.samp.df.TF <- as(sample_data(pcomp.u.bac.TF), "data.frame") 
      set.seed(30)
    adonis2(pcomp.u.TF ~ Treatment, data = pcomp.u.samp.df.TF)
     set.seed(30)
    adonis2(pcomp.u.TF ~ Clade*Treatment, data = pcomp.u.samp.df.TF)
  # Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(pcomp.u.TF, pcomp.u.samp.df.TF$Clade, type = "centroid")) #put in distance matrix
   set.seed(30)
    permutest(betadisper(pcomp.u.TF, pcomp.u.samp.df.TF$Treatment, type = "centroid")) #put in distance matrix
...
adonis(pvar.u.u.T1F ~ Treatment*Time.Point, data = pvar.u.u.samp.df.T1F) #adonis test no clade
  ...
  # Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(pvar.u.u.T1F, pvar.u.u.samp.df.T1F$Clade, type = "centroid")) #put in distance matrix
   set.seed(30)
    permutest(betadisper(pvar.u.u.T1F, pvar.u.u.samp.df.T1F$Treatment, type = "centroid")) #put in distance matrix
...
# Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(pvar.u.u.T1, pvar.u.u.samp.df.T1$Clade, type = "centroid")) #put in distance matrix
   set.seed(30)
    permutest(betadisper(pvar.u.u.T1, pvar.u.u.samp.df.T1$Treatment, type = "centroid")) #put in distance matrix
...
#TF
  ...
  # Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(pvar.u.u.TF, pvar.u.u.samp.df.TF$Clade, type = "centroid")) #put in distance matrix
   set.seed(30)
    permutest(betadisper(pvar.u.u.TF, pvar.u.u.samp.df.TF$Treatment, type = "centroid")) #put in distance matrix
...
#make wunifrac curtis data matrix -T1 and TF
  ...
  # Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(pacu.u.T1F, pacu.u.samp.df.T1F$Clade, type = "centroid")) #put in distance matrix
   set.seed(30)
    permutest(betadisper(pacu.u.T1F, pacu.u.samp.df.T1F$Treatment, type = "centroid")) #put in distance matrix
...
#T1
 ...
 # Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(Pacu.u.T1, pacu.u.samp.df.T1$Clade, type = "centroid")) #put in distance matrix
   set.seed(30)
    permutest(betadisper(Pacu.u.T1, pacu.u.samp.df.T1$Treatment, type = "centroid")) #put in distance matrix
...
# Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(pacu.u.TF, pacu.u.samp.df.TF$Clade, type = "centroid")) #put in distance matrix
   set.seed(30)
    permutest(betadisper(pacu.u.TF, pacu.u.samp.df.TF$Treatment, type = "centroid")) #put in distance matrix
```
...
YOU ARE HERE
# dispersion models for ASVs
```{r}
#ok you need to do this univariate, which means at each time point between treatments (for now)

#mcap 
#T1 mcap.u.bac.mcapT1
 mcap.u.bac.mcapT1 <- phyloseq::distance(mcap.u.bac.T1, method = "wunifrac") 
      mcap.u.samp.df.T1 <- as(sample_data(mcap.u.bac.T1), "data.frame") 
mcap.score.disp.T1<-betadisper(mcap.u.bac.mcapT1, mcap.u.samp.df.T1$Treatment, type = c("centroid"))

disp.score<-scores(mcap.score.disp.T1, display = c("sites", "centroids"))
```
...
# hist(sqrt(erich.tab2$observed))
# ggqqplot(sqrt(erich.tab2$observed))
...
ggqqplot(erich.tab2$evenness_pielou)
hist(sqrt(max(erich.tab2$evenness_pielou+1)-erich.tab2$evenness_pielou))#nope
...
observed_alpha_mod<-lmer(observed_log ~ Species*Time.Point*Treatment+(1|Parent.ID)+(1|Tank.num), data=erich.tab2) #adding tank is singularity
  ...
  observed_alpha_mod<-lmer(observed_log ~ Species*Time.Point*Treatment*Clade+(1|Parent.ID), data=erich.tab2) #adding tank is singularity
  anova(observed_alpha_mod) 
  qqPlot(residuals(observed_alpha_mod)) 
  emm<-emmeans(observed_alpha_mod,  ~ Time.Point*Treatment, adjust="Tukey")
  cld(emm)
...
################Mcap only
 #t1TF
  Mcap_alpha_mod<-lmer(observed_log ~ Time.Point*Treatment+(1|Parent.ID), data=erich.tab2.mcap) #adding tank is singularity
  ...
  Mcap_alpha_mod<-lmer(observed_log ~ Time.Point*Treatment*Clade+(1|Parent.ID), data=erich.tab2.mcap) #adding tank is singularity
  anova(Mcap_alpha_mod) 
  qqPlot(residuals(Mcap_alpha_mod)) 
...
####### PCOMP only
  #t1TF
  pcomp_alpha_mod<-lmer(observed_log ~ Time.Point*Treatment+(1|Parent.ID)+(1|Tank.num), data=erich.tab2.pcomp) 
  ...
  pcomp_alpha_mod<-lmer(observed_log ~ Time.Point*Treatment*Clade+(1|Parent.ID)+(1|Tank.num), data=erich.tab2.pcomp) 
  anova(pcomp_alpha_mod) 
  qqPlot(residuals(pcomp_alpha_mod)) 
