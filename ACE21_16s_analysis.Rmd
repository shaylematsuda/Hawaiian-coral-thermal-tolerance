...
# Read the OTU table (keep characters as characters, avoid factors)
...
#not all are being caught, do manually, N77.S3.L001, N49.S4.L001, 832.S2.L001, 775.S8.L001, 619.S7.L001, 2136.S6.L001, 1413.S9.L001, 
...
Bac.seq <- subset_samples(Bac.seq, sample_name.1 != "1753b" )
Bac.seq <- subset_samples(Bac.seq, sample_name.1 != "208" )
Bac.seq <- subset_samples(Bac.seq, sample_name.1 != "3476" )
Bac.seq <- subset_samples(Bac.seq, sample_name.1 != "N35b" )
Bac.seq <- subset_samples(Bac.seq, sample_name.1 != "3149" )
Bac.seq <- subset_samples(Bac.seq, sample_name.1 != "3149" )
Bac.seq <- subset_samples(Bac.seq, sample_name.1 != "1240" )
...
#Permanova UNIFRAC by ASV 20220514 - REDOING adonis T0-T1, T1-TF by TREATMENT (high only, ambient only) bc you can't find
This is solid and what you need to us for the R2 between timepoints models
This is with T0 split by 'treatment' (not split see next chunk)
```{r}         
Bac.s.rel.u.adon<-Bac.s.rel #make a copy
...
#T0-T1 
  mcap.u.bac<- subset_samples(Bac.s.rel.u.adon, Species == "Montipora_capitata")
...
#TF-T0
        mcap.u.bac.TFT0.amb <- subset_samples(mcap.u.bac.amb, Time.Point == "T0"|Time.Point=="TF")
       mcap.u.bac.TFT0.amb = prune_taxa(taxa_sums(mcap.u.bac.TFT0.amb) > 0, mcap.u.bac.TFT0.amb) #this removes any OTU with 0s
        sample_sums(mcap.u.bac.TFT0.amb)
      
  #make bray curtis data matrix
  u.mcap.u.bac.TFT0.amb <- phyloseq::distance(mcap.u.bac.TFT0.amb, method = "wunifrac")
     mcap.u.samp.df.TFT0.amb <- as(sample_data(mcap.u.bac.TFT0.amb), "data.frame") #sample df

  set.seed(30)
    adonis2(u.mcap.u.bac.TFT0.amb ~ Time.Point, data = mcap.u.samp.df.TFT0.amb) #adonis test
  set.seed(30)
    permutest(betadisper(u.mcap.u.bac.TFT0.amb, mcap.u.samp.df.TFT0.amb$Time.Point, type = "centroid"))     
...
#TF-T0 
        mcap.u.bac.TFT0.high <- subset_samples(mcap.u.bac.high, Time.Point == "T0"|Time.Point=="TF")
       mcap.u.bac.TFT0.high = prune_taxa(taxa_sums(mcap.u.bac.TFT0.high) > 0, mcap.u.bac.TFT0.high) #this removes any OTU with 0s
        sample_sums(mcap.u.bac.TFT0.high)
      
  #make bray curtis data matrix
  u.mcap.u.bac.TFT0.high <- phyloseq::distance(mcap.u.bac.TFT0.high, method = "wunifrac")
     mcap.u.samp.df.TFT0.high <- as(sample_data(mcap.u.bac.TFT0.high), "data.frame") #sample df

  set.seed(30)
    adonis2(u.mcap.u.bac.TFT0.high ~ Time.Point, data = mcap.u.samp.df.TFT0.high) #adonis test
  set.seed(30)
    permutest(betadisper(u.mcap.u.bac.TFT0.high, mcap.u.samp.df.TFT0.high$Time.Point, type = "centroid"))     
...
#T0-T1 
  pcomp.u.bac<- subset_samples(Bac.s.rel.u.adon, Species == "Porites_compressa")
...
#TF-T0
        pcomp.u.bac.TFT0.amb <- subset_samples(pcomp.u.bac.amb, Time.Point == "T0"|Time.Point=="TF")
       pcomp.u.bac.TFT0.amb = prune_taxa(taxa_sums(pcomp.u.bac.TFT0.amb) > 0, pcomp.u.bac.TFT0.amb) #this removes any OTU with 0s
        sample_sums(pcomp.u.bac.TFT0.amb)
      
  #make bray curtis data matrix
  u.pcomp.u.bac.TFT0.amb <- phyloseq::distance(pcomp.u.bac.TFT0.amb, method = "wunifrac")
     pcomp.u.samp.df.TFT0.amb <- as(sample_data(pcomp.u.bac.TFT0.amb), "data.frame") #sample df

  set.seed(30)
    adonis2(u.pcomp.u.bac.TFT0.amb ~ Time.Point, data = pcomp.u.samp.df.TFT0.amb) #adonis test
  set.seed(30)
    permutest(betadisper(u.pcomp.u.bac.TFT0.amb, pcomp.u.samp.df.TFT0.amb$Time.Point, type = "centroid"))     
...
#High only   
  #T0-T1 
    pcomp.u.bac.high <- subset_samples(pcomp.u.bac, Treatment == "High")
       ...
       pcomp.u.bac.T0T1.high = prune_taxa(taxa_sums(pcomp.u.bac.T0T1.high) > 0, pcomp.u.bac.T0T1.high) #this removes any OTU with 0s
...
#T1-TF 
       ...
       pcomp.u.bac.T1TF.high = prune_taxa(taxa_sums(pcomp.u.bac.T1TF.high) > 0, pcomp.u.bac.T1TF.high) #this removes any OTU with 0s
...
#TF-T0 
        pcomp.u.bac.TFT0.high <- subset_samples(pcomp.u.bac.high, Time.Point == "T0"|Time.Point=="TF")
       pcomp.u.bac.TFT0.high = prune_taxa(taxa_sums(pcomp.u.bac.TFT0.high) > 0, pcomp.u.bac.TFT0.high) #this removes any OTU with 0s
        sample_sums(pcomp.u.bac.TFT0.high)
      
  #make bray curtis data matrix
  u.pcomp.u.bac.TFT0.high <- phyloseq::distance(pcomp.u.bac.TFT0.high, method = "wunifrac")
     pcomp.u.samp.df.TFT0.high <- as(sample_data(pcomp.u.bac.TFT0.high), "data.frame") #sample df

  set.seed(30)
    adonis2(u.pcomp.u.bac.TFT0.high ~ Time.Point, data = pcomp.u.samp.df.TFT0.high) #adonis test
  set.seed(30)
    permutest(betadisper(u.pcomp.u.bac.TFT0.high, pcomp.u.samp.df.TFT0.high$Time.Point, type = "centroid"))     
...
#T0-T1 
  pvar.u.bac<- subset_samples(Bac.s.rel.u.adon, Species == "Pavona_varians")
...
#T1-TF 
  ...
  set.seed(30)
    permutest(betadisper(u.pvar.u.bac.T1TF.amb, pvar.u.samp.df.T1TF.amb$Time.Point, type = "centroid")) 
    
#TF-T0
        pvar.u.bac.TFT0.amb <- subset_samples(pvar.u.bac.amb, Time.Point == "T0"|Time.Point=="TF")
       pvar.u.bac.TFT0.amb = prune_taxa(taxa_sums(pvar.u.bac.TFT0.amb) > 0, pvar.u.bac.TFT0.amb) #this removes any OTU with 0s
        sample_sums(pvar.u.bac.TFT0.amb)
      
  #make bray curtis data matrix
  u.pvar.u.bac.TFT0.amb <- phyloseq::distance(pvar.u.bac.TFT0.amb, method = "wunifrac")
     pvar.u.samp.df.TFT0.amb <- as(sample_data(pvar.u.bac.TFT0.amb), "data.frame") #sample df

  set.seed(30)
    adonis2(u.pvar.u.bac.TFT0.amb ~ Time.Point, data = pvar.u.samp.df.TFT0.amb) #adonis test
  set.seed(30)
    permutest(betadisper(u.pvar.u.bac.TFT0.amb, pvar.u.samp.df.TFT0.amb$Time.Point, type = "centroid"))     
...
#TF-T0 
        pvar.u.bac.TFT0.high <- subset_samples(pvar.u.bac.high, Time.Point == "T0"|Time.Point=="TF")
       pvar.u.bac.TFT0.high = prune_taxa(taxa_sums(pvar.u.bac.TFT0.high) > 0, pvar.u.bac.TFT0.high) #this removes any OTU with 0s
        sample_sums(pvar.u.bac.TFT0.high)
      
  #make bray curtis data matrix
  u.pvar.u.bac.TFT0.high <- phyloseq::distance(pvar.u.bac.TFT0.high, method = "wunifrac")
     pvar.u.samp.df.TFT0.high <- as(sample_data(pvar.u.bac.TFT0.high), "data.frame") #sample df

  set.seed(30)
    adonis2(u.pvar.u.bac.TFT0.high ~ Time.Point, data = pvar.u.samp.df.TFT0.high) #adonis test
  set.seed(30)
    permutest(betadisper(u.pvar.u.bac.TFT0.high, pvar.u.samp.df.TFT0.high$Time.Point, type = "centroid"))     
...
#T0-T1 
  pacu.u.bac<- subset_samples(Bac.s.rel.u.adon, Species == "Pocillopora_acuta")
...
#TF-T0
        pacu.u.bac.TFT0.amb <- subset_samples(pacu.u.bac.amb, Time.Point == "T0"|Time.Point=="TF")
       pacu.u.bac.TFT0.amb = prune_taxa(taxa_sums(pacu.u.bac.TFT0.amb) > 0, pacu.u.bac.TFT0.amb) #this removes any OTU with 0s
        sample_sums(pacu.u.bac.TFT0.amb)
      
  #make bray curtis data matrix
  u.pacu.u.bac.TFT0.amb <- phyloseq::distance(pacu.u.bac.TFT0.amb, method = "wunifrac")
     pacu.u.samp.df.TFT0.amb <- as(sample_data(pacu.u.bac.TFT0.amb), "data.frame") #sample df

  set.seed(30)
    adonis2(u.pacu.u.bac.TFT0.amb ~ Time.Point, data = pacu.u.samp.df.TFT0.amb) #adonis test
  set.seed(30)
    permutest(betadisper(u.pacu.u.bac.TFT0.amb, pacu.u.samp.df.TFT0.amb$Time.Point, type = "centroid"))     
...
#TF-T0 
        pacu.u.bac.TFT0.high <- subset_samples(pacu.u.bac.high, Time.Point == "T0"|Time.Point=="TF")
       pacu.u.bac.TFT0.high = prune_taxa(taxa_sums(pacu.u.bac.TFT0.high) > 0, pacu.u.bac.TFT0.high) #this removes any OTU with 0s
        sample_sums(pacu.u.bac.TFT0.high)
      
  #make bray curtis data matrix
  u.pacu.u.bac.TFT0.high <- phyloseq::distance(pacu.u.bac.TFT0.high, method = "wunifrac")
     pacu.u.samp.df.TFT0.high <- as(sample_data(pacu.u.bac.TFT0.high), "data.frame") #sample df

  set.seed(30)
    adonis2(u.pacu.u.bac.TFT0.high ~ Time.Point, data = pacu.u.samp.df.TFT0.high) #adonis test
  set.seed(30)
    permutest(betadisper(u.pacu.u.bac.TFT0.high, pacu.u.samp.df.TFT0.high$Time.Point, type = "centroid"))     
...
```
This is same as above but T0 is NOT split (dupicated T0 so 12 samples for amb and high T0)
```{r}         
Bac.s.rel.T0Dupsamps<-Bac.s.rel #make a copy

### Create a duplicate of T0s for the other A and H treatments for OVER TIME ONLY

#copy amb T0
Bac.s.rel.T0Dupsamps_amb = subset_samples(Bac.s.rel.T0Dupsamps, Time.Point == "T0" & Treatment == "Ambient")  #copy
...
tax  = tax_table(Bac.s.rel.T0Dupsamps_amb)
 ...
 #sample.dataAmb2 <- as(sample_data(bac.Amb.T0dup), "data.frame") #create sample data frame to view

##High
  Bac.s.rel.T0Dupsamps_amb = subset_samples(Bac.s.rel.T0Dupsamps, Time.Point == "T0"&Treatment == "High")  #copy
...
OTU = otu_table(Bac.s.rel.T0Dupsamps_amb)
  ...
  #sample.dataHigh2 <- as(sample_data(bac.High.T0dup), "data.frame") #create sample data frame to view

#Merge control dups H and A
Control16dups = merge_phyloseq(bac.Amb.T0dup,bac.High.T0dup)
Control16dups
    #sample.dataControldups2 <- as(sample_data(Control16dups), "data.frame") #create sample data frame to view
...
``` 
#more asv unifrac adonis within time points
```{r}
...
mcap.u.f.bac.AmbT01F = prune_taxa(taxa_sums(mcap.u.bac.AmbT01F) > 0, mcap.u.bac.AmbT01F) #this removes any OTU with 0s
  ...
  mcap.u.AmbT01F <- phyloseq::distance(mcap.u.f.bac.AmbT01F, method = "wunifrac")
    ...
    set.seed(30)
    adonis2(mcap.u.AmbT01F ~ Time.Point, data = mcap.u.samp.df.AmbT01F)
...
pcomp.u.bac.AllTime = prune_taxa(taxa_sums(pcomp.u.bac.AllTime) > 0, pcomp.u.bac.AllTime) #this removes any OTU with 0s
  sample_sums(pcomp.u.bac.AllTime)
    
  pcomp.u.Alltime <- phyloseq::distance(pcomp.u.bac.AllTime, method = "wunifrac")
     pcomp.u.samp.df.Alltime <- as(sample_data(pcomp.u.f.bac.Alltime), "data.frame")
     pcomp.u.samp.df.Alltime$Code<-paste(pcomp.u.samp.df.Alltime$Treatment,pcomp.u.samp.df.Alltime$Clade)
  ...
  sd$Treatment[sd$Treatment == "High" & sd$Time.Point=="T0"] <- "Alltimeient" 
  sd$Treatment<-as.factor(sd$Treatment)
  ...
  pcomp.u.bac.Alltime <- subset_samples(pcomp.u.bac.Alltime2, Treatment == "Alltimeient")
...
# Pcomp remove the two outliers  T1 #### FIGURE OUT WHICH ONES 
