...
set.seed(30)    
adonis(Bac.s.u.T0 ~ Species*Treatment*Time.Point*Clade, data = s.u.samp.df)

     # Homogeneity of dispersion test  
    set.seed(30)
    t<-permutest(betadisper(Bac.s.u.T0, s.u.samp.df$Species, type = "centroid")) 
   set.seed(30)
    permutest(betadisper(Bac.s.u.T0, s.u.samp.df$Treatment, type = "centroid")) 
...
adonis(Bac.s.u.Amb ~ Species*Clade, data = s.u.samp.df)
  ...
  ball<-  betadisper(Bac.s.u.Amb, s.u.samp.df$Species, type = "centroid")
  TukeyHSD(ball,  ordered = FALSE,conf.level = 0.95)  
...
# Homogeneity of dispersion test  
 ...
 # pacu Bac.s.rel.u.T0   only ####
    pacu.u.bac.T0 <- subset_samples(Bac.s.rel.u.T0, Species == "Pavona_varians")
