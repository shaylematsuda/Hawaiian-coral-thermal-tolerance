...
save(Bac.seq,data.Bac.s.rel,Bac.seqFam_stats.T1F,erich.tab2, file = "Data/16s_phyloseq4HE.RData")
...
ggplot(scores.mcap.u.samp.df, aes(x = NMDS1, y = NMDS2)) +
  geom_point(aes(shape = Treatment, color = Parent.ID, fill=Treatment), size = 5) + 
