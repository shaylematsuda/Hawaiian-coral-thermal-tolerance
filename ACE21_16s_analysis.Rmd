...
mcap.16s.fam.top10.m_mean <- ddply(mcap.16s.fam.top10.m, c("Treatment", "Clade", "Time.Point","family"), summarise, #summarize cell counts
                 N    = length(relabund[!is.na(relabund)]), #calculate the length of the data frame, excluding NA’s
...
#Permanova UNIFRAC by ASV (no filter) Adonis
```{r}         
Bac.s.rel.u<-Bac.s.rel #make a copy
#saveRDS(Bac.s.rel.u, file = "16S_rel.u.rds")

# New section running the models on all timepionts together 20220506 ####
Bac.s.rel.u.AllTime<-Bac.s.rel.u
    Bac.s.rel.u.AllTime = prune_taxa(taxa_sums(Bac.s.rel.u.AllTime) > 0, Bac.s.rel.u.AllTime) #this removes any OTU with 0s
      sample_sums(Bac.s.rel.u.AllTime) #check all duplicates removed

      #make unifrac matrix
Bac.s.u.AllTime <- phyloseq::distance(Bac.s.rel.u.AllTime, method = "wunifrac")
s.u.samp.df.AllTime <- as(sample_data(Bac.s.rel.u.AllTime), "data.frame") #sample df
s.u.samp.df.AllTime$Code<-paste(s.u.samp.df.AllTime$Treatment, s.u.samp.df.AllTime$Species, s.u.samp.df.AllTime$Time.Point)

  #adonis test
set.seed(30)
adonis(Bac.s.u.AllTime ~ Species*Treatment*Time.Point, data = s.u.samp.df.AllTime)
set.seed(30)    
adonis(Bac.s.u.AllTime ~ Species*Treatment*Time.Point*Clade, data = s.u.samp.df.AllTime)

     # Homogeneity of dispersion test  
    set.seed(30)
  permutest(betadisper(Bac.s.u.AllTime, s.u.samp.df.AllTime$Code, type = "centroid")) 
   set.seed(30)
    permutest(betadisper(Bac.s.u.AllTime, s.u.samp.df.AllTime$Treatment, type = "centroid")) 
    
 # mcap #### 
mcap.u.bac.AllTime <- subset_samples(Bac.s.rel.u.AllTime, Species == "Montipora_capitata")
  sample_sums(mcap.u.bac.AllTime)

mcap.u.f.bac.AllTime = prune_taxa(taxa_sums(mcap.u.bac.AllTime) > 0, mcap.u.bac.AllTime) #this removes any OTU with 0s
  sample_sums(mcap.u.f.bac.AllTime)

#make bray curtis data matrix 
  u.mcap.u.AllTime <- phyloseq::distance(mcap.u.bac.AllTime, method = "wunifrac")
     mcap.u.samp.df.AllTime <- as(sample_data(mcap.u.bac.AllTime), "data.frame") #sample df
        mcap.u.samp.df.AllTime$Code<-paste(mcap.u.samp.df.AllTime$Treatment, mcap.u.samp.df.AllTime$Time.Point)
        mcap.u.samp.df.AllTime$Code2<-paste(mcap.u.samp.df.AllTime$Treatment, mcap.u.samp.df.AllTime$Time.Point,mcap.u.samp.df.AllTime$Clade)

    set.seed(30)
    adonis(u.mcap.u.AllTime ~ Treatment*Time.Point, data = mcap.u.samp.df.AllTime) #adonis test no clade
    set.seed(30)
    adonis(u.mcap.u.AllTime ~ Clade*Treatment*Time.Point, data = mcap.u.samp.df.AllTime)#adonis test with clade
   # Homogeneity of dispersion test  
     set.seed(30)
    permutest(betadisper(u.mcap.u.AllTime, mcap.u.samp.df.AllTime$Code, type = "centroid"))
        permutest(betadisper(u.mcap.u.AllTime, mcap.u.samp.df.AllTime$Code2, type = "centroid"))

 # pcomp #### 
pcomp.u.bac.AllTime <- subset_samples(Bac.s.rel.u.AllTime, Species == "Porites_compressa")
  sample_sums(pcomp.u.bac.AllTime)

pcomp.u.f.bac.AllTime = prune_taxa(taxa_sums(pcomp.u.bac.AllTime) > 0, pcomp.u.bac.AllTime) #this removes any OTU with 0s
  sample_sums(pcomp.u.f.bac.AllTime)

#make bray curtis data matrix 
  u.pcomp.u.AllTime <- phyloseq::distance(pcomp.u.bac.AllTime, method = "wunifrac")
     pcomp.u.samp.df.AllTime <- as(sample_data(pcomp.u.bac.AllTime), "data.frame") #sample df
        pcomp.u.samp.df.AllTime$Code<-paste(pcomp.u.samp.df.AllTime$Treatment, pcomp.u.samp.df.AllTime$Time.Point)
        pcomp.u.samp.df.AllTime$Code2<-paste(pcomp.u.samp.df.AllTime$Treatment,pcomp.u.samp.df.AllTime$Time.Point,pcomp.u.samp.df.AllTime$Clade)

    set.seed(30)
    adonis(u.pcomp.u.AllTime ~ Treatment*Time.Point, data = pcomp.u.samp.df.AllTime) #adonis test no clade
    set.seed(30)
    adonis(u.pcomp.u.AllTime ~ Clade*Treatment*Time.Point, data = pcomp.u.samp.df.AllTime)#adonis test with clade
   # Homogeneity of dispersion test  
     set.seed(30)
    permutest(betadisper(u.pcomp.u.AllTime, pcomp.u.samp.df.AllTime$Code, type = "centroid"))
        permutest(betadisper(u.pcomp.u.AllTime, pcomp.u.samp.df.AllTime$Code2, type = "centroid"))

# pvar #### 
pvar.u.bac.AllTime <- subset_samples(Bac.s.rel.u.AllTime, Species == "Pavona_varians")
  sample_sums(pvar.u.bac.AllTime)

pvar.u.f.bac.AllTime = prune_taxa(taxa_sums(pvar.u.bac.AllTime) > 0, pvar.u.bac.AllTime) #this removes any OTU with 0s
  sample_sums(pvar.u.f.bac.AllTime)

#make bray curtis data matrix 
  u.pvar.u.AllTime <- phyloseq::distance(pvar.u.bac.AllTime, method = "wunifrac")
     pvar.u.samp.df.AllTime <- as(sample_data(pvar.u.bac.AllTime), "data.frame") #sample df
        pvar.u.samp.df.AllTime$Code<-paste(pvar.u.samp.df.AllTime$Treatment, pvar.u.samp.df.AllTime$Time.Point)
        pvar.u.samp.df.AllTime$Code2<-paste(pvar.u.samp.df.AllTime$Treatment,pvar.u.samp.df.AllTime$Time.Point,pvar.u.samp.df.AllTime$Clade)

    set.seed(30)
    adonis(u.pvar.u.AllTime ~ Treatment*Time.Point, data = pvar.u.samp.df.AllTime) #adonis test no clade
    set.seed(30)
    adonis(u.pvar.u.AllTime ~ Clade*Treatment*Time.Point, data = pvar.u.samp.df.AllTime)#adonis test with clade
   # Homogeneity of dispersion test  
     set.seed(30)
    permutest(betadisper(u.pvar.u.AllTime, pvar.u.samp.df.AllTime$Code, type = "centroid"))
        permutest(betadisper(u.pvar.u.AllTime, pvar.u.samp.df.AllTime$Code2, type = "centroid"))

# pvar #### 
pvar.u.bac.AllTime <- subset_samples(Bac.s.rel.u.AllTime, Species == "Pocillopora_acuta")
  sample_sums(pvar.u.bac.AllTime)
...
set.seed(30)
    ...
    permutest(betadisper(u.mcap.u.T0, mcap.u.samp.df.T0$Time.Point, type = "centroid")) 
...
set.seed(30)
    ...
    betadisper(u.Pcomp.u.T0, Pcomp.u.samp.df.T0$Time.Point, type = "centroid")
    betadisper(u.Pcomp.u.T0, Pcomp.u.samp.df.T0$Clade, type = "centroid")
...
mcap.u.f.bac.T1F = prune_taxa(taxa_sums(mcap.u.bac.T1F) > 0, mcap.u.bac.T1F) #this removes any OTU with 0s
...
mcap.u.bac.T1 <- subset_samples(mcap.u.bac.T1F, Time.Point == "T1")
  mcap.u.f.bac.T1 = prune_taxa(taxa_sums(mcap.u.bac.T1) > 0, mcap.u.bac.T1) #this removes any OTU with 0s
mcap.u.bac.TF <- subset_samples(mcap.u.f.bac.T1F, Time.Point == "TF")
  mcap.u.f.bac.TF = prune_taxa(taxa_sums(mcap.u.bac.TF) > 0, mcap.u.bac.TF) #this removes any OTU with 0s
...
# Homogeneity of dispersion test  
   ...
   set.seed(30)
    ...
    betadisper(mcap.u.bac.mcapT1, mcap.u.samp.df.T1$Treatment, type = "centroid")
    
    set.seed(30)
    permutest(betadisper(mcap.u.bac.mcapT1, mcap.u.samp.df.T1$Code, type = "centroid")) 
 betadisper(mcap.u.bac.mcapT1, mcap.u.samp.df.T1$Code, type = "centroid")
...
#TF
  ...
  # Homogeneity of dispersion test  
    ...
    betadisper(mcap.u.TF, mcap.u.samp.df.TF$Clade, type = "centroid")
   set.seed(30)
    ...
    betadisper(mcap.u.TF, mcap.u.samp.df.TF$Code, type = "centroid")
...
mcap.u.f.bac.AmbT01F = prune_taxa(taxa_sums(mcap.u.bac.AmbT01F) > 0, mcap.u.bac.AmbT01F) #this removes any OTU with 0s
  ...
  mcap.u.AmbT01F <- phyloseq::distance(mcap.u.f.bac.AmbT01F, method = "wunifrac")
     ...
     mcap.u.samp.df.AmbT01F$Code<-paste(mcap.u.samp.df.AmbT01F$Treatment,mcap.u.samp.df.AmbT01F$Clade)
          mcap.u.samp.df.AmbT01F$Code2<-paste(mcap.u.samp.df.AmbT01F$Treatment,mcap.u.samp.df.AmbT01F$Clade,mcap.u.samp.df.AmbT01F$Time.Point)
    ...
    #mcap high only all three times
    mcap.u.bac.HighT01F <- subset_samples(Bac.s.rel.u, Species == "Montipora_capitata")
        mcap.u.bac.HighT01F <- subset_samples(mcap.u.bac.HighT01F, Treatment == "High")
  sample_sums(mcap.u.bac.HighT01F)

mcap.u.f.bac.HighT01F = prune_taxa(taxa_sums(mcap.u.bac.HighT01F) > 0, mcap.u.bac.HighT01F) #this removes any OTU with 0s
  sample_sums(mcap.u.f.bac.HighT01F)
    
  mcap.u.HighT01F <- phyloseq::distance(mcap.u.f.bac.HighT01F, method = "wunifrac")
     mcap.u.samp.df.HighT01F <- as(sample_data(mcap.u.bac.HighT01F), "data.frame")
     mcap.u.samp.df.HighT01F$Code<-paste(mcap.u.samp.df.HighT01F$Treatment,mcap.u.samp.df.HighT01F$Clade)
          mcap.u.samp.df.HighT01F$Code2<-paste(mcap.u.samp.df.HighT01F$Treatment,mcap.u.samp.df.HighT01F$Clade,mcap.u.samp.df.HighT01F$Time.Point)

    set.seed(30)
    adonis(mcap.u.HighT01F ~ Time.Point, data = mcap.u.samp.df.HighT01F)

  # Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(mcap.u.HighT01F, mcap.u.samp.df.HighT01F$Time.Point, type = "centroid")) 
  betadisper(mcap.u.HighT01F, mcap.u.samp.df.HighT01F$Time.Point, type = "centroid")
  betadisper(mcap.u.HighT01F, mcap.u.samp.df.HighT01F$Code2, type = "centroid")
...
mcap.u.f.bac.T0 = prune_taxa(taxa_sums(mcap.u.bac.T0) > 0, mcap.u.bac.T0) #this removes any OTU with 0s
  ...
  # Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(mcap.u.T0, mcap.u.samp.df.T0$Code, type = "centroid")) 
  betadisper(mcap.u.T0, mcap.u.samp.df.T0$Code, type = "centroid")
...
#All time only !!! ####
  ...
  pcomp.u.bac.Alltime2.sd <- as(sample_data(pcomp.u.bac.AllTime), "data.frame") #create sample data frame to view

pcomp.u.f.bac.Alltime = prune_taxa(taxa_sums(pcomp.u.bac.AllTime) > 0, pcomp.u.bac.AllTime) #this removes any OTU with 0s
  sample_sums(pcomp.u.f.bac.Alltime)
    
  pcomp.u.Alltime <- phyloseq::distance(pcomp.u.f.bac.Alltime, method = "wunifrac")
     pcomp.u.samp.df.Alltime <- as(sample_data(pcomp.u.f.bac.Alltime), "data.frame")
     pcomp.u.samp.df.Alltime$Code<-paste(pcomp.u.samp.df.Alltime$Treatment,pcomp.u.samp.df.Alltime$Clade,pcomp.u.samp.df.Alltime$Time.Point)
         pcomp.u.samp.df.Alltime$Code2<-paste(pcomp.u.samp.df.Alltime$Treatment,pcomp.u.samp.df.Alltime$Time.Point)

     set.seed(30)
    adonis(pcomp.u.Alltime ~ Clade, data = pcomp.u.samp.df.Alltime)

  # Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(pcomp.u.Alltime, pcomp.u.samp.df.Alltime$Clade, type = "centroid")) 
betadisper(pcomp.u.Alltime, pcomp.u.samp.df.Alltime$Code, type = "centroid")
betadisper(pcomp.u.Alltime, pcomp.u.samp.df.Alltime$Code2, type = "centroid")
...
#ALL maybe the only one you need ####
    pvar.u.bac.AllTime <- subset_samples(Bac.s.rel.u, Species == "Pavona_varians") #all pvar
      
  pvar.u.bac.Alltime2.sd <- as(sample_data(pvar.u.bac.AllTime), "data.frame") #create sample data frame to view

pvar.u.f.bac.Alltime = prune_taxa(taxa_sums(pvar.u.bac.AllTime) > 0, pvar.u.bac.AllTime) #this removes any OTU with 0s
  sample_sums(pvar.u.f.bac.Alltime)
    
  pvar.u.Alltime <- phyloseq::distance(pvar.u.f.bac.Alltime, method = "wunifrac")
     pvar.u.samp.df.Alltime <- as(sample_data(pvar.u.f.bac.Alltime), "data.frame")
     pvar.u.samp.df.Alltime$Code<-paste(pvar.u.samp.df.Alltime$Treatment,pvar.u.samp.df.Alltime$Clade,pvar.u.samp.df.Alltime$Time.Point )
         pvar.u.samp.df.Alltime$Code2<-paste(pvar.u.samp.df.Alltime$Treatment,pvar.u.samp.df.Alltime$Time.Point)

     set.seed(30)
    adonis(pvar.u.Alltime ~ Clade, data = pvar.u.samp.df.Alltime)

  # Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(pvar.u.Alltime, pvar.u.samp.df.Alltime$Clade, type = "centroid")) 
    betadisper(pvar.u.Alltime, pvar.u.samp.df.Alltime$Code, type = "centroid")
    betadisper(pvar.u.Alltime, pvar.u.samp.df.Alltime$Code2, type = "centroid")
...
# All for betadisper #### 
  ...
  pacu.u.bac.Alltime2.sd <- as(sample_data(pacu.u.bac.AllTime), "data.frame") #create sample data frame to view
  sample_sums(pacu.u.bac.Amb)

pacu.u.f.bac.Alltime = prune_taxa(taxa_sums(pacu.u.bac.AllTime) > 0, pacu.u.bac.AllTime) #this removes any OTU with 0s
  sample_sums(pacu.u.f.bac.Alltime)
    
  pacu.u.Alltime <- phyloseq::distance(pacu.u.f.bac.Alltime, method = "wunifrac")
     pacu.u.samp.df.Alltime <- as(sample_data(pacu.u.f.bac.Alltime), "data.frame")
     pacu.u.samp.df.Alltime$Code<-paste(pacu.u.samp.df.Alltime$Treatment,pacu.u.samp.df.Alltime$Clade,pacu.u.samp.df.Alltime$Time.Point)
         pacu.u.samp.df.Alltime$Code2<-paste(pacu.u.samp.df.Alltime$Treatment,pacu.u.samp.df.Alltime$Time.Point)

     set.seed(30)
    adonis(pacu.u.Alltime ~ Clade, data = pacu.u.samp.df.Alltime)

  # Homogeneity of dispersion test  
    set.seed(30)
    permutest(betadisper(pacu.u.Alltime, pacu.u.samp.df.Alltime$Clade, type = "centroid")) 
      
        betadisper(pacu.u.Alltime, pacu.u.samp.df.Alltime$Code, type = "centroid")
            betadisper(pacu.u.Alltime, pacu.u.samp.df.Alltime$Code2, type = "centroid")
...
``` 
#permanova uni by asv ambient only - for cn
```{r}
# New section running the models on all timepionts together 20220506 ambient only ####
#by species only

# Amb T0-T1 only
Bac.s.rel.u.Amb<-subset_samples(Bac.s.rel.u.AllTime, Treatment=="Ambient")
Bac.s.rel.u.AmbT0T1<-subset_samples(Bac.s.rel.u.Amb, Time.Point=="T0"| Time.Point=="T1")

    Bac.s.rel.u.AmbT0T1 = prune_taxa(taxa_sums(Bac.s.rel.u.AmbT0T1) > 0, Bac.s.rel.u.AmbT0T1) #this removes any OTU with 0s
      sample_sums(Bac.s.rel.u.AmbT0T1) #check all duplicates removed
     
# Amb T1-TF onl
Bac.s.rel.u.AmbT1TF<-subset_samples(Bac.s.rel.u.Amb, Time.Point=="T1"| Time.Point=="TF")

    Bac.s.rel.u.AmbT1TF = prune_taxa(taxa_sums(Bac.s.rel.u.AmbT1TF) > 0, Bac.s.rel.u.AmbT1TF) #this removes any OTU with 0s
      sample_sums(Bac.s.rel.u.AmbT1TF) #check all duplicates removed      
      
      
       
# mcap #### 
 #T0-T1
mcap.u.bac.AmbT0T1 <- subset_samples(Bac.s.rel.u.AmbT0T1, Species == "Montipora_capitata")
  sample_sums(mcap.u.bac.AmbT0T1)

mcap.u.f.bac.AmbT0T1 = prune_taxa(taxa_sums(mcap.u.bac.AmbT0T1) > 0, mcap.u.bac.AmbT0T1) #this removes any OTU with 0s
  sample_sums(mcap.u.f.bac.AmbT0T1)

#make bray curtis data matrix 
  u.mcap.u.AmbT0T1 <- phyloseq::distance(mcap.u.f.bac.AmbT0T1, method = "wunifrac")
     mcap.u.samp.df.AmbT0T1 <- as(sample_data(mcap.u.f.bac.AmbT0T1), "data.frame") #sample df
        mcap.u.samp.df.AmbT0T1$Code<-paste(mcap.u.samp.df.AmbT0T1$Treatment, mcap.u.samp.df.AmbT0T1$Time.Point)
        mcap.u.samp.df.AmbT0T1$Code2<-paste(mcap.u.samp.df.AmbT0T1$Treatment, mcap.u.samp.df.AmbT0T1$Time.Point,mcap.u.samp.df.AmbT0T1$Clade)

    set.seed(30)
    adonis(u.mcap.u.AmbT0T1 ~ Time.Point, data = mcap.u.samp.df.AmbT0T1) #adonis test no clade
   # Homogeneity of dispersion test  
     set.seed(30)
        permutest(betadisper(u.mcap.u.AmbT0T1, mcap.u.samp.df.AmbT0T1$Code, type = "centroid"))
        permutest(betadisper(u.mcap.u.AmbT0T1, mcap.u.samp.df.AmbT0T1$Code2, type = "centroid"))

#T1-TF
  mcap.u.bac.AmbT1TF <- subset_samples(Bac.s.rel.u.AmbT1TF, Species == "Montipora_capitata")
  sample_sums(mcap.u.bac.AmbT1TF)

mcap.u.f.bac.AmbT1TF = prune_taxa(taxa_sums(mcap.u.bac.AmbT1TF) > 0, mcap.u.bac.AmbT1TF) #this removes any OTU with 0s
  sample_sums(mcap.u.f.bac.AmbT1TF)

#make bray curtis data matrix 
  u.mcap.u.AmbT1TF <- phyloseq::distance(Bac.s.rel.u.AmbT1TF, method = "wunifrac")
     mcap.u.samp.df.AmbT1TF <- as(sample_data(Bac.s.rel.u.AmbT1TF), "data.frame") #sample df

    set.seed(30)
    adonis(u.mcap.u.AmbT1TF ~ Time.Point, data = mcap.u.samp.df.AmbT1TF) #adonis 
   # Homogeneity of dispersion test  
     set.seed(30)
    permutest(betadisper(u.mcap.u.AmbT1TF, mcap.u.samp.df.AmbT1TF$Time.Point, type = "centroid"))

        
        
# pcomp #### 
 #T0-T1
pcomp.u.bac.AmbT0T1 <- subset_samples(Bac.s.rel.u.AmbT0T1, Species == "Porites_compressa")
  sample_sums(pcomp.u.bac.AmbT0T1)

pcomp.u.f.bac.AmbT0T1 = prune_taxa(taxa_sums(pcomp.u.bac.AmbT0T1) > 0, pcomp.u.bac.AmbT0T1) #this removes any OTU with 0s
  sample_sums(pcomp.u.f.bac.AmbT0T1)

#make bray curtis data matrix 
  u.pcomp.u.AmbT0T1 <- phyloseq::distance(pcomp.u.f.bac.AmbT0T1, method = "wunifrac")
     pcomp.u.samp.df.AmbT0T1 <- as(sample_data(pcomp.u.f.bac.AmbT0T1), "data.frame") #sample df
        pcomp.u.samp.df.AmbT0T1$Code<-paste(pcomp.u.samp.df.AmbT0T1$Treatment, pcomp.u.samp.df.AmbT0T1$Time.Point)
        pcomp.u.samp.df.AmbT0T1$Code2<-paste(pcomp.u.samp.df.AmbT0T1$Treatment, pcomp.u.samp.df.AmbT0T1$Time.Point,pcomp.u.samp.df.AmbT0T1$Clade)

    set.seed(30)
    adonis(u.pcomp.u.AmbT0T1 ~ Time.Point, data = pcomp.u.samp.df.AmbT0T1) #adonis test no clade
   # Homogeneity of dispersion test  
     set.seed(30)
        permutest(betadisper(u.pcomp.u.AmbT0T1, pcomp.u.samp.df.AmbT0T1$Code, type = "centroid"))
        permutest(betadisper(u.pcomp.u.AmbT0T1, pcomp.u.samp.df.AmbT0T1$Code2, type = "centroid"))

#T1-TF
  pcomp.u.bac.AmbT1TF <- subset_samples(Bac.s.rel.u.AmbT1TF, Species == "Porites_compressa")
  sample_sums(pcomp.u.bac.AmbT1TF)

pcomp.u.f.bac.AmbT1TF = prune_taxa(taxa_sums(pcomp.u.bac.AmbT1TF) > 0, pcomp.u.bac.AmbT1TF) #this removes any OTU with 0s
  sample_sums(pcomp.u.f.bac.AmbT1TF)

#make bray curtis data matrix 
  u.pcomp.u.AmbT1TF <- phyloseq::distance(Bac.s.rel.u.AmbT1TF, method = "wunifrac")
     pcomp.u.samp.df.AmbT1TF <- as(sample_data(Bac.s.rel.u.AmbT1TF), "data.frame") #sample df

    set.seed(30)
    adonis(u.pcomp.u.AmbT1TF ~ Time.Point, data = pcomp.u.samp.df.AmbT1TF) #adonis 
   # Homogeneity of dispersion test  
     set.seed(30)
    permutest(betadisper(u.pcomp.u.AmbT1TF, pcomp.u.samp.df.AmbT1TF$Time.Point, type = "centroid"))    
# pvar #### 
 #T0-T1
pvar.u.bac.AmbT0T1 <- subset_samples(Bac.s.rel.u.AmbT0T1, Species == "Pavona_varians")
  sample_sums(pvar.u.bac.AmbT0T1)

pvar.u.f.bac.AmbT0T1 = prune_taxa(taxa_sums(pvar.u.bac.AmbT0T1) > 0, pvar.u.bac.AmbT0T1) #this removes any OTU with 0s
  sample_sums(pvar.u.f.bac.AmbT0T1)

#make bray curtis data matrix 
  u.pvar.u.AmbT0T1 <- phyloseq::distance(pvar.u.f.bac.AmbT0T1, method = "wunifrac")
     pvar.u.samp.df.AmbT0T1 <- as(sample_data(pvar.u.f.bac.AmbT0T1), "data.frame") #sample df
        pvar.u.samp.df.AmbT0T1$Code<-paste(pvar.u.samp.df.AmbT0T1$Treatment, pvar.u.samp.df.AmbT0T1$Time.Point)
        pvar.u.samp.df.AmbT0T1$Code2<-paste(pvar.u.samp.df.AmbT0T1$Treatment, pvar.u.samp.df.AmbT0T1$Time.Point,pvar.u.samp.df.AmbT0T1$Clade)

    set.seed(30)
    adonis(u.pvar.u.AmbT0T1 ~ Time.Point, data = pvar.u.samp.df.AmbT0T1) #adonis test no clade
   # Homogeneity of dispersion test  
     set.seed(30)
        permutest(betadisper(u.pvar.u.AmbT0T1, pvar.u.samp.df.AmbT0T1$Code, type = "centroid"))
        permutest(betadisper(u.pvar.u.AmbT0T1, pvar.u.samp.df.AmbT0T1$Code2, type = "centroid"))

#T1-TF
  pvar.u.bac.AmbT1TF <- subset_samples(Bac.s.rel.u.AmbT1TF, Species == "Pavona_varians")
  sample_sums(pvar.u.bac.AmbT1TF)

pvar.u.f.bac.AmbT1TF = prune_taxa(taxa_sums(pvar.u.bac.AmbT1TF) > 0, pvar.u.bac.AmbT1TF) #this removes any OTU with 0s
  sample_sums(pvar.u.f.bac.AmbT1TF)

#make bray curtis data matrix 
  u.pvar.u.AmbT1TF <- phyloseq::distance(Bac.s.rel.u.AmbT1TF, method = "wunifrac")
     pvar.u.samp.df.AmbT1TF <- as(sample_data(Bac.s.rel.u.AmbT1TF), "data.frame") #sample df

    set.seed(30)
    adonis(u.pvar.u.AmbT1TF ~ Time.Point, data = pvar.u.samp.df.AmbT1TF) #adonis 
   # Homogeneity of dispersion test  
     set.seed(30)
    permutest(betadisper(u.pvar.u.AmbT1TF, pvar.u.samp.df.AmbT1TF$Time.Point, type = "centroid"))    

# pacu #### 
 #T0-T1
pacu.u.bac.AmbT0T1 <- subset_samples(Bac.s.rel.u.AmbT0T1, Species == "Pocillopora_acuta")
  sample_sums(pacu.u.bac.AmbT0T1)

pacu.u.f.bac.AmbT0T1 = prune_taxa(taxa_sums(pacu.u.bac.AmbT0T1) > 0, pacu.u.bac.AmbT0T1) #this removes any OTU with 0s
  sample_sums(pacu.u.f.bac.AmbT0T1)

#make bray curtis data matrix 
  u.pacu.u.AmbT0T1 <- phyloseq::distance(pacu.u.f.bac.AmbT0T1, method = "wunifrac")
     pacu.u.samp.df.AmbT0T1 <- as(sample_data(pacu.u.f.bac.AmbT0T1), "data.frame") #sample df
        pacu.u.samp.df.AmbT0T1$Code<-paste(pacu.u.samp.df.AmbT0T1$Treatment, pacu.u.samp.df.AmbT0T1$Time.Point)
        pacu.u.samp.df.AmbT0T1$Code2<-paste(pacu.u.samp.df.AmbT0T1$Treatment, pacu.u.samp.df.AmbT0T1$Time.Point,pacu.u.samp.df.AmbT0T1$Clade)

    set.seed(30)
    adonis(u.pacu.u.AmbT0T1 ~ Time.Point, data = pacu.u.samp.df.AmbT0T1) #adonis test no clade
   # Homogeneity of dispersion test  
     set.seed(30)
        permutest(betadisper(u.pacu.u.AmbT0T1, pacu.u.samp.df.AmbT0T1$Code, type = "centroid"))
        permutest(betadisper(u.pacu.u.AmbT0T1, pacu.u.samp.df.AmbT0T1$Code2, type = "centroid"))

#T1-TF
  pacu.u.bac.AmbT1TF <- subset_samples(Bac.s.rel.u.AmbT1TF, Species == "Pocillopora_acuta")
  sample_sums(pacu.u.bac.AmbT1TF)

pacu.u.f.bac.AmbT1TF = prune_taxa(taxa_sums(pacu.u.bac.AmbT1TF) > 0, pacu.u.bac.AmbT1TF) #this removes any OTU with 0s
  sample_sums(pacu.u.f.bac.AmbT1TF)

#make bray curtis data matrix 
  u.pacu.u.AmbT1TF <- phyloseq::distance(Bac.s.rel.u.AmbT1TF, method = "wunifrac")
     pacu.u.samp.df.AmbT1TF <- as(sample_data(Bac.s.rel.u.AmbT1TF), "data.frame") #sample df

    set.seed(30)
    adonis(u.pacu.u.AmbT1TF ~ Time.Point, data = pacu.u.samp.df.AmbT1TF) #adonis 
   # Homogeneity of dispersion test  
     set.seed(30)
    permutest(betadisper(u.pacu.u.AmbT1TF, pacu.u.samp.df.AmbT1TF$Time.Point, type = "centroid"))    
...
```
#permanova uni by asv High only - for cn
```{r}
# New section running the models on all timepionts together 20220506 Highient only ####
#by species only

# High T0-T1 only
Bac.s.rel.u.High<-subset_samples(Bac.s.rel.u.AllTime, Treatment=="High")
Bac.s.rel.u.HighT0T1<-subset_samples(Bac.s.rel.u.High, Time.Point=="T0"| Time.Point=="T1")

    Bac.s.rel.u.HighT0T1 = prune_taxa(taxa_sums(Bac.s.rel.u.HighT0T1) > 0, Bac.s.rel.u.HighT0T1) #this removes any OTU with 0s
      sample_sums(Bac.s.rel.u.HighT0T1) #check all duplicates removed
     
# High T1-TF onl
Bac.s.rel.u.HighT1TF<-subset_samples(Bac.s.rel.u.High, Time.Point=="T1"| Time.Point=="TF")

    Bac.s.rel.u.HighT1TF = prune_taxa(taxa_sums(Bac.s.rel.u.HighT1TF) > 0, Bac.s.rel.u.HighT1TF) #this removes any OTU with 0s
      sample_sums(Bac.s.rel.u.HighT1TF) #check all duplicates removed      
      
      
       
# mcap #### 
 #T0-T1
mcap.u.bac.HighT0T1 <- subset_samples(Bac.s.rel.u.HighT0T1, Species == "Montipora_capitata")
  sample_sums(mcap.u.bac.HighT0T1)

mcap.u.f.bac.HighT0T1 = prune_taxa(taxa_sums(mcap.u.bac.HighT0T1) > 0, mcap.u.bac.HighT0T1) #this removes any OTU with 0s
  sample_sums(mcap.u.f.bac.HighT0T1)

#make bray curtis data matrix 
  u.mcap.u.HighT0T1 <- phyloseq::distance(mcap.u.f.bac.HighT0T1, method = "wunifrac")
     mcap.u.samp.df.HighT0T1 <- as(sample_data(mcap.u.f.bac.HighT0T1), "data.frame") #sample df
        mcap.u.samp.df.HighT0T1$Code<-paste(mcap.u.samp.df.HighT0T1$Treatment, mcap.u.samp.df.HighT0T1$Time.Point)
        mcap.u.samp.df.HighT0T1$Code2<-paste(mcap.u.samp.df.HighT0T1$Treatment, mcap.u.samp.df.HighT0T1$Time.Point,mcap.u.samp.df.HighT0T1$Clade)

    set.seed(30)
    adonis(u.mcap.u.HighT0T1 ~ Time.Point, data = mcap.u.samp.df.HighT0T1) #adonis test no clade
   # Homogeneity of dispersion test  
     set.seed(30)
        permutest(betadisper(u.mcap.u.HighT0T1, mcap.u.samp.df.HighT0T1$Code, type = "centroid"))
        permutest(betadisper(u.mcap.u.HighT0T1, mcap.u.samp.df.HighT0T1$Code2, type = "centroid"))

#T1-TF
  mcap.u.bac.HighT1TF <- subset_samples(Bac.s.rel.u.HighT1TF, Species == "Montipora_capitata")
  sample_sums(mcap.u.bac.HighT1TF)

mcap.u.f.bac.HighT1TF = prune_taxa(taxa_sums(mcap.u.bac.HighT1TF) > 0, mcap.u.bac.HighT1TF) #this removes any OTU with 0s
  sample_sums(mcap.u.f.bac.HighT1TF)

#make bray curtis data matrix 
  u.mcap.u.HighT1TF <- phyloseq::distance(Bac.s.rel.u.HighT1TF, method = "wunifrac")
     mcap.u.samp.df.HighT1TF <- as(sample_data(Bac.s.rel.u.HighT1TF), "data.frame") #sample df

    set.seed(30)
    adonis(u.mcap.u.HighT1TF ~ Time.Point, data = mcap.u.samp.df.HighT1TF) #adonis 
   # Homogeneity of dispersion test  
     set.seed(30)
    permutest(betadisper(u.mcap.u.HighT1TF, mcap.u.samp.df.HighT1TF$Time.Point, type = "centroid"))

        
        
# pcomp #### 
 #T0-T1
pcomp.u.bac.HighT0T1 <- subset_samples(Bac.s.rel.u.HighT0T1, Species == "Porites_compressa")
  sample_sums(pcomp.u.bac.HighT0T1)

pcomp.u.f.bac.HighT0T1 = prune_taxa(taxa_sums(pcomp.u.bac.HighT0T1) > 0, pcomp.u.bac.HighT0T1) #this removes any OTU with 0s
  sample_sums(pcomp.u.f.bac.HighT0T1)

#make bray curtis data matrix 
  u.pcomp.u.HighT0T1 <- phyloseq::distance(pcomp.u.f.bac.HighT0T1, method = "wunifrac")
     pcomp.u.samp.df.HighT0T1 <- as(sample_data(pcomp.u.f.bac.HighT0T1), "data.frame") #sample df
        pcomp.u.samp.df.HighT0T1$Code<-paste(pcomp.u.samp.df.HighT0T1$Treatment, pcomp.u.samp.df.HighT0T1$Time.Point)
        pcomp.u.samp.df.HighT0T1$Code2<-paste(pcomp.u.samp.df.HighT0T1$Treatment, pcomp.u.samp.df.HighT0T1$Time.Point,pcomp.u.samp.df.HighT0T1$Clade)

    set.seed(30)
    adonis(u.pcomp.u.HighT0T1 ~ Time.Point, data = pcomp.u.samp.df.HighT0T1) #adonis test no clade
   # Homogeneity of dispersion test  
     set.seed(30)
        permutest(betadisper(u.pcomp.u.HighT0T1, pcomp.u.samp.df.HighT0T1$Code, type = "centroid"))
        permutest(betadisper(u.pcomp.u.HighT0T1, pcomp.u.samp.df.HighT0T1$Code2, type = "centroid"))

#T1-TF
  pcomp.u.bac.HighT1TF <- subset_samples(Bac.s.rel.u.HighT1TF, Species == "Porites_compressa")
  sample_sums(pcomp.u.bac.HighT1TF)

pcomp.u.f.bac.HighT1TF = prune_taxa(taxa_sums(pcomp.u.bac.HighT1TF) > 0, pcomp.u.bac.HighT1TF) #this removes any OTU with 0s
  sample_sums(pcomp.u.f.bac.HighT1TF)

#make bray curtis data matrix 
  u.pcomp.u.HighT1TF <- phyloseq::distance(Bac.s.rel.u.HighT1TF, method = "wunifrac")
     pcomp.u.samp.df.HighT1TF <- as(sample_data(Bac.s.rel.u.HighT1TF), "data.frame") #sample df

    set.seed(30)
    adonis(u.pcomp.u.HighT1TF ~ Time.Point, data = pcomp.u.samp.df.HighT1TF) #adonis 
   # Homogeneity of dispersion test  
     set.seed(30)
    permutest(betadisper(u.pcomp.u.HighT1TF, pcomp.u.samp.df.HighT1TF$Time.Point, type = "centroid"))    
# pvar #### 
 #T0-T1
pvar.u.bac.HighT0T1 <- subset_samples(Bac.s.rel.u.HighT0T1, Species == "Pavona_varians")
  sample_sums(pvar.u.bac.HighT0T1)

pvar.u.f.bac.HighT0T1 = prune_taxa(taxa_sums(pvar.u.bac.HighT0T1) > 0, pvar.u.bac.HighT0T1) #this removes any OTU with 0s
  sample_sums(pvar.u.f.bac.HighT0T1)

#make bray curtis data matrix 
  u.pvar.u.HighT0T1 <- phyloseq::distance(pvar.u.f.bac.HighT0T1, method = "wunifrac")
     pvar.u.samp.df.HighT0T1 <- as(sample_data(pvar.u.f.bac.HighT0T1), "data.frame") #sample df
        pvar.u.samp.df.HighT0T1$Code<-paste(pvar.u.samp.df.HighT0T1$Treatment, pvar.u.samp.df.HighT0T1$Time.Point)
        pvar.u.samp.df.HighT0T1$Code2<-paste(pvar.u.samp.df.HighT0T1$Treatment, pvar.u.samp.df.HighT0T1$Time.Point,pvar.u.samp.df.HighT0T1$Clade)

    set.seed(30)
    adonis(u.pvar.u.HighT0T1 ~ Time.Point, data = pvar.u.samp.df.HighT0T1) #adonis test no clade
   # Homogeneity of dispersion test  
     set.seed(30)
        permutest(betadisper(u.pvar.u.HighT0T1, pvar.u.samp.df.HighT0T1$Code, type = "centroid"))
        permutest(betadisper(u.pvar.u.HighT0T1, pvar.u.samp.df.HighT0T1$Code2, type = "centroid"))

#T1-TF
  pvar.u.bac.HighT1TF <- subset_samples(Bac.s.rel.u.HighT1TF, Species == "Pavona_varians")
  sample_sums(pvar.u.bac.HighT1TF)

pvar.u.f.bac.HighT1TF = prune_taxa(taxa_sums(pvar.u.bac.HighT1TF) > 0, pvar.u.bac.HighT1TF) #this removes any OTU with 0s
  sample_sums(pvar.u.f.bac.HighT1TF)

#make bray curtis data matrix 
  u.pvar.u.HighT1TF <- phyloseq::distance(Bac.s.rel.u.HighT1TF, method = "wunifrac")
     pvar.u.samp.df.HighT1TF <- as(sample_data(Bac.s.rel.u.HighT1TF), "data.frame") #sample df

    set.seed(30)
    adonis(u.pvar.u.HighT1TF ~ Time.Point, data = pvar.u.samp.df.HighT1TF) #adonis 
   # Homogeneity of dispersion test  
     set.seed(30)
    permutest(betadisper(u.pvar.u.HighT1TF, pvar.u.samp.df.HighT1TF$Time.Point, type = "centroid"))    

# pacu #### 
 #T0-T1
pacu.u.bac.HighT0T1 <- subset_samples(Bac.s.rel.u.HighT0T1, Species == "Pocillopora_acuta")
  sample_sums(pacu.u.bac.HighT0T1)

pacu.u.f.bac.HighT0T1 = prune_taxa(taxa_sums(pacu.u.bac.HighT0T1) > 0, pacu.u.bac.HighT0T1) #this removes any OTU with 0s
  sample_sums(pacu.u.f.bac.HighT0T1)

#make bray curtis data matrix 
  u.pacu.u.HighT0T1 <- phyloseq::distance(pacu.u.f.bac.HighT0T1, method = "wunifrac")
     pacu.u.samp.df.HighT0T1 <- as(sample_data(pacu.u.f.bac.HighT0T1), "data.frame") #sample df
        pacu.u.samp.df.HighT0T1$Code<-paste(pacu.u.samp.df.HighT0T1$Treatment, pacu.u.samp.df.HighT0T1$Time.Point)
        pacu.u.samp.df.HighT0T1$Code2<-paste(pacu.u.samp.df.HighT0T1$Treatment, pacu.u.samp.df.HighT0T1$Time.Point,pacu.u.samp.df.HighT0T1$Clade)

    set.seed(30)
    adonis(u.pacu.u.HighT0T1 ~ Time.Point, data = pacu.u.samp.df.HighT0T1) #adonis test no clade
   # Homogeneity of dispersion test  
     set.seed(30)
        permutest(betadisper(u.pacu.u.HighT0T1, pacu.u.samp.df.HighT0T1$Code, type = "centroid"))
        permutest(betadisper(u.pacu.u.HighT0T1, pacu.u.samp.df.HighT0T1$Code2, type = "centroid"))

#T1-TF
  pacu.u.bac.HighT1TF <- subset_samples(Bac.s.rel.u.HighT1TF, Species == "Pocillopora_acuta")
  sample_sums(pacu.u.bac.HighT1TF)

pacu.u.f.bac.HighT1TF = prune_taxa(taxa_sums(pacu.u.bac.HighT1TF) > 0, pacu.u.bac.HighT1TF) #this removes any OTU with 0s
  sample_sums(pacu.u.f.bac.HighT1TF)

#make bray curtis data matrix 
  u.pacu.u.HighT1TF <- phyloseq::distance(Bac.s.rel.u.HighT1TF, method = "wunifrac")
     pacu.u.samp.df.HighT1TF <- as(sample_data(Bac.s.rel.u.HighT1TF), "data.frame") #sample df

    set.seed(30)
    adonis(u.pacu.u.HighT1TF ~ Time.Point, data = pacu.u.samp.df.HighT1TF) #adonis 
   # Homogeneity of dispersion test  
     set.seed(30)
    permutest(betadisper(u.pacu.u.HighT1TF, pacu.u.samp.df.HighT1TF$Time.Point, type = "centroid"))    
