...
adonis(Bac.s.u.T1F ~ Species*Treatment*Time.Point*Clade, data = s.u.samp.df)
     ...
     # Homogeneity of dispersion test  
    set.seed(30)
    t<-permutest(betadisper(Bac.s.u.T1F, s.u.samp.df$Species, type = "centroid")) 
   set.seed(30)
    permutest(betadisper(Bac.s.u.T1F, s.u.samp.df$Treatment, type = "centroid")) 
    
  ball<-  betadisper(Bac.s.u.T1F, s.u.samp.df$Species, type = "centroid")
...
scores.ord.u_ALLfield_stats$Code <- paste(scores.ord.u_ALLfield_stats$Clade, scores.ord.u_ALLfield_stats$Species)
