...
AFDW <- read.csv("Data/ACE21_AFDW_20210308.csv")
  AFDW <- AFDW[!(AFDW$Frag.ID == "1195"),] #remove samples not in experiment
...
WaxDipping <- read.csv("Data/WaxDipping_Results_20190403.csv")
  WaxDipping <- WaxDipping[!(WaxDipping$Frag.ID == "1195"),] #remove samples not in experiment
...
Slurry <- read.csv("Data/TT17_airbrush_totalVol_20190420.csv")
  Slurry <- Slurry[!(Slurry$Frag.ID == "1195"),] #remove samples not in experiment
...
# mean
biomass2_mean <- ddply(biomass2, c("Treatment", "Species", "Time.Point"), summarise, 
...
# T1 and TF ####
  ...
  Biomass_model<-lmer(AFDWmg.cm2~Time.Point*Treatment*Species+(1|Parent.ID)+(1|Tank.num), biomass_stats_T1TF)
  anova(Biomass_model) 
...
Biomass_Mcap_model<-lmer(AFDWmg.cm2~Time.Point*Treatment*Clade+(1|Parent.ID)+(1|Tank.num), biomass_stats_T1TF_Mcap) #clade
  anova(Biomass_Mcap_model) 
  qqPlot(residuals(Biomass_Mcap_model)) 
  emm<-emmeans(Biomass_Mcap_model,  ~ Time.Point*Treatment, adjust="Tukey")
  cld(emm)
...
All_biomass_plot<-ggplot(data=biomass_T0_mean, aes(x=Species, y=mean, group = Species, color=Species)) +
  ...
  geom_point(aes(color=Species), size=4, show.legend = F)+
  geom_line(aes(color=Species), linetype=2, show.legend = F)+
  ...
  ylab(expression(paste("mg cm"^"-2"))) +
  ggtitle("Time 0")+
  theme(plot.title = element_text(size=20, face = "italic"));All_biomass_plot

#by clade T0
biomass_T0_mean.clade <- ddply(biomass_T0, c( "Species","Clade"), summarise, 
                 N    = length(AFDWmg.cm2[!is.na(AFDWmg.cm2)]), 
                 mean = mean(AFDWmg.cm2, na.rm=TRUE), 
                 sd   = sd(AFDWmg.cm2, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
biomass_TFH_mean <- ddply(biomass_TFH, c( "Species"), summarise, 
                 N    = length(AFDWmg.cm2[!is.na(AFDWmg.cm2)]), 
                 mean = mean(AFDWmg.cm2, na.rm=TRUE), 
                 sd   = sd(AFDWmg.cm2, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
#means
biomass_means <- ddply(biomass2, c( "Species","Treatment","Time.Point"), summarise, 
                 N    = length(AFDWmg.cm2[!is.na(AFDWmg.cm2)]), 
                 mean = mean(AFDWmg.cm2, na.rm=TRUE), 
                 sd   = sd(AFDWmg.cm2, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
biomass2_Pcompmean <- ddply(Pcomp_biomass2, c("Treatment", "Clade", "Time.Point"), summarise, 
                 N    = length(AFDWmg.cm2[!is.na(AFDWmg.cm2)]), 
                 mean = mean(AFDWmg.cm2, na.rm=TRUE), 
                 sd   = sd(AFDWmg.cm2, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
```
Biomass plots by clade
```{r}
 #means
biomass_means.C <- ddply(biomass2, c( "Species","Treatment","Time.Point", "Clade"), summarise, 
                 N    = length(AFDWmg.cm2[!is.na(AFDWmg.cm2)]), 
                 mean = mean(AFDWmg.cm2, na.rm=TRUE), 
                 sd   = sd(AFDWmg.cm2, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
Mcap_biomass_mean.C<-subset(biomass_means.C, Species=="Montipora_capitata")
Mcap_biomass_mean.C$Code<-paste(Mcap_biomass_mean.C$Clade,Mcap_biomass_mean.C$Treatment)

#plot Mcap #### 
Mcap_biomass_plot.C<-ggplot(data=Mcap_biomass_mean.C, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Code), size=4, show.legend = T)+  
  ...
  ylab(expression(paste("Tissue biomass mg cm"^"-2"))) +
  # ggtitle("M capitata")+
  theme(plot.title = element_text(size=20, face = "italic"));Mcap_biomass_plot.C

# Pcomp  ####
Pcomp_biomass_mean.C<-subset(biomass_means.C, Species=="Porites_compressa")
Pcomp_biomass_mean.C$Code<-paste(Pcomp_biomass_mean.C$Clade,Pcomp_biomass_mean.C$Treatment)

#plot Pcomp #### 
Pcomp_biomass_plot.C<-ggplot(data=Pcomp_biomass_mean.C, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Code), size=4, show.legend = T)+  
  geom_line(aes(color=Code),linetype="dotted")+
  ...
  # ylab(expression(paste("Tissue biomass mg cm"^"-2"))) +
  # ggtitle("M capitata")+
  theme(plot.title = element_text(size=20, face = "italic"));Pcomp_biomass_plot.C

# Pvar  ####
Pvar_biomass_mean.C<-subset(biomass_means.C, Species=="Pavona_varians")
Pvar_biomass_mean.C$Code<-paste(Pvar_biomass_mean.C$Clade,Pvar_biomass_mean.C$Treatment)

#plot Pvar #### 
Pvar_biomass_plot.C<-ggplot(data=Pvar_biomass_mean.C, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
 geom_point(aes(color=Code), size=4, show.legend = T)+  
  geom_line(aes(color=Code),linetype="dotted")+
  ...
  # ylab(expression(paste("Tissue biomass mg cm"^"-2"))) +
  # ggtitle("M capitata")+
  theme(plot.title = element_text(size=20, face = "italic"));Pvar_biomass_plot.C

# Pacu ####
Pacu_biomass_mean.C<-subset(biomass_means.C, Species=="Pocillopora_acuta")
Pacu_biomass_mean.C$Code<-paste(Pacu_biomass_mean.C$Clade,Pacu_biomass_mean.C$Treatment)

#plot Pacu #### 
Pacu_biomass_plot.C<-ggplot(data=Pacu_biomass_mean.C, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Code), size=4, show.legend = T)+  
  geom_line(aes(color=Code),linetype="dotted")+
  ...
  # ylab(expression(paste("Tissue biomass mg cm"^"-2"))) +
  # ggtitle("M capitata")+
  theme(plot.title = element_text(size=20, face = "italic"));Pacu_biomass_plot.C

###### All plots together
Mcap_biomass_plot.C<-Mcap_biomass_plot.C+ theme(legend.position = "none") #remove legend
Pcomp_biomass_plot.C<-Pcomp_biomass_plot.C+ theme(legend.position = "none") #remove legend
Pvar_biomass_plot.C<-Pvar_biomass_plot.C+ theme(legend.position = "none") #remove legend
Pacu_biomass_plot.C<-Pacu_biomass_plot.C+ theme(legend.position = "none") #remove legend

grid.arrange(Mcap_biomass_plot.C, Pcomp_biomass_plot.C, Pvar_biomass_plot.C,Pacu_biomass_plot.C, nrow = 1)
```
...
PlateB$Concentration<-as.numeric(as.character(PlateB$Concentration)) # this is loading in as a factor
...
PlateC$Concentration<-as.numeric(as.character(PlateC$Concentration)) # this is loading in as a factor
...
PlateE$Concentration<-as.numeric(as.character(PlateE$Concentration)) # this is loading in as a factor
PlateE <- subset(PlateE, Gate.Name == "Symbiodinium")
keepE <- c("Sample.Name", "Concentration")
PlateE <- PlateE[keepE]
E_meta <- read.csv("Data/TT17_FC_PlateE.csv") # load Plate E location data
...
tData$Parent.ID<- as.factor(tData$Parent.ID) 
  tData$Frag.ID<-as.factor(tData$Frag.ID)
  tData$Sample.Name<-as.factor(tData$Sample.Name)
  tData$Treatment<-as.factor(tData$Treatment)
  tData$Species<-as.factor(tData$Species)
  tData$Time.Point<-as.factor(tData$Time.Point)
  tData$Tissue<-as.factor(tData$Tissue)
  tData$transmission<-as.factor(tData$transmission)
...
duplicated(tData$Frag.ID) #check 428 Pacu TF, N172mcap T1,1133 mcap t1 <- WHY******
...
#mean tables
#
FC.biomass_Sum <- ddply(FC_Data, c("Species","Treatment", "Time.Point"), summarise, 
                   N    = length(zoox.AFDWmg.cm2[!is.na(zoox.AFDWmg.cm2)]), 
                   mean = mean(zoox.AFDWmg.cm2, na.rm=TRUE), 
                   sd   = sd(zoox.AFDWmg.cm2, na.rm=TRUE), 
                   se   = sd / sqrt(N), 
                   max = max(zoox.AFDWmg.cm2, na.rm=TRUE) 
)
FC.biomass_Sum #display table

FC_SumClade <- ddply(FC_Data, c("Treatment", "Clade", "Species","Time.Point"), summarise, 
...
FC_SumCladenoTemp <- ddply(FC_Data, c( "Clade", "Species","Time.Point"), summarise, 
                   N    = length(zoox.cm2[!is.na(zoox.cm2)]), 
                   mean = mean(zoox.cm2, na.rm=TRUE), 
                   sd   = sd(zoox.cm2, na.rm=TRUE), 
                   se   = sd / sqrt(N), 
...
FC_SumCladeSp.bio <- ddply(FC_Data, c( "Species","Time.Point"), summarise, 
                   N    = length(zoox.AFDWmg.cm2[!is.na(zoox.AFDWmg.cm2)]), 
                   mean = mean(zoox.AFDWmg.cm2, na.rm=TRUE), 
                   sd   = sd(zoox.AFDWmg.cm2, na.rm=TRUE), 
                   se   = sd / sqrt(N), 
...
#mean tables
# Mcap
Mcap_FC_Sum <- ddply(Mcap_FC, c("Treatment", "Time.Point"), summarise, 
                   N    = length(zoox.cm2[!is.na(zoox.cm2)]), 
                   mean = mean(zoox.cm2, na.rm=TRUE), 
                   sd   = sd(zoox.cm2, na.rm=TRUE), 
                   se   = sd / sqrt(N), 
...
# Pcomp
Pcomp_FC_Sum <- ddply(Pcomp_FC, c("Treatment", "Time.Point"), summarise, 
                   N    = length(zoox.cm2[!is.na(zoox.cm2)]), 
                   mean = mean(zoox.cm2, na.rm=TRUE), 
                   sd   = sd(zoox.cm2, na.rm=TRUE), 
                   se   = sd / sqrt(N), 
...
Pcomp_FC_SumClade <- ddply(Pcomp_FC, c("Treatment", "Clade", "Time.Point"), summarise, 
                   N    = length(zoox.cm2[!is.na(zoox.cm2)]), 
                   mean = mean(zoox.cm2, na.rm=TRUE), 
                   sd   = sd(zoox.cm2, na.rm=TRUE), 
                   se   = sd / sqrt(N), 
...
# Pvar
Pvar_FC_Sum <- ddply(Pvar_FC, c("Treatment", "Time.Point"), summarise, 
                   N    = length(zoox.cm2[!is.na(zoox.cm2)]), 
                   mean = mean(zoox.cm2, na.rm=TRUE), 
                   sd   = sd(zoox.cm2, na.rm=TRUE), 
                   se   = sd / sqrt(N), 
...
Pvar_FC_SumClade <- ddply(Pvar_FC, c("Treatment", "Time.Point","Clade"), summarise, 
                   N    = length(zoox.cm2[!is.na(zoox.cm2)]), 
                   mean = mean(zoox.cm2, na.rm=TRUE), 
                   sd   = sd(zoox.cm2, na.rm=TRUE), 
                   se   = sd / sqrt(N), 
...
# Pacu
Pacu_FC_Sum <- ddply(Pacu_FC, c("Treatment", "Time.Point"), summarise, 
                   N    = length(zoox.cm2[!is.na(zoox.cm2)]), 
                   mean = mean(zoox.cm2, na.rm=TRUE), 
                   sd   = sd(zoox.cm2, na.rm=TRUE), 
                   se   = sd / sqrt(N), 
...
FC_Pacu_model<-lmer(zoox.cm2_log~Time.Point*Treatment*Clade+(1|Parent.ID)+(1|Tank.num), FC_stats_T1TF_Pacu)  anova(FC_Pacu_model) 
...
```{r}   
# T0 ####   
FC_T0_mean <- ddply(FC_stats_T0, c( "Species"), summarise, 
                 N    = length(zoox.cm2[!is.na(zoox.cm2)]), 
                 mean = mean(zoox.cm2, na.rm=TRUE), 
                 sd   = sd(zoox.cm2, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
FC_T0_mean_plot<-ggplot(data=FC_T0_mean, aes(x=Species, y=mean, group = Species, color=Species)) +
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        panel.background = element_rect(colour = "black", size=1))+
        theme(aspect.ratio=1)+
  ylab(expression(paste("cells cm"^"-2"))) +
  ggtitle("Time 0")+
  theme(plot.title = element_text(size=20, face = "italic"));FC_T0_mean_plot

#by clade T0
FC_T0_mean.clade <- ddply(FC_stats_T0, c( "Species","Clade"), summarise, 
                 N    = length(zoox.cm2[!is.na(zoox.cm2)]), 
                 mean = mean(zoox.cm2, na.rm=TRUE), 
                 sd   = sd(zoox.cm2, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
FC_TFH_mean <- ddply(FC_TFH, c( "Species"), summarise, 
                 N    = length(zoox.cm2[!is.na(zoox.cm2)]), 
                 mean = mean(zoox.cm2, na.rm=TRUE), 
                 sd   = sd(zoox.cm2, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
#means
FC_mean <- ddply(FC_Data, c( "Species","Treatment","Time.Point"), summarise, 
                 N    = length(zoox.cm2[!is.na(zoox.cm2)]), 
                 mean = mean(zoox.cm2, na.rm=TRUE), 
                 sd   = sd(zoox.cm2, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
FC_SumClade.mcap$Code<-paste(FC_SumClade.mcap$Treatment,FC_SumClade.mcap$Clade)
 ...
 FC_SumClade.mcap_T1TF<-subset(FC_SumClade.mcap, Time.Point=="T1"|Time.Point=="TF")
 
#by clade FC_SumClade.mcap
 Mcap_FC_lineplot.c2<-ggplot(data=FC_SumClade.mcap_T1TF, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Code, shape=Clade), size=8, show.legend = T)+
  geom_line(aes(color=Code),linetype="dotted")+
  scale_color_manual(values=c("dodgerblue3","blue", "darkred","red"))+
   # geom_point(aes(shape=Clade),shape = 1,size = 8,colour = "black")+
  xlab("Time Point") + #Label the X Axis
       #scale_y_log10()+
   #   ylim(0, 4000000)+
  theme_bw() + #Set the background color
  ...
  ylab(expression(paste("cells"))) +
   theme(panel.grid.major = element_blank(), 
        ...
        theme(aspect.ratio=1)+
  ggtitle("M capitata")+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Mcap_FC_lineplot.c2
 
 Mcap_FC_lineplot.c2+facet_wrap(~Clade)
...
#pcomp clades Pcomp_FC_SumClade  FIX COLORS
...
Pcomp_FC_SumClade_T1TF<-subset(Pcomp_FC_SumClade, Time.Point=="T1"|Time.Point=="TF")
 
#by clade FC_SumClade.mcap
 pcmp_FC_lineplot.c2<-ggplot(data=Pcomp_FC_SumClade_T1TF, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Code, shape=Clade), size=8, show.legend = T)+
  geom_line(aes(color=Code),linetype="dotted")+
  ...
  ylab(expression(paste("cells"))) +
   ...
   #      theme(aspect.ratio=1)+
  ggtitle("pcomp")+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));pcmp_FC_lineplot.c2
 
FC_SumClade.pcomp_T1TF<-subset(Pcomp_FC_SumClade, Time.Point=="T1"|Time.Point=="TF")
 
#by clade FC_SumClade.mcap
 pcomp_FC_lineplot.c2<-ggplot(data=FC_SumClade.pcomp_T1TF, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Code, shape=Clade), size=8, show.legend = T)+
  geom_line(aes(color=Code),linetype="dotted")+
  ...
  ylab(expression(paste("cells"))) +
   theme(panel.grid.major = element_blank(), 
        ...
        theme(aspect.ratio=1)+
  ggtitle("Pcomp")+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));pcomp_FC_lineplot.c2
...
all plots by clade
```{r}
FC_mean.C <- ddply(FC_Data, c( "Species","Treatment","Time.Point","Clade"), summarise, 
                 N    = length(zoox.cm2[!is.na(zoox.cm2)]), 
                 mean = mean(zoox.cm2, na.rm=TRUE), 
                 sd   = sd(zoox.cm2, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
FC_mean.C$Code<-paste(FC_mean.C$Species,FC_mean.C$Clade,FC_mean.C$Treatment)

Mcap_FC_mean.C<-subset(FC_mean.C, Species=="Montipora_capitata")

#plot Mcap #### 
Mcap_FC_plot.C<-ggplot(data=Mcap_FC_mean.C, aes(x=Time.Point, y=mean, group = Code, color=Treatment)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  ...
  ylab(expression(paste("cells cm"^"-2"))) +
  # ggtitle("M capitata")+
  theme(plot.title = element_text(size=20, face = "italic"));Mcap_FC_plot.C
# Pcomp  ####
Pcomp_FC_mean.C<-subset(FC_mean.C, Species=="Porites_compressa")

#plot Pcomp #### 
Pcomp_FC_plot.C<-ggplot(data=Pcomp_FC_mean.C, aes(x=Time.Point, y=mean, group = Code, color=Treatment)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Treatment, shape=Clade), size=4, show.legend = T)+
  geom_line(aes(color=Treatment), linetype=2, show.legend = F)+
  ...
  #       panel.background = element_rect(colour = "black", size=1))+
        theme(aspect.ratio=1)+
  # ylab(expression(paste("Tissue FC mg cm"^"-2"))) +
  # ggtitle("M capitata")+
  theme(plot.title = element_text(size=20, face = "italic"));Pcomp_FC_plot.C

# Pvar  ####

Pvar_FC_mean.C<-subset(FC_mean.C, Species=="Pavona_varians")

#plot Pvar #### 
Pvar_FC_plot.C<-ggplot(data=Pvar_FC_mean.C, aes(x=Time.Point, y=mean, group = Code, color=Treatment)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Treatment, shape=Clade), size=4, show.legend = T)+
  geom_line(aes(color=Treatment), linetype=2, show.legend = F)+
  ...
  # ylab(expression(paste("Tissue FC mg cm"^"-2"))) +
  # ggtitle("M capitata")+
  theme(plot.title = element_text(size=20, face = "italic"));Pvar_FC_plot.C

# Pacu ####

Pacu_FC_mean.C<-subset(FC_mean.C, Species=="Pocillopora_acuta")

#plot Pacu #### 
Pacu_FC_plot.C<-ggplot(data=Pacu_FC_mean.C, aes(x=Time.Point, y=mean, group = Code, color=Treatment)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Treatment, shape=Clade), size=4, show.legend = T)+
  geom_line(aes(color=Treatment), linetype=2, show.legend = F)+
  ...
  # ylab(expression(paste("Tissue FC mg cm"^"-2"))) +
  # ggtitle("M capitata")+
  theme(plot.title = element_text(size=20, face = "italic"));Pacu_FC_plot.C


###### All plots together
Mcap_FC_plot.C<-Mcap_FC_plot.C+ theme(legend.position = "none") #remove legend
Pcomp_FC_plot.C<-Pcomp_FC_plot.C+ theme(legend.position = "none") #remove legend
Pvar_FC_plot.C<-Pvar_FC_plot.C+ theme(legend.position = "none") #remove legend
Pacu_FC_plot.C<-Pacu_FC_plot.C+ theme(legend.position = "none") #remove legend

grid.arrange(Mcap_FC_plot.C, Pcomp_FC_plot.C, Pvar_FC_plot.C,Pacu_FC_plot.C, nrow = 1)
```

# boxplot
```{r}
FC_meanlog <- ddply(FC_Data, c( "Species","Treatment","Time.Point"), summarise, 
                 N    = length(zoox.cm2_log[!is.na(zoox.cm2_log)]), 
                 mean = mean(zoox.cm2_log, na.rm=TRUE), 
                 sd   = sd(zoox.cm2_log, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
                 max = max(zoox.cm2_log, na.rm=TRUE) 
)
FC_meanlog

FC_mean_box<-subset(FC_meanlog, Time.Point=="T1"|Time.Point=="TF")
FC_mean_box_mcap<-subset(FC_mean_box, Species=="Montipora_capitata")
FC_mean_box_pcomp<-subset(FC_mean_box, Species=="Porites_compressa")
FC_mean_box_pvar<-subset(FC_mean_box, Species=="Pavona_varians")
FC_mean_box_pacu<-subset(FC_mean_box, Species=="Pocillopora_acuta")

plot1<-ggplot(data=FC_mean_box_mcap, aes(x=Time.Point, y=mean, colour=Treatment, group=interaction(Time.Point, Treatment))) +
  geom_boxplot(position=position_dodge(0.9), lwd=1)+
  # geom_jitter(shape=16, position=position_dodge(0.9), size=3)+
  scale_color_manual(values=c("dodgerblue3", "darkred"))+

    xlab("Time Point")+
  ylab(paste("log cells cm2")) +
  theme_classic() +
  theme(text = element_text(size = 18, color="black"),
        ...
        axis.title.x = element_text(margin = margin(t = 3, r = 0, b = 0, l = 0)));plot1

plot1<-ggplot(data=FC_mean_box_pcomp, aes(x=Time.Point, y=mean, colour=Treatment, group=interaction(Time.Point, Treatment))) +
  geom_boxplot(position=position_dodge(0.9), lwd=1)+
  # geom_jitter(shape=16, position=position_dodge(0.9), size=3)+
  scale_color_manual(values=c("dodgerblue3", "darkred"))+
...
plot1<-ggplot(data=FC_mean_box_pvar, aes(x=Time.Point, y=mean, colour=Treatment, group=interaction(Time.Point, Treatment))) +
  geom_boxplot(position=position_dodge(0.9), lwd=1)+
  # geom_jitter(shape=16, position=position_dodge(0.9), size=3)+
  scale_color_manual(values=c("dodgerblue3", "darkred"))+
...
plot1<-ggplot(data=FC_mean_box_pacu, aes(x=Time.Point, y=mean, colour=Treatment, group=interaction(Time.Point, Treatment))) +
  geom_boxplot(position=position_dodge(0.9), lwd=.5)+
  geom_jitter(shape=16, position=position_dodge(0.9), size=3)+
  scale_color_manual(values=c("dodgerblue3", "darkred"))+
...
##calc BW for Mcap in general (T0-T1 ambient only) 
# data_McapBW.amb<-subset(data_McapBW, Treatment=="Ambient")
# write.csv(data_McapBW.amb,"data_McapBW.amb.csv")
...
# plots by clade
Mcap_BW_plot.c<-Mcap_BW_plot.c+ theme(legend.position = "none") #remove legend
Pcomp_BW_plot.c<-Pcomp_BW_plot.c+ theme(legend.position = "none") #remove legend
Pvar_BW_plot.c<-Pvar_BW_plot.c+ theme(legend.position = "none") #remove legend
Pacu_BW_plot.c<-Pacu_BW_plot.c+ theme(legend.position = "none") #remove legend

grid.arrange(Mcap_BW_plot.c, Pcomp_BW_plot.c, Pvar_BW_plot.c, Pacu_BW_plot.c, nrow = 1)
...
#T0 (T0-T1 abm)
T0Growth<-rbind(G_Mcap, G_Pcomp, G_Pvar, G_Pacu)
T0Growth<-subset(T0Growth,Time=="Time1")
T0Growth<-subset(T0Growth,Treatment=="Ambient")

grow_T0_mean_plot<-ggplot(data=T0Growth, aes(x=Species, y=mean, group = Species, color=Species)) +
  geom_errorbar(aes(ymin=mean-sem, ymax=mean+sem),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Species), size=4, show.legend = F)+
  geom_line(aes(color=Species), linetype=2, show.legend = F)+
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        panel.background = element_rect(colour = "black", size=1))+
        theme(aspect.ratio=1)+
  ylab(expression(paste("% change"))) +
  ggtitle("Time 0")+
  theme(plot.title = element_text(size=20, face = "italic"));grow_T0_mean_plot
...
#T0 by clade
Chla_T0_mean.c <- ddply(Chla_T0, c( "Species","Clade"), summarise, 
                 N    = length(ChlaSA[!is.na(ChlaSA)]), 
                 mean = mean(ChlaSA, na.rm=TRUE), 
                 sd   = sd(ChlaSA, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
Chla_TFH_mean <- ddply(Chla_TFH, c( "Species"), summarise, 
                 N    = length(ChlaSA[!is.na(ChlaSA)]), 
                 mean = mean(ChlaSA, na.rm=TRUE), 
                 sd   = sd(ChlaSA, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
Pvar_Chla_plot.c<-ggplot(data=Pvar_chla.Clade, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Code), size=4, show.legend = T)+  
  geom_line(aes(color=Code),linetype="dotted")+
  ...
  #       panel.background = element_rect(colour = "black", size=1))+
        theme(aspect.ratio=1)+
  # ggtitle("P varians")+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Pvar_Chla_plot.c
...
###### All plots together CLADE
Mcap_Chla_plot.c<-Mcap_Chla_plot.c+ theme(legend.position = "none") #remove legend
Pcomp_Chla_plot.c<-Pcomp_Chla_plot.c+ theme(legend.position = "none") #remove legend
Pvar_Chla_plot.c<-Pvar_Chla_plot.c+ theme(legend.position = "none") #remove legend
Pacu_Chla_plot.c<-Pacu_Chla_plot.c+ theme(legend.position = "none") #remove legend

grid.arrange(Mcap_Chla_plot.c, Pcomp_Chla_plot.c, Pvar_Chla_plot.c,Pacu_Chla_plot.c, nrow = 1)
```
...
PAM_T0_mean <- ddply(PAM_T0, c( "Species"), summarise, 
                 N    = length(Yield[!is.na(Yield)]), 
                 mean = mean(Yield, na.rm=TRUE), 
                  sd   = sd(Yield, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
#t0 by clade
PAM_T0_mean.c <- ddply(PAM_T0, c( "Species","Clade"), summarise, 
                 N    = length(Yield[!is.na(Yield)]), 
                 mean = mean(Yield, na.rm=TRUE), 
                  sd   = sd(Yield, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
Pcomp_PAM_plot<-ggplot(data=Pcomp_PAM_mean.clade, aes(x=Days, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Code, shape=Clade), size=4, show.legend = T)+  
  geom_line(aes(color=Code),linetype="dotted")+
  scale_color_manual(values=c("dodgerblue3", "darkred","blue","red"))+
   geom_point(shape = 1,size = 4,colour = "black")+
  xlab("Time Point") + #Label the X Axis
...
#just T0 #### 
Protein_T0_mean <- ddply(Prot_stats_T0, c( "Species"), summarise, 
                 N    = length(mg.mm2[!is.na(mg.mm2)]), 
                 mean = mean(mg.mm2, na.rm=TRUE), 
                 sd   = sd(mg.mm2, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
prot_T0_mean_plot<-ggplot(data=Protein_T0_mean, aes(x=Species, y=mean, group = Species, color=Species)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Species), size=4, show.legend = F)+
  geom_line(aes(color=Species), linetype=2, show.legend = F)+
  ...
  ylab(expression(paste("mg cm"^"-2"))) +
  ggtitle("Time 0")+
  theme(plot.title = element_text(size=20, face = "italic"));prot_T0_mean_plot
...
Protein_TFH_mean <- ddply(Protein_TFH, c( "Species"), summarise, 
                 N    = length(mg.mm2[!is.na(mg.mm2)]), 
                 mean = mean(mg.mm2, na.rm=TRUE), 
                 sd   = sd(mg.mm2, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
#Pacu by clade
Protein_meanCLADE.Pacu<-subset(Protein_meanCLADE, Species=="Pocillopora_acuta")
...
Photosynthesis
```{r}       
GrossP_mean <- ddply(PR.df_B, c("Treatment", "Species", "Time.Point"), summarise, 
...
GrossP_mean #display table

GrossP_meanCLADE <- ddply(PR.df_BPR.df_B.T0, c("Treatment", "Species", "Time.Point","Clade"), summarise, 
                   N    = length(GrossP[!is.na(GrossP)]), 
                   mean = mean(GrossP, na.rm=TRUE), 
                   sd   = sd(GrossP, na.rm=TRUE), 
                   se   = sd / sqrt(N), 
...
PR.df_BPR.df_B.T0_mean <- ddply(PR.df_BPR.df_B.T0, c( "Species"), summarise, 
                 N    = length(GrossP[!is.na(GrossP)]), 
                 mean = mean(GrossP, na.rm=TRUE), 
                 sd   = sd(GrossP, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
#plot all
Photo_T0_mean_plot<-ggplot(data=PR.df_BPR.df_B.T0_mean, aes(x=Species, y=mean, group = Species, color=Species)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Species), size=4, show.legend = F)+
  geom_line(aes(color=Species), linetype=2, show.legend = F)+
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        panel.background = element_rect(colour = "black", size=1))+
        theme(aspect.ratio=1)+
  ylab(expression(paste("nmol cm"^"-2 min"^"-"))) +
  ggtitle("Gross Photosynthesis T0")+
  theme(plot.title = element_text(size=20, face = "italic"));Photo_T0_mean_plot


 

#TFH only####
GrossP_TFH<-subset(PR.df_B, Time.Point=="TF"&Treatment=="High") #Subset Pvar
GrossP_TFH_mean <- ddply(GrossP_TFH, c( "Species"), summarise, 
                 N    = length(GrossP[!is.na(GrossP)]), 
                 mean = mean(GrossP, na.rm=TRUE), 
                 sd   = sd(GrossP, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
#plot all
GrossP_TFH_plot<-ggplot(data=GrossP_TFH_mean, aes(x=Species, y=mean, group = Species, color=Species)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Species), size=4, show.legend = T)+
  geom_line(aes(color=Species), linetype=2, show.legend = T)+
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        panel.background = element_rect(colour = "black", size=1))+
        theme(aspect.ratio=1)+
  ylab(expression(paste("nmol O2 cm-2 m-"))) +
  ggtitle("Time F, High only")+
  theme(plot.title = element_text(size=20, face = "italic"));GrossP_TFH_plot
...
# divide by species ####
Mcap_GrossP_mean<-subset(GrossP_mean, Species =="Montipora_capitata")
Pcomp_GrossP_mean<-subset(GrossP_mean, Species =="Porites_compressa")
Pvar_GrossP_mean<-subset(GrossP_mean, Species =="Pavona_varians")
Pacu_GrossP_mean<-subset(GrossP_mean, Species =="Pocillopora_acuta")

#Mcap plot

Mcap_GrossP_plot<-ggplot(data=Mcap_GrossP_mean, aes(x=Time.Point, y=mean, group = Treatment, color=Treatment)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Treatment), size=4, show.legend = T)+  
  geom_line(aes(color=Treatment),linetype="dotted")+
...
#         panel.background = element_rect(colour = "black", size=2))+
        theme(aspect.ratio=1)+
  # ggtitle("Mcap P")+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Mcap_GrossP_plot


#Pcomp plot

Pcomp_GrossP_plot<-ggplot(data=Pcomp_GrossP_mean, aes(x=Time.Point, y=mean, group = Treatment, color=Treatment)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Treatment), size=4, show.legend = T)+  
  geom_line(aes(color=Treatment),linetype="dotted")+
  ...
  # ggtitle("Pcomp P")+
          theme(aspect.ratio=1)+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Pcomp_GrossP_plot


#pcomp clade GrossP_meanCLADE
GrossP_meanCLADE.pcomp<-subset(Photo_meanCLADE, Species=="Porites_compressa")
GrossP_meanCLADE.pcomp$Code<-paste(GrossP_meanCLADE.pcomp$Treatment,GrossP_meanCLADE.pcomp$Clade)

Pcomp_GrossP_plot<-ggplot(data=GrossP_meanCLADE.pcomp, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Code), size=4, show.legend = T)+  
  geom_line(aes(color=Code),linetype="dotted")+
...
Pvar_GrossP_plot<-ggplot(data=Pvar_GrossP_mean, aes(x=Time.Point, y=mean, group = Treatment, color=Treatment)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Treatment), size=4, show.legend = T)+  
  geom_line(aes(color=Treatment),linetype="dotted")+
  ...
  #       panel.background = element_rect(colour = "black", size=2))+
          theme(aspect.ratio=1)+
  # ggtitle("Pvar P")+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Pvar_GrossP_plot

#Pacu plot

Pacu_GrossP_plot<-ggplot(data=Pacu_GrossP_mean, aes(x=Time.Point, y=mean, group = Treatment, color=Treatment)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Treatment), size=4, show.legend = T)+ 
    ylim(0,30)+
  ...
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Pacu_GrossP_plot

```
P Plots together
```{r} 
###### All plots together
Mcap_GrossP_plot<-Mcap_GrossP_plot+ theme(legend.position = "none") #remove legend
Pcomp_GrossP_plot<-Pcomp_GrossP_plot+ theme(legend.position = "none") #remove legend
Pvar_GrossP_plot<-Pvar_GrossP_plot+ theme(legend.position = "none") #remove legend
Pacu_GrossP_plot<-Pacu_GrossP_plot+ theme(legend.position = "none") #remove legend

grid.arrange(Mcap_GrossP_plot, Pcomp_GrossP_plot, Pvar_GrossP_plot,Pacu_GrossP_plot, nrow = 1)
library(gridExtra)
...
```{r}  
#Mcap 
GrossP_mean.Clade <- ddply(PR.df_B, c("Treatment", "Species", "Time.Point","Clade"), summarise, 
                   N    = length(GrossP[!is.na(GrossP)]), 
                   mean = mean(GrossP, na.rm=TRUE), 
                   sd   = sd(GrossP, na.rm=TRUE), 
                   se   = sd / sqrt(N), 
...
GrossP_mean.Clade #display table

# divide by species
Mcap_GrossP_mean.Clade<-subset(GrossP_mean.Clade, Species =="Montipora_capitata")
  Mcap_GrossP_mean.Clade$Code<-paste(Mcap_GrossP_mean.Clade$Clade, Mcap_GrossP_mean.Clade$Treatment)
Pcomp_GrossP_mean.Clade<-subset(GrossP_mean.Clade, Species =="Porites_compressa")
  Pcomp_GrossP_mean.Clade$Code<-paste(Pcomp_GrossP_mean.Clade$Clade, Pcomp_GrossP_mean.Clade$Treatment)
Pvar_GrossP_mean.Clade<-subset(GrossP_mean.Clade, Species =="Pavona_varians")
  Pvar_GrossP_mean.Clade$Code<-paste(Pvar_GrossP_mean.Clade$Clade, Pvar_GrossP_mean.Clade$Treatment)
Pacu_GrossP_mean.Clade<-subset(GrossP_mean.Clade, Species =="Pocillopora_acuta")
  Pacu_GrossP_mean.Clade$Code<-paste(Pacu_GrossP_mean.Clade$Clade, Pacu_GrossP_mean.Clade$Treatment)


library(RColorBrewer)

#Mcap by clade
Mcap_GrossP_mean.Clade$Code<-paste(Mcap_GrossP_mean.Clade$Treatment,Mcap_GrossP_mean.Clade$Clade)

Mcap_GrossP_plot.Clade<-ggplot(data=Mcap_GrossP_mean.Clade, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
            width=0.1, show.legend = T)+
  geom_point(aes(color=Code), size=4, show.legend = T)+ 
...
#         panel.background = element_rect(colour = "black", size=2))+
        theme(aspect.ratio=1)+
  # ggtitle("Mcap P")+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Mcap_GrossP_plot.Clade


#Pcomp by clade
Pcomp_GrossP_mean.Clade$Code<-paste(Pcomp_GrossP_mean.Clade$Treatment,Pcomp_GrossP_mean.Clade$Clade)

Pcomp_GrossP_plot.Clade<-ggplot(data=Pcomp_GrossP_mean.Clade, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
            width=0.1, show.legend = T)+
  geom_point(aes(color=Code), size=4, show.legend = T)+ 
  geom_line(aes(linetype=Clade))+
...
#         panel.background = element_rect(colour = "black", size=2))+
        theme(aspect.ratio=1)+
  # ggtitle("Pcomp P")+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Pcomp_GrossP_plot.Clade

#Pvar by clade
Pvar_GrossP_mean.Clade$Code<-paste(Pvar_GrossP_mean.Clade$Treatment,Pvar_GrossP_mean.Clade$Clade)

Pvar_GrossP_plot.Clade<-ggplot(data=Pvar_GrossP_mean.Clade, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
            width=0.1, show.legend = T)+
  geom_point(aes(color=Code), size=4, show.legend = T)+ 
...
#         panel.background = element_rect(colour = "black", size=2))+
        theme(aspect.ratio=1)+
  # ggtitle("Pvar P")+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Pvar_GrossP_plot.Clade

#Pacu by clade
Pacu_GrossP_mean.Clade$Code<-paste(Pacu_GrossP_mean.Clade$Treatment,Pacu_GrossP_mean.Clade$Clade)

Pacu_GrossP_plot.Clade<-ggplot(data=Pacu_GrossP_mean.Clade, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
            width=0.1, show.legend = T)+
  geom_point(aes(color=Code), size=4, show.legend = T)+ 
  geom_line(aes(linetype=Clade, color=Code))+
...
#         panel.background = element_rect(colour = "black", size=2))+
        theme(aspect.ratio=1)+
  # ggtitle("Pacu P")+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Pacu_GrossP_plot.Clade

Mcap_GrossP_plot.Clade<-Mcap_GrossP_plot.Clade+ theme(legend.position = "none") #remove legend
Pcomp_GrossP_plot.Clade<-Pcomp_GrossP_plot.Clade+ theme(legend.position = "none") #remove legend
Pvar_GrossP_plot.Clade<-Pvar_GrossP_plot.Clade+ theme(legend.position = "none") #remove legend
Pacu_GrossP_plot.Clade<-Pacu_GrossP_plot.Clade+ theme(legend.position = "none") #remove legend

grid.arrange(Mcap_GrossP_plot.Clade, Pcomp_GrossP_plot.Clade, Pvar_GrossP_plot.Clade,Pacu_GrossP_plot.Clade, nrow = 1)



```

GrossPsynthesis stats 
```{r}        
...
#t0 only by speices?
GrossP_stats_T0.mcap<-subset(GrossP_stats_T0, Species=="Montipora_capitata")
GrossP_stats_T0.pcomp<-subset(GrossP_stats_T0, Species=="Porites_compressa")
GrossP_stats_T0.pvar<-subset(GrossP_stats_T0, Species=="Pavona_varians")
GrossP_stats_T0.pacu<-subset(GrossP_stats_T0, Species=="Pocillopora_acuta")
...
#t0 only
PR.df_PR_B.T0_mean <- ddply(PR.df_BPR.df_B.T0, c( "Species"), summarise, 
...
#plot all
R_T0_mean_plot<-ggplot(data=PR.df_PR_B.T0_mean, aes(x=Species, y=mean, group = Species, color=Species)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Species), size=4, show.legend = F)+
  geom_line(aes(color=Species), linetype=2, show.legend = F)+
  ...
  ylab(expression(paste("nmol cm"^"-2 min"^"-"))) +
  ggtitle("R T0")+
  theme(plot.title = element_text(size=20, face = "italic"));R_T0_mean_plot
...
RespPos_mean <- ddply(PR.df_B, c("Treatment", "Species", "Time.Point"), summarise, 
                   N    = length(RespPos[!is.na(RespPos)]), 
                   mean = mean(RespPos, na.rm=TRUE), #calculate mean of RespPosonse variable, removing NA's
                   sd   = sd(RespPos, na.rm=TRUE), 
                   se   = sd / sqrt(N), 
                   max = max(RespPos, na.rm=TRUE) 
)
RespPos_mean #display table
 
# divide by species
Mcap_RespPos_mean<-subset(RespPos_mean, Species =="Montipora_capitata")
Pcomp_RespPos_mean<-subset(RespPos_mean, Species =="Porites_compressa")
Pvar_RespPos_mean<-subset(RespPos_mean, Species =="Pavona_varians")
Pacu_RespPos_mean<-subset(RespPos_mean, Species =="Pocillopora_acuta")

#Mcap plot

Mcap_RespPos_plot<-ggplot(data=Mcap_RespPos_mean, aes(x=Time.Point, y=mean, group = Treatment, color=Treatment)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Treatment), size=4, show.legend = T)+  
  geom_line(aes(color=Treatment),linetype="dotted")+
  ...
  #       panel.background = element_rect(colour = "black", size=2))+
        theme(aspect.ratio=1)+
  # ggtitle("Mcap RespPos")+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Mcap_RespPos_plot


#Pcomp plot

Pcomp_RespPos_plot<-ggplot(data=Pcomp_RespPos_mean, aes(x=Time.Point, y=mean, group = Treatment, color=Treatment)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Treatment), size=4, show.legend = T)+  
  geom_line(aes(color=Treatment),linetype="dotted")+
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  # ylab(expression(paste("nmol O2 cm-2 m-"))) +
  # ggtitle("Pcomp RespPos")+
  # theme(panel.grid.major = element_blank(), 
  #       panel.grid.minor = element_blank(),
  #       panel.background = element_rect(colour = "black", size=2))+
        theme(aspect.ratio=1)+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Pcomp_RespPos_plot

#Pvar plot

Pvar_RespPos_plot<-ggplot(data=Pvar_RespPos_mean, aes(x=Time.Point, y=mean, group = Treatment, color=Treatment)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Treatment), size=4, show.legend = T)+  
  geom_line(aes(color=Treatment),linetype="dotted")+
 ...
 xlab(" ") + #Label the X Axis
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  # ylab(expression(paste("nmol O2 cm-2 m-"))) +
  # ggtitle("Pvar RespPos")+
  # theme(panel.grid.major = element_blank(), 
  #       panel.grid.minor = element_blank(),
  #       panel.background = element_rect(colour = "black", size=2))+
        theme(aspect.ratio=1)+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Pvar_RespPos_plot

#Pacu plot

Pacu_RespPos_plot<-ggplot(data=Pacu_RespPos_mean, aes(x=Time.Point, y=mean, group = Treatment, color=Treatment)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = T)+
  geom_point(aes(color=Treatment), size=4, show.legend = T)+  
  geom_line(aes(color=Treatment),linetype="dotted")+
 ...
 xlab(" ") + #Label the X Axis
  ...
  theme(axis.line = element_line(color = 'black'), #Set the axes color
        ...
        legend.key = element_blank()) + #Set plot legend key
  # ylab(expression(paste("nmol O2 cm-2 m-"))) +
  # ggtitle("Pacu RespPos")+
  # theme(panel.grid.major = element_blank(), 
  #       panel.grid.minor = element_blank(),
  #       panel.background = element_rect(colour = "black", size=2))+
        theme(aspect.ratio=1)+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Pacu_RespPos_plot
...
#plot all
RespPos_T0_mean_plot<-ggplot(data=PR.df_BPR.df_B.T0_mean, aes(x=Species, y=mean, group = Species, color=Species)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Species), size=4, show.legend = T)+
  geom_line(aes(color=Species), linetype=2, show.legend = T)+
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        theme(aspect.ratio=1)+
  ylab(expression(paste("nmol O2 cm-2 m-"))) +
  ggtitle("RespPosiration T0")+
  theme(plot.title = element_text(size=20, face = "italic"));RespPos_T0_mean_plot


#TFH only#### 
RespPos_TFH<-subset(PR.df_B, Time.Point=="TF"&Treatment=="High") #Subset Pvar
RespPos_TFH_mean <- ddply(RespPos_TFH, c( "Species"), summarise, 
                 N    = length(RespPos[!is.na(RespPos)]), 
                 mean = mean(RespPos, na.rm=TRUE), #calculate mean of RespPosonse variable, removing NA's
                 sd   = sd(RespPos, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
...
#plot all
RespPos_TFH_plot<-ggplot(data=RespPos_TFH_mean, aes(x=Species, y=mean, group = Species, color=Species)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Species), size=4, show.legend = T)+
  geom_line(aes(color=Species), linetype=2, show.legend = T)+
  ...
  ylab(expression(paste("nmol O2 cm-2 m-"))) +
  ggtitle("Time F, High only")+
  theme(plot.title = element_text(size=20, face = "italic"));RespPos_TFH_plot
...
RespPos_mean.Clade <- ddply(PR.df_B, c("Treatment", "Species", "Time.Point","Clade"), summarise, 
                   N    = length(RespPos[!is.na(RespPos)]), 
                   mean = mean(RespPos, na.rm=TRUE), #calculate mean of RespPosonse variable, removing NA's
                   sd   = sd(RespPos, na.rm=TRUE), 
                   se   = sd / sqrt(N), 
...
RespPos_mean.Clade #display table

# divide by species
Mcap_RespPos_mean.Clade<-subset(RespPos_mean.Clade, Species =="Montipora_capitata")
  Mcap_RespPos_mean.Clade$Code<-paste(Mcap_RespPos_mean.Clade$Clade, Mcap_RespPos_mean.Clade$Treatment)
Pcomp_RespPos_mean.Clade<-subset(RespPos_mean.Clade, Species =="Porites_compressa")
  Pcomp_RespPos_mean.Clade$Code<-paste(Pcomp_RespPos_mean.Clade$Clade, Pcomp_RespPos_mean.Clade$Treatment)
Pvar_RespPos_mean.Clade<-subset(RespPos_mean.Clade, Species =="Pavona_varians")
  Pvar_RespPos_mean.Clade$Code<-paste(Pvar_RespPos_mean.Clade$Clade, Pvar_RespPos_mean.Clade$Treatment)
Pacu_RespPos_mean.Clade<-subset(RespPos_mean.Clade, Species =="Pocillopora_acuta")
  Pacu_RespPos_mean.Clade$Code<-paste(Pacu_RespPos_mean.Clade$Clade, Pacu_RespPos_mean.Clade$Treatment)


library(RColorBrewer)

#Mcap by clade
Mcap_RespPos_mean.Clade$Code<-paste(Mcap_RespPos_mean.Clade$Treatment,Mcap_RespPos_mean.Clade$Clade)

Mcap_RespPos_plot.Clade<-ggplot(data=Mcap_RespPos_mean.Clade, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
            width=0.1, show.legend = T)+
  geom_point(aes(color=Code), size=4, show.legend = T)+ 
...
#         panel.background = element_rect(colour = "black", size=2))+
        theme(aspect.ratio=1)+
  # ggtitle("Mcap RespPosiration")+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Mcap_RespPos_plot.Clade


#Pcomp by clade
Pcomp_RespPos_mean.Clade$Code<-paste(Pcomp_RespPos_mean.Clade$Treatment,Pcomp_RespPos_mean.Clade$Clade)

Pcomp_RespPos_plot.Clade<-ggplot(data=Pcomp_RespPos_mean.Clade, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
            width=0.1, show.legend = T)+
  geom_point(aes(color=Code), size=4, show.legend = T)+ 
  geom_line(linetype="dotted")+
...
#         panel.background = element_rect(colour = "black", size=2))+
        theme(aspect.ratio=1)+
  # ggtitle("Pcomp RespPosiration")+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Pcomp_RespPos_plot.Clade

#Pvar by clade
Pvar_RespPos_mean.Clade$Code<-paste(Pvar_RespPos_mean.Clade$Treatment,Pvar_RespPos_mean.Clade$Clade)

Pvar_RespPos_plot.Clade<-ggplot(data=Pvar_RespPos_mean.Clade, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
            width=0.1, show.legend = T)+
  geom_point(aes(color=Code), size=4, show.legend = T)+ 
  geom_line(linetype="dotted")+
...
#         panel.background = element_rect(colour = "black", size=2))+
        theme(aspect.ratio=1)+
  # ggtitle("Pvar RespPosiration")+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Pvar_RespPos_plot.Clade

#Pacu by clade
Pacu_RespPos_mean.Clade$Code<-paste(Pacu_RespPos_mean.Clade$Treatment,Pacu_RespPos_mean.Clade$Clade)

Pacu_RespPos_plot.Clade<-ggplot(data=Pacu_RespPos_mean.Clade, aes(x=Time.Point, y=mean, group = Code, color=Code)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
            width=0.1, show.legend = T)+
  geom_point(aes(color=Code), size=4, show.legend = T)+ 
  geom_line(linetype="dotted")+
...
#         panel.background = element_rect(colour = "black", size=2))+
        theme(aspect.ratio=1)+
  # ggtitle("Pacu RespPosiration")+
  theme(plot.title = element_text(size=20, face = "italic", hjust=0.5));Pacu_RespPos_plot.Clade

Mcap_RespPos_plot.Clade<-Mcap_RespPos_plot.Clade+ theme(legend.position = "none") #remove legend
Pcomp_RespPos_plot.Clade<-Pcomp_RespPos_plot.Clade+ theme(legend.position = "none") #remove legend
Pvar_RespPos_plot.Clade<-Pvar_RespPos_plot.Clade+ theme(legend.position = "none") #remove legend
Pacu_RespPos_plot.Clade<-Pacu_RespPos_plot.Clade+ theme(legend.position = "none") #remove legend

grid.arrange(Mcap_RespPos_plot.Clade, Pcomp_RespPos_plot.Clade, Pvar_RespPos_plot.Clade,Pacu_RespPos_plot.Clade, nrow = 1)
...
```{r}  
###### All plots together
Mcap_RespPos_plot<-Mcap_RespPos_plot+ theme(legend.position = "none") #remove legend
Pcomp_RespPos_plot<-Pcomp_RespPos_plot+ theme(legend.position = "none") #remove legend
Pvar_RespPos_plot<-Pvar_RespPos_plot+ theme(legend.position = "none") #remove legend
Pacu_RespPos_plot<-Pacu_RespPos_plot+ theme(legend.position = "none") #remove legend

grid.arrange(Mcap_RespPos_plot, Pcomp_RespPos_plot, Pvar_RespPos_plot,Pacu_RespPos_plot, nrow = 1)
...
PR_T0_mean_plot<-ggplot(data=PR.df_PR_B.T0_mean, aes(x=Species, y=mean, group = Species, color=Species)) +
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        panel.background = element_rect(colour = "black", size=1))+
        theme(aspect.ratio=1)+
  ylab(expression(paste("nmol O2 cm"^"-2 min"^"- "))) +
  ggtitle("PR T0")+
...
Rplot1<-ggplot(data=PR.df_B, aes(x=Time.Point, y=PR_real, colour=Treatment, group=interaction(Time.Point, Treatment))) +
  geom_boxplot(position=position_dodge(0.9), lwd=1)+
  geom_jitter(shape=16, position=position_dodge(0.9), size=3)+
  ...
  xlab("Time Point")+
  ylab(expression(bold(paste("P:R (nmol ", O[2], " cm"^-2, "min"^-1, ")")))) +
  theme_classic() +
  theme(text = element_text(size = 18, color="black"),
        axis.text = element_text(size = 18, color="black"), 
        legend.position = "top",
...
Rplot3<-Rplot1+facet_wrap(~Species);Rplot3
 ...
 #try scatter
Treat.colors<-c("Ambient" = "dodgerblue3","High"="darkred")


Rplot1<-ggplot(data=PR.df_B, aes(x=Resp, y=GrossP, color=Treatment)) +
  geom_point()+
  stat_ellipse(geom = "polygon",alpha = 0.1, aes(fill=Treatment), size=0)+ #remove line
  geom_hline(yintercept=0, linetype="dashed", color="black", size=0.75)+
  geom_abline(intercept = 0, slope=1, size=0.75)+
   scale_color_manual(values=c("dodgerblue3","darkred"))+
     scale_fill_manual(values=c("dodgerblue3","darkred"))+
   xlab(expression(bold(paste("Respiration (nmol ", O[2], " cm"^-2, "min"^-1, ")")))) +
  ylab(expression(bold(paste("Gross Photosynthesis (nmol ", O[2], " cm"^-2, "min"^-1, ")")))) +
  theme_classic() +
  theme(text = element_text(size = 18, color="black"),
        axis.text = element_text(size = 18, color="black"), 
        legend.position = "top",
        ...
        axis.title.y = element_text(margin = margin(t = 0, r = 1, b = 0, l = 1)), 
        axis.title.x = element_text(margin = margin(t = 3, r = 0, b = 0, l = 0)));Rplot1
Rplot3<-Rplot1+facet_wrap(~Species*Time.Point, ncol=3)+theme(legend.position="none");Rplot3
Rplot2<-Rplot1+theme(legend.position="none")
...
PR_TFH_mean <- ddply(PR_TFH, c( "Species"), summarise, 
                 N    = length(PR_real[!is.na(PR_real)]), 
                 mean = mean(PR_real, na.rm=TRUE), #calculate mean of PRonse variable, removing NA's
                 sd   = sd(PR_real, na.rm=TRUE), 
                 se   = sd / sqrt(N), 
                 max = max(PR_real, na.rm=TRUE) 
)
...
### by speices ###
PR_mean <-  ddply(PR.df_B, c("Treatment", "Species", "Time.Point"), summarise, 
                    N    = length(PR_real[!is.na(PR_real)]), 
                   mean = mean(PR_real, na.rm=TRUE), 
                   sd   = sd(PR_real, na.rm=TRUE), 
                   se   = sd / sqrt(N), 
...
grid.arrange(
            Mcap_biomass_plot, Pcomp_biomass_plot, Pvar_biomass_mean_plot,Pacu_biomass_mean_plot,
            Mcap_FC_lineplot, Pcomp_FC_lineplot, Pvar_FC_lineplot,Pacu_FC_lineplot,
          Mcap_BW_plot, Pcomp_BW_plot, Pvar_BW_plot,Pacu_BW_plot,
            Mcap_Chla_plot, Pcomp_Chla_plot, Pvar_Chla_plot,Pacu_Chla_plot,
            Mcap_PAM_plot, Pcomp_PAM_plot, Pvar_PAM_plot,Pacu_PAM_plot,
            Mcap_Protein_plot, Pcomp_Protein_plot, Pvar_Protein_plot,Pacu_Protein_plot,
             Mcap_Photo_plot, Pcomp_Photo_plot, Pvar_Photo_plot,Pacu_Photo_plot,
             Mcap_Resp_plot, Pcomp_Resp_plot, Pvar_Resp_plot,Pacu_Resp_plot,
             Mcap_PR_plot, Pcomp_PR_plot, Pvar_PR_plot,Pacu_PR_plot, nrow = 9)
...
# duplicated(Biomass_psy)
  ...
  Biomass_psy<- Biomass_psy[,c("Code" ,"Biomass")] # keep only columns you need
...
names(Chla_psy)[names(Chla_psy) == "zoox.cm2_log"] <- "Zoox Density"
...
names(Chla_psy)[names(Chla_psy) == "ChlaSA_quart"] <- "Chl a"
...
Calcification_psy$calc.percentchange[is.na(Calcification_psy$Calcification)] <- 0 #change T0 growth to 0s
...
Phy_nmds.MDS<-metaMDS(Phy_nmds[,8:16], distance = "bray", k = 2, trymax = 200, engine = c("monoMDS", "isoMDS"))
stressplot(Phy_nmds.MDS)
Phy_nmds.MDS
Phy_nmds.MDS.scores <- as.data.frame(scores(Phy_nmds.MDS)) #make the nMDS scores into a dataframe
Phy_nmds.MDS #get summary info, stress is 0.1 great
...
Phy_nmds.T1<-subset(Phy_nmds, Time.Point=="T1")
  set.seed(30)
Phy_nmds.MDS.T1<-metaMDS(Phy_nmds.T1[,8:16], distance = "bray", k = 2, trymax = 200, engine = c("monoMDS", "isoMDS"))
...
apDataT0<-apDataT0[,c("Parent.ID","Treatment","Species", "Time.Point", "Calcification","AFDWmg.cm2","zoox.cm2_log","Chl a","Protein", "Yield","Photosynthesis", "Respiration","PR")] #put cols in correct order
...
apDataT0<-apDataT0[,c("Parent.ID","Treatment","Species", "Time.Point","AFDWmg.cm2","zoox.cm2_log","Chl a","Protein", "Yield","Photosynthesis", "Respiration","PR")] #put cols in correct order, remove calcificaiton
...
ggbiplot(pcobj = apDataT02,
         choices=c(1,2),
         ellipse=TRUE, groups=Miss_scores_T0$species, geom="polygon", ellipse_fill=T, alpha=1)+
  theme_classic()

##ariana code not running 
porTP2<-ggplot2::autoplot(apDataT02,data=apDataT0[1:5], loadings=T, color="species",
                          loadings.label.colour="black", loadings.colour="black", loadins.label=T, frame=F, frame.type="convex", frame.level=0.95, loadings.labels.size=5, loadings.label.repel=T, size=4, alpha=1.0, loadings.arrow=grid::arrow(length =grid::unit(10,"points")),scale=0)+
  theme_classic()+
  coord_cartesian(xlim=c(-8,8),ylim=c(-5,5),slip="off")+
  theme(legend.text=element_text(size=18),
        ...
        axist.title=element_text(size=18));porTP2
...
AA_PhysioData<-AA_PhysioData[,c("Parent.ID","Treatment","Species", "Time.Point", "Calcification","AFDWmg.cm2","zoox.cm2_log","Chl a","Protein", "Fv/Fm","Photosynthesis", "Respiration","PR")] # keep only columns you need
...
groups2<-c("Montipora_capitata.Ambient.T1", "Montipora_capitata.Ambient.TF", "Montipora_capitata.High.T1","Montipora_capitata.High.TF", "Porites_compressa.Ambient.T1", "Porites_compressa.Ambient.TF", "Porites_compressa.High.T1","Porites_compressa.High.TF","Pavona_varians.Ambient.T1", "Pavona_varians.Ambient.TF", "Pavona_varians.High.T1","Pavona_varians.High.TF","Pocillopora_acuta.Ambient.T1", "Pocillopora_acuta.Ambient.TF", "Pocillopora_acutaa.High.T1","Pocillopora_acuta.High.TF")
colors=c(
  "#F8766D", #Mcap 
  "#C77CFF", #Porites
  "#7CAE00", # Pvar
...
groups2<-c("Montipora_capitata", "Porites_compressa","Pavona_varians","Pocillopora_acuta")
colors=c(
  "#F8766D", #Mcap 
  "#C77CFF", #Porites
  "#7CAE00", # Pvar
