...
#### T0 Pcomp only ####        
 ...
 # Bac_T0_mantel physio_T0_mantel
    ...
    physio_T0_mantel.Pacu  <- subset(physio_T0_mantel, species == "Pavona_varians")
...
#set up physio T1
  ...
  # reorder ps object so samples are in the same order
        physio_T1.High_mantel <- physio_T1.High_mantel[order(physio_T1.High_mantel$ID),]
...
#build matrix  
  ...
  #physio T1 high
        #   Scale and center
   physio_T1.High_mantel2<-  physio_T1.High_mantel[,3:10]
...
#remove ITS2
  ...
  # reorder ps object so samples are in the same order
        physio_T0_mantel <- physio.T0[order(physio.T0$ID),]
        rownames(physio_T0_mantel) <- physio_T0_mantel[,1] #make first col row names
#build matrix  
  #ITS2 T0        
...
#change names ITS2 RENAME S1388a, S1857b, SN134b
  ...
  # reorder ps object so samples are in the same order
        physio_T1.High_mantel <- physio.T1.High_mantel[order(physio.T1.High_mantel$ID),]
        rownames(physio_T1.High_mantel) <- physio_T1.High_mantel[,1] #make first col row names
#build matrix  
  #ITS2 T1        
...
#physio REMOVE: SN222, S1195
      physio.T1.Amb<-physio.T1.High[!(physio.T1.Amb$ID=="SN222"),]
            physio.T1.Amb<-physio.T1.High[!(physio.T1.Amb$ID=="S1195"),]
        physio_T1.Amb_mantel<-physio.T1.Amb #make a copy
...
#### T1 Mcap only ####   NOT RUNNING     
 # ITS2.T1.Amb physio_T1.Amb_mantel
    
    #subset df for mcap
    ITS2_T1.Amb_mantel.Mcap <- subset_samples(ITS2.T1.Amb, Species == "Montipora_capitata")
...
#### T1 Pcomp only ####        
 # ITS2_T1_mantel physio_T1_mantel
   ...
   #physio T1 Pcomp dist
     euc.physio.T1.Amb.mantel.Pcomp<- dist(physio_T1.Amb_mantel.Pcomp[,3:11], method = "euclidian") 

   # Run mantel test
      mantel(bray.ITS2_T1.Amb_mantel.Pcomp, euc.physio.T1.Amb.mantel.Pcomp,  permutations=1000)        
 ...
 # ITS2_T1.Amb_mantel physio_T1.Amb_mantel
   ...
   #physio T1 Pvar dist
     euc.physio.T1.Amb.mantel.Pvar <-dist(physio_T1.Amb_mantel.Pvar[,3:11], method = "euclidian")  

   # Run mantel test
      mantel(bray.ITS2_T1.Amb_mantel.Pvar, euc.physio.T1.Amb.mantel.Pvar,  permutations=1000)            
 ...
 # ITS2_T1.Amb_mantel physio_T1.Amb_mantel
    ...
    #subset df for Pacu
    ITS2_T1.Amb_mantel.Pacu <- subset_samples(ITS2.T1.Amb.mantel, Species == "Pavona_varians")
    ITS2_T1.Amb_mantel.Pacu = prune_taxa(taxa_sums(ITS2_T1.Amb_mantel.Pacu) > 0, ITS2_T1.Amb_mantel.Pacu) 
    
    physio_T1.Amb_mantel.Pacu  <- subset(physio_T1.Amb_mantel, species == "Pavona_varians")

    #ITS2 T1 Pacu dist        
      bray.ITS2_T1.Amb_mantel.Pacu <- phyloseq::distance(ITS2_T1.Amb_mantel.Pacu, method = "bray")
        
   #physio T1 Pacu dist
     euc.physio.T1.Amb.mantel.Pacu <- dist(physio_T1.Amb_mantel.Pacu[,3:11], method = "euclidian")  

   # Run mantel test
      mantel(bray.ITS2_T1.Amb_mantel.Pacu, euc.physio.T1.Amb.mantel.Pacu,  permutations=1000)            
...
#set up ITS2
    ITS2.TF<-subset_samples(ITS2, Time.Point=="TF")
  ...
  # look at sample names
    ...
    #save just sample names
      ITS2.TF.High.sd.samps<-ITS2.TF.High.sd[['sample_name.1']]
...
#set up physio TF
  ...
  #identify missing samples btw datasets     ***** This is not running i think it is a computer issue*** did by hand
      setdiff(ITS2.TF.High.sd.samps,physio.TF.High.sd) #samples in ITS2 but not phys: REMOVE S1502, S2284, S3481, S3485, S619, S972 REPLACE: S3476b
      setdiff(physio.TF.High.sd,ITS2.TF.High.sd.samps) #samples in phys but not ITS2:REMOVE: S1771, S2018, S3471, S3474, S3489,S3484 S3515, S3516, S477, S840, SN141, SN212   
        
#16 remove: S1502, S2284, S3481, S3485, S619, S972
            ITS2.TF.High <- subset_samples(ITS2.TF.High, sample_name.1 != "S1502" )
            ITS2.TF.High <- subset_samples(ITS2.TF.High, sample_name.1 != "S2284" )
            ITS2.TF.High <- subset_samples(ITS2.TF.High, sample_name.1 != "S3481" )
            ITS2.TF.High <- subset_samples(ITS2.TF.High, sample_name.1 != "S3485" )
            ITS2.TF.High <- subset_samples(ITS2.TF.High, sample_name.1 != "S619" )
            ITS2.TF.High <- subset_samples(ITS2.TF.High, sample_name.1 != "S972" )

#rename ITS2:S3476b
    # pull OTU table
     OTU.ITS2TF.High = as(otu_table(ITS2.TF.High), "matrix") #pull otu
       OTU.ITS2TF.High<-as.data.frame(OTU.ITS2TF.High) #make into df
        row.names(OTU.ITS2TF.High)[21] <- "S3476"   #change row name by row number
    ...
    #pull TAX table
     ...
     #pull phy tree table
     tree.seq.TFHigh = phy_tree(ITS2.TF.High) #pull out tree

    #pull SAMPLE DATA
     aSD.ITS2TF.High = as(sample_data(ITS2.TF.High), "matrix") #pull samp.data
     aSD.ITS2TF.High<-as.data.frame(aSD.ITS2TF.High) #change to df
        row.names(aSD.ITS2TF.High)[21] <- "S3476"  #replace name S208b
    ...
    #remake the phyloseq obj
      samdata = sample_data(aSD.ITS2TF.High)
        ...
        phy_tree = read_tree(tree.seq.TFHigh)
          ITS2_TF.High_mantel = phyloseq(otu_table(seqtab), tax_table(taxtab), sample_data(samdata),phy_tree(tree.seq))      
      
    
   #physio - remove samps not in the ITS2 df-  S1771, S2018, S3471, S3474, S3489, S3515, S3516, S477, S840, SN141, SN212  , S3484 
...
#build matrix  
  #ITS2 TF        
        ...
        ITS2_TF.High_mantel2 <- phyloseq::distance(ITS2_TF.High_mantel2, method = "bray")
        
  #physio TF high
   euc.physio_TF.High_mantel <- dist(physio_TF.High_mantel[,3:11], method = "euclidian") 

  # Run mantel test
      mantel(ITS2_TF.High_mantel2, euc.physio_TF.High_mantel,  permutations=999)
    # r=-0.1817 . p=0.997
...
#### TF Mcap only ####        
 # ITS2_TF_mantel physio_TF_mantel
   ...
   #physio TF mcap dist
     euc.physio.TF.High.mantel.Mcap  <- dist(physio_TF.High_mantel.Mcap[,3:11], method = "euclidian") 

   # Run mantel test
      mantel(bray.ITS2_TF.High_mantel.Mcap, euc.physio.TF.High.mantel.Mcap,  permutations=1000)
...
#### TF Pcomp only ####        
 # ITS2_TF.High_mantel physio_TF.High_mantel
   ...
   #physio TF Pcomp dist
     euc.physio.TF.mantel.Pcomp<- dist(physio_TF.High_mantel.Pcomp[,3:11], method = "euclidian") 

   # Run mantel test
      mantel(bray.ITS2_TF.High_mantel.Pcomp, euc.physio.TF.mantel.Pcomp,  permutations=1000)        
 ...
 # ITS2_TF.High_mantel physio_TF.High_mantel
   ...
   #physio TF Pvar dist
     euc.physio.TF.mantel.Pvar <-dist(physio_TF.High_mantel.Pvar[,3:11], method = "euclidian")  

   # Run mantel test
      mantel(bray.ITS2_TF.High_mantel.Pvar, euc.physio.TF.mantel.Pvar,  permutations=1000)            
 ...
 # ITS2_TF.High_mantel physio_TF.High_mantel
    ...
    #subset df for Pacu
    ITS2_TF.High_mantel.Pacu <- subset_samples(ITS2_TF.High_mantel, Species == "Pavona_varians")
    ITS2_TF.High_mantel.Pacu = prune_taxa(taxa_sums(ITS2_TF.High_mantel.Pacu) > 0, ITS2_TF.High_mantel.Pacu) 
    
    physio_TF.High_mantel.Pacu  <- subset(physio_TF.High_mantel, species == "Pavona_varians")

    #ITS2 TF Pacu dist        
      bray.ITS2_TF.High_mantel.Pacu <- phyloseq::distance(ITS2_TF.High_mantel.Pacu, method = "bray")
        
   #physio TF Pacu dist
     euc.physio.TF.mantel.Pacu <- dist(physio_TF.High_mantel.Pacu[,3:11], method = "euclidian")  

   # Run mantel test
      mantel(bray.ITS2_TF.High_mantel.Pacu, euc.physio.TF.mantel.Pacu,  permutations=1000)            
...
#set up ITS2
    ITS2.TF<-subset_samples(ITS2, Time.Point=="TF")
    ITS2.TF.Ambient<-subset_samples(ITS2.TF, Treatment=="Ambient")

    ITS2.TF.Ambient = prune_taxa(taxa_sums(ITS2.TF.Ambient) > 0, ITS2.TF.Ambient) #this removes any OTU with 0s
  # look at sample names
    ITS2.TF.Ambient.sd <- as(sample_data(ITS2.TF.Ambient), "data.frame") #sample df
    #save just sample names
      ITS2.TF.Ambient.sd.samps<-ITS2.TF.Ambient.sd[['sample_name.1']]
 ITS2.TF.Ambient.sd.samps<-as.data.frame(ITS2.TF.Ambient.sd.samps)
...
#set up physio TF
  ...
  #save just sample names
      ...
      # compare physio to ITS2 at TF
  #identify missing samples btw datasets     ***** This is not running i think it is a computer issue*** did by hand
      setdiff(ITS2.TF.Ambient.sd.samps,physio.TF.Ambient.sd) #samples in ITS2 but not phys: REMOVE: S1226, S1688. S2214, S2226, S377. S471. S955. SN110 SN158, SN169, SN217, 
      setdiff(physio.TF.Ambient.sd,ITS2.TF.Ambient.sd.samps) #samples in phys but not ITS2:REMOVE:SN42 REAL: S3317, S779, SN102, SN208, S1279 S 1556 S785b
      
      
#16 remove: S1226, S1688, S2214, S2226, S377 S471 S955 SN110 SN158, SN169, SN217, SN42 S785b
            ITS2.TF.Ambient <- subset_samples(ITS2.TF.Ambient, sample_name.1 != "S1226" )
                        ITS2.TF.Ambient <- subset_samples(ITS2.TF.Ambient, sample_name.1 != "S1556" )
                        ITS2.TF.Ambient <- subset_samples(ITS2.TF.Ambient, sample_name.1 != "S785b" )

            ITS2.TF.Ambient <- subset_samples(ITS2.TF.Ambient, sample_name.1 != "S1688" )
            ITS2.TF.Ambient <- subset_samples(ITS2.TF.Ambient, sample_name.1 != "S2214" )
            ITS2.TF.Ambient <- subset_samples(ITS2.TF.Ambient, sample_name.1 != "S2226" )
            ITS2.TF.Ambient <- subset_samples(ITS2.TF.Ambient, sample_name.1 != "S377" )
            ITS2.TF.Ambient <- subset_samples(ITS2.TF.Ambient, sample_name.1 != "S471" )
            ITS2.TF.Ambient <- subset_samples(ITS2.TF.Ambient, sample_name.1 != "S955" )
            ITS2.TF.Ambient <- subset_samples(ITS2.TF.Ambient, sample_name.1 != "SN110" )
            ITS2.TF.Ambient <- subset_samples(ITS2.TF.Ambient, sample_name.1 != "SN158" )
            ITS2.TF.Ambient <- subset_samples(ITS2.TF.Ambient, sample_name.1 != "SN169" )
            ITS2.TF.Ambient <- subset_samples(ITS2.TF.Ambient, sample_name.1 != "SN217" )
            ITS2.TF.Ambient <- subset_samples(ITS2.TF.Ambient, sample_name.1 != "SN42" )


   #physio - remove samps not in the ITS2 df-  S1226, S1688. S2214, S2226, S377 S471 S955 SN110 SN158, SN169, SN217, SN42
...
#build matrix  
  #ITS2 TF        
        ITS2_TF.Ambient_mantel2<-ITS2.TF.Ambient
        ITS2_TF.Ambient_mantel2 <- phyloseq::distance(ITS2_TF.Ambient_mantel2, method = "bray")
        
  #physio TF Ambient
   euc.physio_TF.Ambient_mantel <- dist(physio_TF.Ambient_mantel[,3:11], method = "euclidian") 

  # Run mantel test
      mantel(ITS2_TF.Ambient_mantel2, euc.physio_TF.Ambient_mantel,  permutations=999)
    # r=-0.1817 . p=0.997
...
#### TF Mcap only ####        
 # ITS2_TF_mantel physio_TF_mantel
    ...
    #subset df for mcap
    ITS2_TF.Ambient_mantel.Mcap <- subset_samples(ITS2.TF.Ambient, Species == "Montipora_capitata")
    ITS2_TF.Ambient_mantel.Mcap = prune_taxa(taxa_sums(ITS2_TF.Ambient_mantel.Mcap) > 0, ITS2_TF.Ambient_mantel.Mcap) 
    
    physio_TF.Ambient_mantel.Mcap  <- subset(physio_TF.Ambient_mantel, species == "Montipora_capitata")

    #ITS2 TF mcap dist        
      bray.ITS2_TF.Ambient_mantel.Mcap <- phyloseq::distance(ITS2_TF.Ambient_mantel.Mcap, method = "bray")
        
   #physio TF mcap dist
     euc.physio.TF.Ambient.mantel.Mcap  <- dist(physio_TF.Ambient_mantel.Mcap[,3:11], method = "euclidian") 

   # Run mantel test
      mantel(bray.ITS2_TF.Ambient_mantel.Mcap, euc.physio.TF.Ambient.mantel.Mcap,  permutations=1000)
    
#### TF Pcomp only ####        
 # ITS2_TF.Ambient_mantel physio_TF.Ambient_mantel
    
    #subset df for Pcomp
    ITS2_TF.Ambient_mantel.Pcomp <- subset_samples(ITS2.TF.Ambient, Species == "Porites_compressa")
    ITS2_TF.Ambient_mantel.Pcomp = prune_taxa(taxa_sums(ITS2_TF.Ambient_mantel.Pcomp) > 0, ITS2_TF.Ambient_mantel.Pcomp) 
    
    physio_TF.Ambient_mantel.Pcomp  <- subset(physio_TF.Ambient_mantel, species == "Porites_compressa")

    #ITS2 TF Pcomp dist        
      bray.ITS2_TF.Ambient_mantel.Pcomp <- phyloseq::distance(ITS2_TF.Ambient_mantel.Pcomp, method = "bray")
        
   #physio TF Pcomp dist
     euc.physio.TF.mantel.Pcomp<- dist(physio_TF.Ambient_mantel.Pcomp[,3:11], method = "euclidian") 

   # Run mantel test
      mantel(bray.ITS2_TF.Ambient_mantel.Pcomp, euc.physio.TF.mantel.Pcomp,  permutations=1000)        
 ...
 # ITS2_TF.Ambient_mantel physio_TF.Ambient_mantel
    ...
    #subset df for Pvar
    ITS2_TF.Ambient_mantel.Pvar <- subset_samples(ITS2.TF.Ambient, Species == "Pavona_varians")
    ITS2_TF.Ambient_mantel.Pvar = prune_taxa(taxa_sums(ITS2_TF.Ambient_mantel.Pvar) > 0, ITS2_TF.Ambient_mantel.Pvar) 
    
    physio_TF.Ambient_mantel.Pvar  <- subset(physio_TF.Ambient_mantel, species == "Pavona_varians")

    #ITS2 TF Pvar dist        
      bray.ITS2_TF.Ambient_mantel.Pvar <- phyloseq::distance(ITS2_TF.Ambient_mantel.Pvar, method = "bray")
        
   #physio TF Pvar dist
     euc.physio.TF.mantel.Pvar <-dist(physio_TF.Ambient_mantel.Pvar[,3:11], method = "euclidian")  

   # Run mantel test
      mantel(bray.ITS2_TF.Ambient_mantel.Pvar, euc.physio.TF.mantel.Pvar,  permutations=1000)            
 ...
 # ITS2_TF.Ambient_mantel physio_TF.Ambient_mantel
    ...
    #subset df for Pacu
    ITS2_TF.Ambient_mantel.Pacu <- subset_samples(ITS2.TF.Ambient, Species == "Pavona_varians")
    ITS2_TF.Ambient_mantel.Pacu = prune_taxa(taxa_sums(ITS2_TF.Ambient_mantel.Pacu) > 0, ITS2_TF.Ambient_mantel.Pacu) 
    
    physio_TF.Ambient_mantel.Pacu  <- subset(physio_TF.Ambient_mantel, species == "Pavona_varians")

    #ITS2 TF Pacu dist        
      bray.ITS2_TF.Ambient_mantel.Pacu <- phyloseq::distance(ITS2_TF.Ambient_mantel.Pacu, method = "bray")
        
   #physio TF Pacu dist
     euc.physio.TF.mantel.Pacu <- dist(physio_TF.Ambient_mantel.Pacu[,3:11], method = "euclidian")  

   # Run mantel test
      mantel(bray.ITS2_TF.Ambient_mantel.Pacu, euc.physio.TF.mantel.Pacu,  permutations=1000)            
