...
#T1 only  mcap.samp.df.T1 ### dont' use but cool
set.seed(30)
ord.mcapT1 <- ordinate(mcap.RelRare.T1, "NMDS", "bray", trymax = 100) 
stressplot(ord.mcapT1)

scores.mcapT1<-as.data.frame(cbind(vegan::scores(ord.mcapT1, display="sites")))

scores.mcapT1$Treatment <- mcap.RelRare.T1.samp.df$Treatment
scores.mcapT1$Parent.ID <- mcap.RelRare.T1.samp.df$Parent.ID
scores.mcapT1$Clade <- mcap.RelRare.T1.samp.df$Clade
scores.mcapT1$CladeTreat <- as.factor(paste(mcap.RelRare.T1.samp.df$Clade,mcap.RelRare.T1.samp.df$Treatment))
...
#TF only  mcap.samp.df.TF ####
set.seed(30)
ord.mcapTF <- ordinate(mcap.RelRare.TF, "NMDS", "bray", trymax = 100) 
stressplot(ord.mcapTF)

scores.mcapTF<-as.data.frame(cbind(vegan::scores(ord.mcapTF, display="sites")))

scores.mcapTF$Treatment <- mcap.RelRare.TF.samp.df$Treatment
scores.mcapTF$Parent.ID <- mcap.RelRare.TF.samp.df$Parent.ID
scores.mcapTF$Clade <- mcap.RelRare.TF.samp.df$Clade
scores.mcapTF$CladeTreat <- as.factor(paste(mcap.RelRare.TF.samp.df$Clade,mcap.RelRare.TF.samp.df$Treatment))
