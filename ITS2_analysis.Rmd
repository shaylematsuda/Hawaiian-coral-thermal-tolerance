...
#Mcap
TopNOTUsMcap = names(sort(taxa_sums(Mcap_DIV_RA), TRUE)[1:10])
...
#Pvar
TopNOTUsVar = names(sort(taxa_sums(Pvar_DIV_RA), TRUE)[1:10])
...
#
 #T0 make all ambient   
   ...
   disp_mean.its <- ddply(Awu.disp.Species.its, c("Treatment", "Species", "Time.Point","Clade"), summarise, #summarize cell counts
...
#mcap
 ...
 #pcomp
    ...
    disp_mean.its_plot<-ggplot(data=disp_mean.its.pcomp, aes(x=Time.Point, y=mean, group = Code2, color=Treatment)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Treatment), size=4, show.legend = T)+
  geom_line(aes(color=Treatment), linetype=2, show.legend = T)+
...
#pvar
    ...
    disp_mean.its_plot<-ggplot(data=disp_mean.its.pvar, aes(x=Time.Point, y=mean, group = Code2, color=Treatment)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Treatment), size=4, show.legend = T)+
  geom_line(aes(color=Treatment), linetype=2, show.legend = T)+
...
#pacu
    ...
    disp_mean.its_plot<-ggplot(data=disp_mean.its.pacu, aes(x=Time.Point, y=mean, group = Code2, color=Treatment)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Treatment), size=4, show.legend = T)+
  geom_line(aes(color=Treatment), linetype=2, show.legend = T)+
...
Mcap_evenness_pielou_plot<-ggplot(data=erich.tab2its.mcapT1mean, aes(x=Clade, y=mean, group = Clade, color=Treatment)) +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se),
                width=0.1, show.legend = F)+
  geom_point(aes(color=Treatment), size=4, show.legend = F)+
 # geom_line(aes(color=Treatment), linetype=2, show.legend = F)+
