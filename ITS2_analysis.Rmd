...
save(profiles, file = "Data/profiles_phyloseq.RData")
...
load("data/profiles_phyloseq.RData") #use RAW data
...
## keep this for now, but the bar plots are ugly, skip to next chunk for nicer plots and delete for publication
```{r}       
#RELA 
