...
##Mcap only ####
  hist(erich.tab2.mcap$observed)
ggqqplot(erich.tab2.mcap$observed)
  erich.tab2.mcap.t1tf<-subset(erich.tab2.mcap, Time.Point=="T1"|Time.Point=="TF")
 #t1TF
  Mcap_alpha_mod<-lmer(observed ~ Time.Point*Treatment+(1|Parent.ID), data=erich.tab2.mcap.t1tf) #adding tank is singularity
  ...
  Mcap_alpha_mod<-lmer(observed ~ Time.Point*Treatment*Clade+(1|Parent.ID), data=erich.tab2.mcap.t1tf) #adding tank is singularity
  anova(Mcap_alpha_mod) 
qqPlot(residuals(Mcap_alpha_mod)) 
